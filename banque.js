...
x:"La lettre de change (ou traite) est un écrit par lequel le tireur (créancier) donne l'ordre au tiré (débiteur) de payer une certaine somme à une date déterminée. C'est le tireur qui rédige et adresse la traite au tiré pour acceptation."},
...
x:"Dans une SARL, la responsabilité des associés est limitée au montant de leurs apports (art. L.223-1 du Code de commerce). Ils ne peuvent pas être poursuivis sur leurs biens personnels, sauf faute de gestion."},
...
x:"La cessation de paiement est définie comme l'impossibilité pour une entreprise de faire face à son passif exigible (dettes arrivées à échéance) avec son actif disponible (liquidités). C'est le déclencheur d'une procédure collective."},
...
x:"En droit commercial, le délai de prescription de droit commun est de 5 ans (art. L.110-4 du Code de commerce), sauf prescriptions spéciales plus courtes comme la prescription d'un an en transport routier."},
...
x:"Le président de la SAS peut être une personne physique ou une personne morale, associé ou non de la société. Les statuts fixent librement les modalités de sa désignation (art. L.227-6 du Code de commerce)."},
...
x:"Le gérant d'une SARL n'est pas commerçant. Il agit au nom de la société, qui seule a la qualité de commerçant. Le gérant peut être associé ou non, et peut même être salarié sous certaines conditions."},
...
x:"La prescription en transport est interrompue par une action en justice (assignation). Une simple lettre de réclamation, même recommandée, n'interrompt pas la prescription en droit du transport (art. L.133-6 du Code de commerce)."},
...
x:"La procédure d'injonction de payer doit être introduite devant le tribunal compétent du lieu du domicile du débiteur (ou de l'un d'eux s'ils sont plusieurs). Le tribunal compétent en matière commerciale est le tribunal de commerce."},
...
x:"La faillite personnelle est une sanction personnelle prononcée par le tribunal à l'encontre d'un dirigeant ayant commis des fautes graves de gestion. Elle entraîne l'interdiction de diriger, gérer ou contrôler une entreprise."},
...
x:"Les commissaires aux comptes ont pour mission de certifier que les comptes annuels sont réguliers et sincères et donnent une image fidèle de la situation financière de la société. Ils ne tiennent pas la comptabilité."},
...
x:"Un chèque certifié est un chèque sur lequel le banquier du tireur atteste l'existence de la provision au moment de la certification. Cette provision n'est pas bloquée (contrairement au chèque de banque)."},
...
x:"L'escompte consiste à remettre une traite à sa banque avant son échéance afin d'obtenir immédiatement les fonds, moyennant des agios (intérêts et frais). La banque avance le montant et récupère la créance à l'échéance."},
...
x:"L'objet social (activité exercée par la société) est une mention obligatoire des statuts pour toutes les formes de sociétés. Le nom des gérants, lui, peut figurer dans un acte séparé."},
...
x:"Le transporteur est responsable de plein droit en cas de perte, d'avarie ou de retard survenus entre la prise en charge et la livraison. Cette présomption de responsabilité peut être renversée par la preuve d'un cas d'exonération (force majeure, vice propre de la marchandise, faute du donneur d'ordre)."},
...
x:"La personnalité morale d'une société est acquise à partir de son immatriculation au Registre National des Entreprises (RNE), anciennement RCS, qui remplace depuis 2023 les différents registres d'entreprises."},
...
x:"Les documents comptables (livres, journaux, grand livre, pièces justificatives) doivent être conservés pendant 10 ans en droit commercial (art. L.123-22 du Code de commerce). Les documents fiscaux doivent être conservés 6 ans."},
...
x:"Comme dans la SARL, la responsabilité des associés de la SAS est limitée à leurs apports. Ils ne peuvent être poursuivis sur leurs biens personnels au-delà de ce montant."},
...
x:"L'injonction de payer est une procédure judiciaire simplifiée permettant à un créancier de recouvrer rapidement une créance certaine, liquide et exigible, sans débat contradictoire initial."},
...
x:"Dans un billet à ordre, le souscripteur est l'acheteur (débiteur) qui s'engage à payer une somme déterminée au bénéficiaire (vendeur/créancier) à une date fixée. C'est l'inverse de la lettre de change."},
...
x:"Les fonds constituant le capital social sont bloqués sur un compte spécial jusqu'à l'immatriculation de la société. Une fois immatriculée, ils sont débloqués et mis à la disposition de la société pour son activité."},
...
x:"La TVA n'affecte pas le résultat ni les coûts (elle est neutre pour les assujettis qui la récupèrent). En revanche, elle a un impact sur la trésorerie : l'entreprise collecte la TVA sur ses ventes avant de la reverser à l'État, ce qui génère des décalages de trésorerie."},
...
x:"Lorsqu'un auto-entrepreneur dépasse le seuil de franchise en base de TVA (37 500 € pour les prestations de services depuis 2026), il devient redevable de la TVA : il doit la facturer à ses clients et la reverser à l'État, mais peut aussi la déduire sur ses achats."},
...
x:"Sous le régime de la franchise en base de TVA, l'entreprise ne facture pas de TVA à ses clients (facturation HT avec la mention 'TVA non applicable - article 293 B du CGI'). En contrepartie, elle ne peut pas récupérer la TVA sur ses achats."},
...
x:"Le taux normal de TVA en France est de 20 %. Les prestations de transport de marchandises sont soumises au taux normal de 20 %. Des taux réduits (10 % ou 5,5 %) s'appliquent à certains produits ou services spécifiques."},
...
x:"L'impôt sur les sociétés (IS) s'applique de droit aux sociétés de capitaux (SA, SAS, SARL…). Le taux normal est de 25 %. Un taux réduit de 15 % s'applique sur les 42 500 premiers euros de bénéfice pour les PME répondant à certains critères."},
...
x:"La TVS (remplacée par une taxe sur les émissions depuis 2022) concerne les véhicules de tourisme (catégorie M1) utilisés ou possédés par les sociétés soumises à l'IS ou à l'IR selon les BIC/BA. Les VUL et véhicules utilitaires professionnels ne sont pas concernés."},
...
x:"Pour les prestations de services BIC (dont le transport pour compte d'autrui), le taux de cotisations sociales de l'auto-entrepreneur est de 21,2 % du chiffre d'affaires (2025-2026). Le taux de 12,3 % concerne uniquement l'achat-revente de marchandises."},
...
x:"Depuis le 1er janvier 2026, le seuil de franchise en base de TVA pour les prestataires de services est de 37 500 € (seuil majoré de tolérance : 41 250 €). Pour les ventes de marchandises, le seuil est de 85 000 €."},
...
x:"La TICPE est une taxe indirecte incluse dans le prix du carburant, payée à l'État lors de l'achat. Les transporteurs routiers professionnels bénéficient d'un remboursement partiel forfaitaire de TICPE sur le gazole professionnel."},
...
x:"Le registre unique du personnel doit être conservé pendant 5 ans après la date à laquelle le dernier salarié inscrit a quitté l'établissement (art. L.1221-13 du Code du travail)."},
...
x:"Depuis 2017, la visite de reprise est obligatoire après un arrêt de travail pour maladie non professionnelle d'au moins 30 jours (ou pour maladie professionnelle quelle qu'en soit la durée, ou après une maternité)."},
...
x:"Pour un licenciement économique individuel, l'employeur doit notifier l'administration (DREETS) dans les 8 jours ouvrables qui suivent l'envoi de la lettre de licenciement (art. R.1233-2 du Code du travail)."},
...
x:"Un CDD peut être conclu pour remplacer un salarié absent (maladie, congé maternité, etc.) pendant toute la durée de son absence. En revanche, il ne peut pas être conclu pour remplacer un salarié dont le contrat est suspendu suite à un conflit collectif."},
...
x:"L'inaptitude est reconnue par le médecin du travail (et non le médecin traitant) après au moins un examen médical et une étude du poste, sauf en cas de danger immédiat pour la santé ou la sécurité du salarié ou de tiers."},
...
x:"Le préavis commence à courir à la date de première présentation de la lettre recommandée au domicile du salarié, même si celui-ci est absent et ne l'a pas encore retirée."},
...
x:"Depuis le 1er juillet 2021, le congé total est de 28 jours : 3 jours de congé de naissance (payés par l'employeur) + 25 jours de congé paternité (indemnisés par la CPAM). Les 4 premiers jours du congé paternité sont obligatoires et doivent être pris immédiatement après la naissance."},
...
x:"Pour un 1er ou 2ème enfant, le congé maternité est de 16 semaines : 6 semaines avant et 10 semaines après l'accouchement. Il est porté à 26 semaines pour une naissance à partir du 3ème enfant."},
...
x:"Le règlement intérieur doit être déposé au secrétariat-greffe du conseil de prud'hommes dans le ressort duquel l'entreprise est située, et notifié à l'inspecteur du travail (art. R.1321-4 du Code du travail)."},
...
x:"Depuis 2020, le règlement intérieur est obligatoire dans toute entreprise employant au moins 50 salariés. Attention : le CSE (Comité Social et Économique) est obligatoire à partir de 11 salariés pendant 12 mois consécutifs, ce qui est différent."},
...
x:"La rupture conventionnelle (art. L.1237-11 du Code du travail) est une modalité de rupture d'un CDI d'un commun accord. Le salarié perçoit une indemnité spécifique (au moins égale à l'indemnité légale de licenciement) et peut percevoir les allocations chômage."},
...
x:"La durée maximale absolue de travail est fixée à 48 heures par semaine (art. L.3121-20 du Code du travail). La durée légale de 35 heures est le seuil à partir duquel les heures supplémentaires sont déclenchées, mais ce n'est pas le maximum."},
...
x:"Selon l'annexe 1 de la convention collective des transports routiers, la période d'essai d'un conducteur routier embauché en CDI est de 2 mois non renouvelables."},
...
x:"L'AGS garantit le paiement des créances salariales (salaires, préavis, indemnités de licenciement) en cas d'ouverture d'une procédure de redressement ou liquidation judiciaire. Elle est financée par une cotisation patronale."},
...
x:"Le CPF (Compte Personnel de Formation) est alimenté à 500 €/an pour les salariés à temps plein ayant au moins un niveau bac (plafond 5 000 €), et à 800 €/an pour les salariés sans qualification (plafond 8 000 €)."},
...
x:"Le seuil de rentabilité est le niveau de chiffre d'affaires à partir duquel l'entreprise couvre l'intégralité de ses charges (fixes + variables) et commence à dégager un bénéfice. En dessous, elle est en perte."},
...
x:"Les disponibilités représentent les fonds immédiatement disponibles : soldes des comptes bancaires, solde caisse, valeurs mobilières de placement immédiatement réalisables. C'est la trésorerie active au sens strict."},
...
x:"Le FRNG (Fonds de Roulement Net Global) = Ressources stables (capitaux propres + emprunts LT) − Emplois stables (actif immobilisé net). Un FRNG positif signifie que les ressources stables financent non seulement les immobilisations mais aussi une partie de l'actif circulant."},
...
x:"DSO = Créances clients TTC / CA TTC × 360 jours. Il mesure le délai moyen d'encaissement des factures clients. Plus le DSO est court, mieux c'est pour la trésorerie. Un DSO de 45 jours signifie que les clients paient en moyenne 45 jours après la facturation."},
...
x:"La CAF mesure la capacité de l'entreprise à générer des ressources par son activité. Formule simplifiée : CAF = Résultat net + Dotations aux amortissements et provisions − Reprises. Elle sert à rembourser les emprunts, investir, distribuer des dividendes."},
...
x:"Le crédit-bail préserve la trésorerie (pas d'immobilisation de capital), les loyers sont déductibles en charges d'exploitation, et le véhicule est récent. En contrepartie, le coût global est supérieur à l'achat comptant et l'entreprise n'est pas propriétaire pendant le contrat."},
...
x:"Le ratio d'indépendance financière = (Capitaux propres + provisions pour risques et charges) / Dettes financières. Plus ce ratio est élevé, plus l'entreprise est financièrement indépendante. Un ratio supérieur à 1 est généralement considéré comme sain."},
...
x:"Le BFR représente le besoin de financement généré par le cycle d'exploitation : l'entreprise doit financer ses stocks et ses créances clients avant d'encaisser ses recettes, tout en ayant déjà réglé ses fournisseurs. BFR = (Stocks + Créances) − Dettes fournisseurs et fiscales/sociales."},
...
x:"Le plan de trésorerie est un tableau prévisionnel mensuel des encaissements et décaissements. Il permet d'anticiper les périodes de tension ou d'excédent de trésorerie et de prendre des décisions adaptées (ligne de crédit, placement…)."},
...
x:"La valeur ajoutée (VA) = Production (chiffre d'affaires ± variation stocks) − Consommations en provenance des tiers (achats de matières, sous-traitance, services externes). Elle mesure la richesse créée par l'entreprise."},
...
x:"L'amortissement comptable représente la dépréciation progressive d'un bien liée à l'usure ou à l'obsolescence. Pour un VUL, on applique généralement un amortissement linéaire sur 4 à 5 ans. Il constitue une charge non décaissée qui réduit le résultat imposable."},
...
x:"Le plan de financement met en regard les besoins (immobilisations, BFR, remboursements d'emprunts) et les ressources (apports, emprunts, CAF) sur plusieurs années. Il permet de vérifier l'équilibre financier du projet et de prévoir les éventuels besoins de financement complémentaire."},
...
x:"Pour exercer le transport public de marchandises avec des véhicules ≤3,5t, l'exploitant doit satisfaire les 3 conditions d'accès : honorabilité professionnelle, capacité financière et capacité professionnelle. L'entreprise doit être inscrite au registre des transporteurs tenu par la DREAL."},
...
x:"Pour un transport public routier de marchandises avec un VUL, le conducteur doit avoir à bord : la lettre de voiture, la copie certifiée conforme de la licence de transport intérieur (LTI) pour les véhicules >3,5t ou le document attestant l'inscription au registre pour les <3,5t."},
...
x:"La lettre de voiture nationale n'a pas de forme légalement imposée (contrairement à la CMR en international). Elle doit cependant mentionner certaines informations essentielles (expéditeur, destinataire, marchandise, transporteur) pour valoir preuve du contrat de transport."},
...
x:"Pour les envois ≥3 tonnes, le contrat type 'général' prévoit que le chargement, le calage et l'arrimage sont à la charge de l'expéditeur. Pour les envois <3 tonnes, ces opérations incombent au transporteur."},
...
x:"Les ZFE-m restreignent la circulation selon la vignette Crit'Air (classement en 6 niveaux selon les émissions polluantes) du véhicule. Les VUL sont concernés au même titre que les voitures particulières et les poids lourds dans les agglomérations concernées."},
...
x:"Les contrats types (arrêté du 5 mai 1988) s'appliquent de plein droit quand les parties n'ont pas conclu de contrat écrit spécifique. Ils peuvent être écartés par une convention particulière plus favorable."},
...
x:"L'article L.3221-3 du Code des transports, qui impose notamment l'obligation de prix rémunérateur, s'applique aux contrats de sous-traitance entre transporteurs publics et entre commissionnaires de transport et transporteurs publics."},
...
x:"Les documents de transport (lettres de voiture, documents de location) doivent être conservés pendant 2 ans par l'entreprise de transport, conformément à l'arrêté du 9 novembre 1999."},
...
x:"Selon l'article L.3222-5 du Code des transports, toute prestation annexe non prévue au contrat de transport (attente anormale, déchargement non prévu, etc.) ouvre droit à un complément de rémunération pour le transporteur."},
...
x:"Si les réserves émises à la livraison ne sont pas acceptées par le transporteur, le destinataire doit les confirmer par écrit (protestation motivée) dans les 3 jours non fériés suivant la livraison (art. L.133-3 du Code de commerce)."},
...
x:"Un transporteur non inscrit au registre des commissionnaires peut sous-traiter jusqu'à 25 % de son chiffre d'affaires transport annuel pour faire face à des surcharges temporaires d'activité. Au-delà, il doit s'inscrire comme commissionnaire."},
...
x:"Le transporteur est présumé responsable de toute perte ou avarie survenue entre la prise en charge et la livraison de la marchandise, sans que le donneur d'ordre ait à prouver une faute. Cette présomption peut être renversée par la preuve d'un cas d'exonération."},
...
x:"Les 3 conditions cumulatives pour exercer la profession de transporteur public routier de marchandises sont : 1) Honorabilité professionnelle (absence de condamnations incompatibles), 2) Capacité financière (fonds propres suffisants), 3) Capacité professionnelle (attestation CPC)."},
...
x:"La capacité financière pour le transport léger (<3,5t) est de 1 800 € pour le 1er véhicule et 900 € par véhicule supplémentaire. Pour le transport lourd (>3,5t), elle est de 9 000 € pour le 1er et 5 000 € par véhicule supplémentaire."},
...
x:"La FIMO est une formation accélérée de 140 heures (4 semaines) dans un centre agréé. Elle permet d'obtenir la CQC (Carte de Qualification du Conducteur). La voie longue de 280 heures correspond aux titres professionnels (CAP, Bac Pro, Titre pro conducteur) qui donnent une équivalence FIMO."},
...
x:"La FCOS dure 35 heures (5 jours) et doit être effectuée dans les 5 ans suivant l'obtention de la CQC (initiale par FIMO) ou le renouvellement précédent. Elle est obligatoire pour maintenir la CQC en cours de validité."},
...
x:"La commission territoriale des sanctions administratives (CTSA) émet un avis consultatif préalablement aux décisions préfectorales de sanctions administratives prises en matière d'infractions à la réglementation des transports et à la réglementation sociale applicable aux transporteurs routiers."},
...
x:"Un VUL (véhicule utilitaire léger) de moins de 3,5t de PTAC est soumis aux mêmes limitations de vitesse qu'une voiture particulière : 130 km/h sur autoroute, 110 km/h sur route à 2 chaussées séparées, 80 km/h sur route."},
...
x:"La vignette Crit'Air est une pastille de couleur (6 niveaux + non classé) classifiant les véhicules selon leurs émissions polluantes. Elle est obligatoire pour circuler dans les ZFE-m et lors des pics de pollution. Elle est délivrée par le Ministère chargé de l'environnement."},
...
x:"Un nouveau conducteur dispose de 6 points dès l'obtention du permis. Pendant la période probatoire de 3 ans, il gagne 2 points par année sans infraction (ou 3 points si aucune infraction sanctionnable), pour atteindre le capital maximum de 12 points."},
...
x:"L'extincteur à poudre ABC (polyvalent) est le plus adapté aux incendies de véhicules car il permet de lutter contre les feux de matières solides (A), de liquides inflammables (B) et de gaz (C). L'extincteur CO2 est efficace sur les feux électriques mais moins polyvalent."},
...
x:"La gérance libre (ou location-gérance) consiste à louer un fonds de commerce pour l'exploiter. Le gérant-locataire dispose du fonds mais n'en est pas propriétaire. Il paie une redevance au propriétaire et exploite l'activité à ses risques et périls."},
...
x:"Les décisions du tribunal de commerce peuvent être contestées devant la Cour d'Appel dans un délai d'1 mois à compter de la signification du jugement. La Cour de Cassation n'est saisie qu'en dernier recours pour contrôle de légalité."},
...
x:"La dépréciation d'un stock se constate par une provision pour dépréciation de stock. Contrairement aux immobilisations (amortissements), les actifs circulants font l'objet de provisions pour dépréciation."},
...
x:"La variation de stock (stock final - stock initial) permet de calculer les consommations réelles de l'exercice. Si le stock final est inférieur au stock initial, l'entreprise a consommé plus qu'elle n'a acheté."},
...
x:"Pour tout transport international entre pays signataires de la CMR, la lettre de voiture CMR est obligatoire. Elle se compose de 3 exemplaires originaux : 1 pour l'expéditeur (rose), 1 accompagnant la marchandise (bleu), 1 conservé par le transporteur (vert)."},
...
x:"Depuis le 1er janvier 2023, le RNE (Registre National des Entreprises) remplace et unifie l'ensemble des registres d'entreprises : le RCS (Registre du Commerce et des Sociétés), le RM (Répertoire des Métiers) et le RAA (Registre des Actifs Agricoles)."},
...
x:"Une convention collective étendue s'applique obligatoirement à tous les employeurs de la branche concernée, qu'ils aient ou non adhéré à l'organisation patronale signataire. L'extension par arrêté ministériel la rend universellement applicable dans le secteur."},
...
r:[{t:"10 salariés"},{t:"11 salariés pendant 12 mois consécutifs",ok:true},{t:"20 salariés"},{t:"50 salariés"}],
x:"Le CSE (Comité Social et Économique) est obligatoire dans toute entreprise employant au moins 11 salariés pendant 12 mois consécutifs. Il remplace depuis 2020 les délégués du personnel, le comité d'entreprise et le CHSCT."},
...
x:"Si le salarié est maintenu dans l'entreprise après l'échéance de son CDD sans nouveau contrat, la relation de travail est automatiquement requalifiée en CDI (Contrat à Durée Indéterminée)."},
...
x:"Un CDD pour accroissement temporaire d'activité peut avoir une durée maximale de 18 mois, renouvellement inclus. Certains cas exceptionnels permettent 24 mois (mission à l'étranger ou attente d'une embauche en CDI)."},
...
x:"En cas d'inaptitude suite à un accident du travail ou maladie professionnelle, si le reclassement est impossible, l'employeur licencie le salarié et lui verse une indemnité spéciale de licenciement équivalente au double de l'indemnité légale normale."},
...
x:"L'aide à l'apprentissage 2026 (décret n°2026-168 du 6 mars 2026) est de 5 000 € maximum pour la 1ère année, pour les entreprises de moins de 250 salariés, pour les diplômes jusqu'au niveau bac. Elle est portée à 6 000 € si l'apprenti est en situation de handicap."},
...
x:"Le PASS est fixé à 48 060 € en 2026 (soit 4 005 €/mois). Il sert de base de calcul pour les cotisations plafonnées et certaines prestations. Il est revalorisé chaque 1er janvier par arrêté ministériel."},
...
x:"La franchise de mise à disposition au chargement est de 2 heures sans rendez-vous fixé. Au-delà, le transporteur peut facturer des frais d'immobilisation selon les barèmes prévus."},
...
x:"Le régime réel simplifié s'applique aux prestataires de services dont le CA HT est compris entre 37 500 € (seuil franchise TVA) et 254 000 €. Au-delà, c'est le régime réel normal. Pour les activités de vente, les seuils sont 85 000 € à 840 000 €."},
...
x:"Pour le calcul de la capacité financière, tous les véhicules motorisés exploités sont pris en compte, quelle que soit la modalité de détention : propriété, location avec conducteur, location sans conducteur (LLD), ou crédit-bail."},

{id:98,prog:'LOURD',theme:'lo-secu',d:2,
...
x:"Depuis novembre 2021, dans les 48 départements de montagne, entre le 1er novembre et le 31 mars, les PL doivent être équipés de pneus hiver OU de dispositifs antidérapants amovibles (chaînes ou chaussettes à neige) sur les roues motrices."},
...
x:"Parts sociales : X = 4 500/26 500 = 17 %, Y = 10 000/26 500 = 37,7 %, Z = 12 000/26 500 = 45,3 %. Z est minoritaire car il détient moins de 50 % des parts. X + Y ensemble = 54,7 % > Z. Z gérant minoritaire peut être salarié."},
...
x:"EBE = Valeur Ajoutée + Subventions d'exploitation − Impôts et taxes − Charges de personnel (salaires + charges sociales). L'EBE mesure la performance économique de l'entreprise indépendamment de sa politique de financement et d'amortissement."},

{id:101,prog:'LOURD',theme:'lo-regl',d:1,
...
x:"La carte entreprise permet uniquement le téléchargement (lecture) des données enregistrées dans les tachygraphes numériques de l'entreprise. La carte conducteur sert à la conduite. La carte atelier permet l'étalonnage et la programmation."},
...
x:"Selon l'article L.132-8 du Code de commerce, le voiturier (transporteur) dispose d'une action directe en paiement contre l'expéditeur, le destinataire et le commissionnaire de transport s'il est intervenu dans la prestation."},
...
x:"En cas de perte totale de la marchandise, la prescription d'un an court à compter du jour où la remise de la marchandise aurait dû être effectuée au destinataire (art. L.133-6 du Code de commerce)."},
...
x:"La clause EXW (Ex Works / à l'usine) signifie que le vendeur met la marchandise à disposition dans ses locaux. L'acheteur prend en charge tous les frais et risques à partir du chargement chez le vendeur, y compris le transport principal."},
...
x:"Le contrat d'assurance est un contrat aléatoire car ses effets dépendent d'un événement incertain (la survenance du sinistre). L'assureur s'engage à indemniser en cas de réalisation du risque, sans savoir à l'avance si et quand cela se produira."},
...
r:[{t:"3 ans"},{t:"5 ans"},{t:"8 ans"},{t:"10 ans",ok:true}],
x:"Les documents comptables (livres, pièces justificatives) doivent être conservés pendant 10 ans (art. L.123-22 du Code de commerce). Cette obligation permet de justifier les opérations lors de contrôles fiscaux ou de litiges commerciaux."},
...
x:"Le taux réduit d'IS de 15 % s'applique sur les premiers 42 500 € de bénéfice imposable pour les PME dont le CA HT < 10 millions d'euros et dont le capital est détenu à 75 % minimum par des personnes physiques. Au-delà, le taux normal de 25 % s'applique."},
...
x:"Le remboursement partiel de TICPE s'applique uniquement au gazole (gazole professionnel) utilisé pour la traction des véhicules affectés au transport routier. Il est demandé trimestriellement ou mensuellement auprès de la DGDDI."},
...
x:"La TVA collectée par le transporteur sur ses prestations est une dette envers l'État dès son émission sur la facture. Le transporteur n'est qu'un intermédiaire collecteur : il doit la reverser à l'administration fiscale dans les délais légaux."},
...
x:"La période de référence légale pour l'acquisition des congés payés est du 1er juin au 31 mai de l'année suivante. Pour les entreprises adhérant à une caisse de congés payés du BTP, d'autres périodes peuvent s'appliquer."},
...
x:"Un salarié à temps plein acquiert 2,5 jours ouvrables de congés payés par mois de travail effectif, soit 30 jours ouvrables (ou 25 jours ouvrés) sur une année complète."},
...
x:"La loi limite le congé principal à 24 jours ouvrables consécutifs maximum (sur les 30 jours annuels). Les 6 jours restants (5e semaine) doivent être pris séparément. Des dérogations existent notamment pour les salariés ayant des contraintes familiales particulières."},
...
x:"La DPAE (Déclaration Préalable à l'Embauche) doit être transmise à l'URSSAF avant toute embauche d'un nouveau salarié (y compris CDD). Elle peut être faite 8 jours avant l'embauche au plus tôt et au plus tard le jour de l'embauche."},
...
x:"L'employeur dispose d'un délai de 2 mois à compter de la connaissance des faits fautifs pour engager les poursuites disciplinaires (convocation à entretien préalable). Passé ce délai, les faits sont prescrits et ne peuvent plus fonder une sanction."},
...
x:"Un devis constitue une offre ferme engageant son émetteur pendant la durée de validité indiquée. L'acceptation du devis par le client forme le contrat. Si aucune durée de validité n'est mentionnée, 30 jours est l'usage courant."},
...
x:"Un DSO de 45 jours signifie que les créances clients sont encaissées en moyenne 45 jours après la facturation. Plus le DSO est élevé, plus le besoin en fonds de roulement (BFR) est important et la trésorerie sollicitée."},
...
x:"Selon le contrat type 'général', au-delà du délai de franchise (2 heures sans rendez-vous), le transporteur peut facturer des frais d'immobilisation selon le barème prévu. Ces frais s'ajoutent au prix de transport et sont dus par le chargeur."},
...
x:"Selon le contrat type 'général', le délai de franchise pour les opérations de déchargement est de 2 heures pour les envois inférieurs à 3 tonnes et de 3 heures pour ceux égaux ou supérieurs à 3 tonnes (pour les ensembles >3,5t)."},
...
x:"La vignette Crit'Air classe 1 (vert) est attribuée aux véhicules hybrides rechargeables et aux véhicules à essence conformes aux normes Euro 5 et 6. La vignette de classe 0 (vert foncé) est réservée aux véhicules 100 % électriques et à hydrogène."},
...
x:"Le registre unique du personnel (art. L.1221-13 du Code du travail) doit mentionner pour chaque salarié : nom, prénom, nationalité, date de naissance, sexe, emploi, qualification, date d'entrée et de sortie, et type de contrat. Il doit être présenté à tout contrôle de l'inspection du travail."},
...
x:"Les décisions administratives du préfet de région (retrait d'autorisation, sanctions administratives) relevant du droit public, les recours doivent être portés devant les juridictions administratives (tribunal administratif, puis cour administrative d'appel, puis Conseil d'État)."},
...
x:"Lors d'un licenciement pour faute lourde, l'employeur doit remettre : l'attestation France Travail, le certificat de travail, et le solde de tout compte. Le salarié perd le droit à l'indemnité de licenciement et à l'indemnité compensatrice de préavis, mais conserve ses congés payés acquis."},
...
x:"Dans une SARL unipersonnelle (EURL), comme dans toute SARL, la responsabilité de l'associé unique est limitée à ses apports. Il ne peut pas être poursuivi sur ses biens personnels pour les dettes sociales, sauf en cas de faute de gestion avérée."},
...
x:"Le seuil de rentabilité en jours (point mort) = (Charges fixes / Taux de MCV) / CA × 365. Il indique à partir de quel jour de l'année l'entreprise commence à dégager un bénéfice. Plus le point mort arrive tôt dans l'année, plus l'entreprise est en sécurité."},
...
x:"Des pénalités de retard sont dues automatiquement au transporteur en cas de dépassement du délai de paiement de 30 jours, sans qu'une mise en demeure soit nécessaire. Le taux légal de pénalités de retard est fixé à 3 fois le taux d'intérêt légal."},
...
x:"La livraison est le moment où la marchandise est mise à la disposition du destinataire et acceptée par lui. C'est à partir de ce moment que le délai pour émettre des réserves commence à courir, et que la responsabilité du transporteur cesse en principe."},
...
x:"Le DUERP est obligatoire dès l'embauche du 1er salarié (art. R.4121-1 du Code du travail). Il répertorie les risques professionnels identifiés dans l'entreprise et les mesures de prévention mises en place. Il doit être mis à jour régulièrement."},
...
x:"Le contrat type 'longue distance' (arrêté du 5 mai 1988) s'applique aux transports de marchandises générales dépassant à la fois 3 tonnes ET 150 km. En dessous de ces seuils, le contrat type 'général' ou un contrat spécifique s'applique."},
...
x:"Le CPF est alimenté en euros depuis le 1er janvier 2019 (auparavant en heures). Les droits acquis en heures avant cette date ont été convertis en euros (1 heure = 15 euros, plafonné à 5 000 €). Le CPF est géré par la Caisse des Dépôts sur Mon Compte Formation."},
...
x:"Le commissionnaire de transport est responsable envers son client (donneur d'ordre) comme s'il avait effectué lui-même les opérations de transport. C'est sa responsabilité propre de commissionnaire, distincte de celle du transporteur sous-traitant."},
...
x:"Le certificat de travail doit mentionner obligatoirement : les dates d'entrée et de sortie et la nature du ou des emplois occupés. Il ne doit pas comporter de mentions discriminatoires ni de motif de rupture. Il est différent de l'attestation France Travail."},
...
x:"La convention collective applicable dans l'entreprise doit être mentionnée sur le bulletin de paie du salarié (art. R.3243-1 du Code du travail). Elle doit également être affichée dans l'entreprise et tenue à la disposition des salariés qui souhaitent la consulter."},
...
x:"Le bilan comptable est un document de synthèse qui décrit à un instant précis (date de clôture de l'exercice) le patrimoine de l'entreprise : à gauche l'actif (emplois des ressources), à droite le passif (ressources = capitaux propres + dettes)."},
...
x:"Le chiffre d'affaires (CA) représente le montant total hors taxes des ventes de biens et des prestations de services réalisées par l'entreprise au cours de l'exercice comptable. C'est l'indicateur de l'activité commerciale de l'entreprise."},
...
x:"Dans une SA, comme dans les autres sociétés de capitaux (SARL, SAS), la responsabilité des actionnaires est limitée à leurs apports. En cas de dettes, ils ne peuvent perdre que le montant qu'ils ont investi dans la société."},
...
x:"La DREAL est le service de l'État chargé du contrôle et de la régulation du transport routier. Elle délivre les titres d'autorisation (licences), gère le RNET (registre des entreprises de transport), et effectue les contrôles en entreprise et sur route."},
...
x:"Le contrat type 'denrées périssables' s'applique aux transports de marchandises périssables nécessitant le respect d'une température dirigée (chaîne du froid). Il impose des obligations spécifiques au transporteur en matière de température et de contrôle."},
...
x:"L'hypothèque est une garantie réelle conventionnelle portant sur un bien immobilier. Le débiteur reste en possession de son bien mais le créancier peut le faire saisir et vendre en cas de non-paiement. C'est la garantie couramment demandée par les banques pour les prêts immobiliers."},
...
x:"Le plan de financement est un tableau prévisionnel sur plusieurs années (généralement 3 à 5 ans) mettant en regard les besoins (investissements, BFR, remboursements) et les ressources (apports en capital, emprunts, CAF). Il permet de vérifier l'équilibre financier du projet."},
...
x:"La liquidation judiciaire est prononcée quand l'entreprise est en cessation de paiement ET que le redressement est manifestement impossible. Elle entraîne la dissolution et la vente des actifs pour rembourser les créanciers dans un ordre légal."},
...
x:"Le tribunal de commerce est composé de juges consulaires : des commerçants ou chefs d'entreprise élus par leurs pairs pour exercer bénévolement des fonctions judiciaires. Ils ne sont pas magistrats professionnels."},
...
x:"Un chèque barré (deux barres parallèles dessinées) ne peut pas être encaissé directement au guichet en espèces. Il doit obligatoirement être remis à une banque pour être porté au crédit d'un compte bancaire."},
...
x:"Le gérant associé majoritaire d'une SARL (détenant plus de 50 % des parts seul, ou plus de 50 % avec ses co-gérants) relève du régime des travailleurs non-salariés (TNS), anciennement RSI, maintenant intégré à l'URSSAF. Il n'est pas salarié."},
...
x:"La solidarité passive (entre débiteurs) permet au créancier de réclamer le paiement de la totalité de la dette à n'importe lequel des codébiteurs solidaires. Le débiteur qui a tout payé dispose ensuite d'un recours contre les autres pour récupérer leurs parts."},
...
x:"Pour les prestations de services B2B intracommunautaires, c'est le principe de territorialité : la TVA est due dans le pays du preneur (client). Le transporteur français facture HT et le client espagnol déclare et paie la TVA espagnole par autoliquidation (article 44 de la directive TVA)."},
...
x:"Une entreprise individuelle (EI) de transport est soumise à l'IR (Impôt sur le Revenu) dans la catégorie des BIC (Bénéfices Industriels et Commerciaux). Le bénéfice s'intègre au revenu global du foyer fiscal du dirigeant."},
...
x:"Le contrat d'apprentissage est ouvert aux personnes de 16 à 29 ans révolus. Des dérogations permettent d'aller au-delà pour les personnes handicapées, celles souhaitant créer une entreprise, ou en cas de rupture du contrat pour cause indépendante de leur volonté."},
...
x:"Les 8 premières heures supplémentaires (de la 36ème à la 43ème heure) sont majorées d'au moins 25 %. À partir de la 44ème heure, le taux est d'au moins 50 %. Ces taux légaux peuvent être augmentés par accord de branche ou d'entreprise."},
...
x:"Selon la convention collective des transports routiers, le préavis d'un conducteur licencié est de : 1 mois pour moins de 2 ans d'ancienneté, 2 mois entre 2 et 5 ans, et 3 mois au-delà de 5 ans. Ces durées peuvent être plus favorables si l'accord de branche le prévoit."},
...
x:"SR = Charges fixes / Taux de MCV = 8 000 / 0,40 = 20 000 €. L'entreprise doit réaliser 20 000 € de CA mensuel pour couvrir toutes ses charges. En dessous, elle est en perte ; au-delà, elle génère du bénéfice."},
...
x:"Coût du trajet = 1,50 × 500 = 750 €. Pour une marge de 20 %, Prix de vente = Coût / (1 - 0,20) = 750 / 0,80 = 937,50 €. Alternative : si 20 % sur le coût (markup), PV = 750 × 1,20 = 900 €. En pratique le raisonnement 'marge sur prix de vente' donne 937,50 €."},
...
x:"L'emprunt bancaire permet d'acquérir la propriété du bien immédiatement (l'entreprise l'inscrit à l'actif). Son coût total est généralement inférieur au crédit-bail. En revanche, il nécessite un apport, immobilise des ressources et figure en dettes dans le bilan."},
...
x:"La lettre de voiture de déménagement est obligatoire pour tout déménagement d'un volume d'au moins 14 m³. En dessous de ce seuil, un document plus simple (devis accepté) peut suffire selon le contrat type déménagement."},
...
x:"Le contrat type de déménagement s'applique aux opérations de déménagement effectuées par des déménageurs professionnels pour le compte de particuliers et de professionnels, incluant le transport et les opérations accessoires (emballage, manutention, stockage)."},
...
x:"La procédure de redressement judiciaire peut être ouverte à la demande : du débiteur lui-même, des créanciers, ou du ministère public (parquet). Elle peut aussi être ouverte d'office par le tribunal dans certaines situations."},
...
x:"La caution personnelle (ou garantie personnelle) est un engagement par lequel le dirigeant s'engage sur ses biens personnels à rembourser la dette de la société en cas de défaillance. C'est la garantie la plus couramment demandée par les banques lors d'un emprunt."},

{id:159,prog:'LOURD',theme:'lo-social',d:3,
...
x:"Selon la CCNTR, la durée maximale du temps de service (conduite + autres travaux + disponibilités) sur une semaine isolée est de 60 heures pour les conducteurs grand routier. En moyenne sur 4 mois, elle est de 48 heures hebdomadaires."},
...
x:"À l'échéance d'un CDD (sauf cas particuliers : CDD de remplacement, CDD étudiant, rupture à la demande du salarié), l'employeur verse une indemnité de fin de contrat (précarité) égale à 10 % de la rémunération totale brute versée pendant le contrat."},
...
x:"Un compte courant d'associé est une créance de l'associé sur la société : il laisse des fonds à la disposition de l'entreprise (souvent sans intérêt ou à taux modeste). Ces sommes sont remboursables mais pas exigibles immédiatement comme un capital (sauf clause contraire)."},
...
x:"Marge sur coûts variables = CA - Charges variables = 100 000 - 60 000 = 40 000 €. Taux de MCV = 40 000 / 100 000 = 40 %. Ce taux indique que pour chaque euro de CA, 0,40 € contribue à couvrir les charges fixes et à générer du bénéfice."},
...
x:"Selon le contrat type de location avec conducteur, c'est le locataire (le transporteur qui commande la prestation) qui assume la maîtrise et la responsabilité des opérations de transport. Le loueur reste employeur du conducteur mais n'est pas responsable du transport."},
...
x:"Toute société doit indiquer sur ses documents commerciaux (factures, devis, courriers, site internet) sa dénomination sociale, sa forme juridique (SARL, SAS, SA...), son numéro SIRET, son siège social et le cas échéant son capital social."},
...
x:"Pour les acquisitions intracommunautaires de moyens de transport neufs, la TVA est due dans le pays de l'acquéreur (France), quel que soit le statut de l'acheteur (assujetti ou non). L'acquéreur français déclare et paie la TVA française."},
...
x:"L'inspecteur du travail peut, sans délai de prévenance ni autorisation préalable, effectuer des visites dans les entreprises à toute heure du jour et de la nuit lorsque du personnel y travaille (art. L.8113-1 du Code du travail). Ses prérogatives sont larges pour contrôler le respect du droit du travail."},
...
x:"Résultat net = CA - Charges = 200 000 - 180 000 = 20 000 €. Taux de rentabilité nette = Résultat net / CA × 100 = 20 000 / 200 000 × 100 = 10 %."},
...
x:"La procédure de sauvegarde est ouverte à la demande du débiteur qui, sans être en cessation de paiement, éprouve des difficultés qu'il ne peut surmonter seul. C'est un outil de prévention permettant de restructurer l'entreprise avant d'atteindre le stade de la cessation de paiement."},
...
x:"La durée légale du travail est fixée à 35 heures hebdomadaires (art. L.3121-27 du Code du travail). C'est le seuil de déclenchement des heures supplémentaires, non la durée maximale autorisée (qui est de 48h/semaine)."},
...
x:"Dans le cadre du transport express avec traçabilité électronique, un bon de transport électronique peut remplacer la lettre de voiture papier traditionelle. La réglementation française admet les documents dématérialisés sous certaines conditions."},
...
x:"L'honorabilité professionnelle est réputée non satisfaite si la personne a fait l'objet d'une condamnation pénale définitive pour certains délits graves : vol, escroquerie, abus de confiance, corruption, travail clandestin, infractions routières graves ayant causé des blessures ou la mort, etc."},
...
x:"Lorsque le CA dépasse le seuil de franchise en base de TVA (37 500 € pour les prestations de services depuis 2026, seuil majoré 41 250 €), l'auto-entrepreneur perd le bénéfice de la franchise et doit collecter et reverser la TVA."},
...
{id:2001,prog:'LOURD',theme:'lo-regl',d:1,
...
x:"L'assurance RC automobile est obligatoire pour tout véhicule mis en circulation (art. L.211-1 du Code des assurances). En revanche, l'assurance des marchandises transportées (responsabilité du transporteur) n'est pas légalement obligatoire, bien que fortement recommandée."},
...
x:"L'article L.132-8 du Code de commerce consacre l'action directe en paiement du transporteur. Le voiturier (transporteur) bénéficie d'un privilège sur la marchandise et peut agir directement contre l'expéditeur, le destinataire ou le commissionnaire de transport."},

{id:2003,prog:'LOURD',theme:'lo-gestion',d:3,
...
x:"Le transporteur doit indemniser tous les dommages justifiés dont il est légalement tenu pour responsable. L'indemnisation est plafonnée par les contrats types (exprimés en €/kg) et ne peut dépasser la valeur réelle de la marchandise. Une déclaration de valeur permet d'augmenter ce plafond."},

{id:2004,prog:'LOURD',theme:'lo-regl',d:2,
...
r:[{t:"1 heure"},{t:"2 heures",ok:true},{t:"3 heures"},{t:"4 heures"}],
x:"Selon le contrat type 'général', le transporteur dispose d'une franchise de 2 heures de mise à disposition au chargement (sans rendez-vous fixé). Au-delà, il peut facturer des frais d'immobilisation au tarif prévu."},

{id:2005,prog:'LOURD',theme:'lo-acces',d:1,
...
x:"Les coopératives de transporteurs exercent leur activité de transport pour le compte de leurs membres. Elles doivent être inscrites au registre des entreprises de transport (RNET) comme toute entreprise de transport public routier."},

{id:2006,prog:'LOURD',theme:'lo-intl',d:2,
e:"La licence de transport intérieur (LTI) a une durée de validité maximale de :",
r:[{t:"3 ans"},{t:"5 ans"},{t:"7 ans"},{t:"10 ans",ok:true}],
x:"La licence de transport intérieur (LTI) et la licence communautaire de transport ont une durée de validité maximale de 10 ans. Elles peuvent être retirées en cas de non-respect des conditions d'accès à la profession."},

{id:2007,prog:'LOURD',theme:'lo-social',d:3,
...
x:"Le document de suivi est utilisé pour les envois fractionnés ou groupés. Il permet de suivre les différentes parties d'un envoi depuis l'expéditeur jusqu'au destinataire, en cas de transbordement ou de groupage."},

{id:2008,prog:'LOURD',theme:'lo-fiscal',d:2,
...
x:"La capacité financière est appréciée sur la base des capitaux propres de l'entreprise, tels qu'ils ressortent du bilan comptable (liasse fiscale). Le montant minimum est déterminé en fonction du nombre de véhicules exploités."},

{id:2009,prog:'LOURD',theme:'lo-acces',d:1,
...
x:"Tout changement substantiel (changement de dirigeant, de gestionnaire de transport, de parc de véhicules, de forme juridique…) doit être déclaré auprès de la DREAL dans un délai de 30 jours."},

{id:2010,prog:'LOURD',theme:'lo-gestion',d:2,
...
x:"Le contrat type de sous-traitance s'applique aux relations entre un donneur d'ordre (transporteur principal ou commissionnaire) et un transporteur sous-traitant (affrété). Il régit notamment les conditions de prix, de responsabilité et les obligations des parties."},
...
x:"L'article L.133-3 du Code de commerce prévoit que le destinataire qui a reçu la marchandise sans réserves perd son droit d'agir contre le transporteur, à moins qu'il n'envoie une protestation motivée dans les 3 jours non fériés suivant la réception."},

{id:2012,prog:'LOURD',theme:'lo-regl',d:2,
...
x:"Les restrictions de circulation du week-end s'appliquent aux véhicules de transport de marchandises de plus de 7,5 tonnes de PTAC (sauf dérogations). En été, la restriction est également applicable le samedi de 7h à 19h pour les véhicules >7,5t."},
...
x:"Selon le règlement 561/2006, après 4h30 de conduite continue (ou accumulée), le conducteur doit prendre une pause d'au moins 45 minutes avant de reprendre la conduite. Cette pause peut être fractionnée en une première partie de 15 min puis une de 30 min."},
...
x:"La pause de 45 minutes peut être fractionnée en deux parties prises dans l'ordre suivant : une première période de 15 minutes minimum, puis une seconde de 30 minutes minimum. L'ordre est impératif : 15 min d'abord, 30 min ensuite."},
...
x:"La durée maximale de conduite journalière est de 9 heures. Elle peut être portée à 10 heures maximum mais pas plus de 2 fois par semaine civile. La durée hebdomadaire ne peut dépasser 56 heures."},
...
x:"Le règlement 561/2006 fixe une double limite : 56 heures maximum par semaine ET 90 heures maximum sur 2 semaines consécutives. Ces deux limites doivent être respectées simultanément."},
...
x:"Lorsque le repos journalier normal (11 heures) est fractionné, il doit être pris en deux parties : la première période d'au moins 3 heures consécutives et la seconde d'au moins 9 heures. Le repos total fractionné est donc de 12 heures minimum."},
...
x:"Le temps de service (temps de conduite + autres travaux + disponibilités) d'un conducteur grand routier est limité à 48 heures hebdomadaires en moyenne sur 12 semaines (ou 4 mois par accord). La durée maximale sur une semaine isolée est de 60 heures."},
...
x:"Selon l'arrêté du 6 juillet 2005, les données de la carte conducteur doivent être téléchargées au moins tous les 28 jours calendaires. Les données de l'unité embarquée (appareil) doivent être téléchargées au moins tous les 90 jours."},
...
x:"La carte entreprise permet uniquement le téléchargement (lecture) des données enregistrées dans la mémoire des tachygraphes numériques. La carte conducteur est nécessaire pour conduire. La carte atelier permet l'étalonnage."},
...
x:"Le temps de service = temps de conduite + autres travaux + disponibilités (attentes). Soit : 7h + 1h + 2h = 10 heures. Les pauses et temps de repas ne sont pas comptabilisés dans le temps de service."},
...
x:"Selon la convention collective des transports routiers, le préavis pour un conducteur ayant entre 6 mois et 2 ans d'ancienneté est de 1 mois. Il est de 2 mois entre 2 et 5 ans, et de 3 mois au-delà de 5 ans."},
...
x:"Le certificat ADR (Accord Européen Relatif au Transport International des Marchandises Dangereuses par Route) du conducteur est valable 5 ans. Pour le conserver, le conducteur doit suivre une formation de recyclage dans les 12 mois précédant l'expiration."},

{id:2024,prog:'LOURD',theme:'lo-secu',d:2,
...
x:"L'usage de pneumatiques rechapés est interdit sur l'essieu directeur (avant) des véhicules à moteur, pour des raisons de sécurité. Il est en revanche autorisé sur les essieux arrière moteurs et sur les essieux des remorques et semi-remorques."},
...
x:"Pour conduire un camion isolé (>7,5t), le conducteur doit avoir : le permis C en cours de validité, la CQC (Carte de Qualification du Conducteur) valide (initiale ou renouvelée par FCO), et la carte conducteur pour le tachygraphe numérique."},
...
x:"Le CRK = Total des charges annuelles (fixes + variables) / Kilométrage annuel. Les charges fixes comprennent : amortissements, salaires, assurances, structure. Les charges variables comprennent : carburant, entretien/pneus, péages, AdBlue."},

{id:2027,prog:'LOURD',theme:'lo-fiscal',d:3,
...
x:"Le CNR publie mensuellement des indices de coûts (carburant, salaires, péages, matériel…) permettant aux transporteurs de : justifier des révisions tarifaires, insérer des clauses d'indexation dans leurs contrats, et comparer leurs propres coûts aux coûts sectoriels."},

{id:2028,prog:'LOURD',theme:'lo-fiscal',d:2,
...
x:"La CAF représente les ressources internes dégagées par l'activité. Elle permet de : rembourser les emprunts, financer de nouveaux investissements (renouvellement du parc), constituer des réserves et éventuellement distribuer des dividendes."},
...
x:"Un transporteur non inscrit au registre des commissionnaires peut sous-traiter jusqu'à 25 % de son CA transport annuel pour faire face à des surcroîts temporaires d'activité. Au-delà, il commet une infraction réglementaire et doit s'inscrire comme commissionnaire."},

{id:2030,prog:'LOURD',theme:'lo-fiscal',d:2,
...
x:"Le suramortissement permet de déduire fiscalement un amortissement supplémentaire (ex. 40 % du prix d'achat en plus de l'amortissement normal) pour les investissements dans des véhicules à énergies alternatives. Cela réduit la base imposable et donc l'IS."},
...
x:"Le B100 (colza pur) nécessite des adaptations moteur spécifiques et une vidange supplémentaire annuelle, ce qui engendre des surcoûts d'entretien. La consommation est légèrement supérieure au gazole (+2 à 3 litres/100 km), mais les émissions de CO2 fossile sont très réduites."},
...
x:"Le retraitement du crédit-bail en analyse financière consiste à : ajouter la valeur brute du bien en actif immobilisé (comme s'il était propriétaire) et ajouter les engagements restants du crédit-bail aux dettes financières. Cela donne une image plus fidèle de la structure financière."},
...
x:"Loyer mensuel = Prix HT × taux = 110 000 × 1,36 % = 1 496 € HT/mois. Ce mode de calcul du crédit-bail est une méthode simplifiée consistant à appliquer directement le coefficient mensuel au prix d'achat."},
...
x:"VA = Production (CA ± variation de stocks) − Consommations intermédiaires. Dans le transport, les consommations intermédiaires comprennent notamment : carburant, sous-traitance transport, entretien, assurances, loyers de crédit-bail…"},

{id:2035,prog:'LOURD',theme:'lo-civil',d:3,
...
x:"Depuis la loi de modernisation de l'économie (LME), le délai maximal de paiement pour les prestations de transport est de 30 jours à compter de la date d'émission de la facture. Des pénalités de retard sont dues automatiquement en cas de dépassement."},

{id:2036,prog:'LOURD',theme:'lo-social',d:2,
...
x:"La FIMO est une formation accélérée de 140 heures (4 semaines) dans un centre agréé, permettant d'obtenir la CQC initiale. La voie longue de 280 heures correspond aux titres professionnels (CAP conducteur, Titre Pro CTRMP/CTRMV) qui donnent une équivalence FIMO."},
...
x:"La lettre de voiture doit accompagner la marchandise pendant tout le transport et être présentée à la demande des agents de contrôle (DREAL, gendarmerie, police). Elle constitue la preuve du contrat de transport."},
...
x:"Le PTAC d'un véhicule moteur à 3 essieux est limité à 26 tonnes en France. Pour un véhicule à 2 essieux, il est de 19 tonnes. Le poids maximal d'un ensemble articulé à 5 essieux est de 44 tonnes."},
...
x:"La longueur maximale d'un ensemble articulé (tracteur + semi-remorque) est de 16,50 mètres. Un train routier (porteur + remorque) peut atteindre 18,75 mètres. Les dimensions hors normes nécessitent une autorisation de transport exceptionnel."},
...
x:"La longueur maximale d'un train routier (véhicule à moteur + remorque) est de 18,75 mètres. La longueur maximale d'un ensemble articulé (tracteur + semi-remorque) est de 16,50 mètres."},
...
{id:2043,prog:'LOURD',theme:'lo-social',d:1,
e:"La carte de conducteur pour tachygraphe numérique a une durée de validité de :",
r:[{t:"1 an"},{t:"3 ans"},{t:"5 ans",ok:true},{t:"10 ans"}],
x:"La carte conducteur pour tachygraphe numérique est valable 5 ans. Elle doit être renouvelée avant expiration. En cas d'impossibilité technique, le conducteur peut utiliser des feuilles d'enregistrement papier pendant 7 jours maximum."},
...
x:"Pour les grumes et pièces de grande longueur, le dépassement autorisé est de 1 m à l'avant et 3 m à l'arrière du véhicule. Ces dépassements doivent être signalés par des dispositifs réflectorisants ou des panneaux."},

{id:2045,prog:'LOURD',theme:'lo-secu',d:2,
...
x:"La remorque d'un train routier de PMA ≥40 tonnes doit afficher à l'arrière trois disques de limitation de vitesse : 60 km/h (routes ordinaires), 80 km/h (routes à 2 chaussées séparées) et 90 km/h (autoroute). Ces disques doivent être bien lisibles."},
...
x:"Un véhicule >3 m de large constitue un transport exceptionnel de 1ère catégorie (jusqu'à 3 m de large : APL - Autorisation de Portée Locale, entre 3 et 3,50 m : autorisation individuelle de 1ère catégorie). Au-delà de 3,50 m, c'est la 2ème catégorie."},

{id:2047,prog:'LOURD',theme:'lo-secu',d:1,
...
x:"La circulation des PL transportant des marchandises dangereuses soumises à signalisation (panneaux orange) est interdite de 12h00 le samedi à 24h00 le dimanche (arrêté du 22 janvier 1992 modifié)."},
...
x:"Pour le transport lourd (>3,5t), la capacité financière est de 9 000 € pour le 1er véhicule et 5 000 € par véhicule supplémentaire. Cette condition doit être satisfaite à tout moment de la vie de l'entreprise."},
...
x:"L'honorabilité professionnelle doit être prouvée pour toutes les personnes ayant une responsabilité dans la direction de l'entreprise : les gérants (ou dirigeants) ET le gestionnaire de transport (ou directeur des transports), qu'il soit interne ou externe."},

{id:2050,prog:'LOURD',theme:'lo-social',d:2,
...
x:"L'inscription au RNET est matérialisée par la délivrance d'une licence de transport intérieur (LTI) pour le transport national, ou d'une licence communautaire (LC) pour le transport international dans l'UE. Ces titres sont délivrés par la DREAL."},
...
x:"La Convention CMR s'applique à tout contrat de transport international de marchandises par route à titre onéreux lorsque le lieu de prise en charge de la marchandise et le lieu de livraison sont situés dans deux pays différents, dont l'un au moins est signataire de la Convention."},
...
x:"Selon la CMR, pour les dommages non apparents lors de la livraison, le délai est de 7 jours calendaires (non fériés) pour émettre des réserves écrites. Pour les dommages apparents, les réserves doivent être émises au moment de la livraison."},
...
x:"Selon la CMR, l'indemnité pour retard à la livraison est limitée au prix du transport. Si le transporteur est en dol ou faute inexcusable, la prescription passe de 1 an à 3 ans, et le plafond d'indemnisation peut être levé."},
...
x:"Pour un transport France-Pologne en transit par l'Allemagne, le transporteur français doit avoir : une copie certifiée conforme de la licence communautaire + la lettre de voiture CMR. L'ensemble du trajet (transit inclus) est couvert par la licence communautaire au sein de l'UE."},
...
x:"Le cabotage (transport national dans un pays étranger après un transport international entrant) est autorisé dans l'UE avec la licence communautaire, dans la limite de 3 opérations en 7 jours. Aucune autorisation bilatérale n'est requise au sein de l'UE."},
...
x:"L'attestation de conducteur est un document permettant à un ressortissant d'un pays tiers (non UE/EEE) d'être employé légalement comme conducteur dans l'UE. Elle est exigée lors des transports internationaux effectués sous couvert d'une licence communautaire."},
...
x:"La déclaration de détachement est obligatoire pour les opérations de cabotage (transport national dans un pays étranger). Elle se fait sur la plateforme IMI (Internal Market Information) avant le début du détachement. Les règles du pays d'accueil (salaire minimum, durée du travail) s'appliquent alors."},
...
x:"Le carnet TIR est un document douanier international permettant le transport de marchandises sous scellés, en suspendant les droits et taxes dans les pays de transit. Il est principalement utilisé pour les transports traversant des pays hors UE (Turquie, Maroc, pays de la CEI...)."},
...
x:"Selon la CMR, la lettre de voiture est établie par l'expéditeur ou par le transporteur agissant sous la responsabilité de l'expéditeur. Elle est établie en 3 exemplaires minimum : 1 pour l'expéditeur, 1 accompagne la marchandise (pour le destinataire), 1 conservé par le transporteur."},
...
x:"La licence communautaire est délivrée au transporteur, pas au véhicule. Le transporteur français utilisant son tracteur (propriété française) avec une semi-remorque étrangère est couvert par sa propre licence communautaire française pour l'ensemble du transport."},
...
x:"La FCO dure 35 heures (5 jours) et doit être réalisée tous les 5 ans pour maintenir la CQC (Carte de Qualification du Conducteur) valide. Elle peut être fractionnée sur plusieurs semaines dans certaines conditions."},
...
x:"Le repos hebdomadaire normal est de 45 heures consécutives minimum. Il peut être réduit à 24 heures (repos réduit) une fois sur deux semaines, à condition de récupérer la réduction dans les 3 semaines suivantes."},
...
x:"Le droit de retrait (art. L.4131-1 du Code du travail) permet à un salarié de se retirer d'une situation de danger grave et imminent. Il doit simultanément exercer son droit d'alerte en informant son employeur ou son représentant."},

{id:2065,prog:'LOURD',theme:'lo-intl',d:2,
...
x:"La copie certifiée conforme de la licence communautaire est obligatoire dans le véhicule pendant tout le transport public de marchandises pour compte d'autrui avec des véhicules de plus de 3,5t de PTAC."},

{id:2066,prog:'LOURD',theme:'lo-civil',d:1,
...
x:"Les hayons élévateurs, grues auxiliaires et chariots élévateurs embarqués font l'objet d'une vérification obligatoire tous les 6 mois par un technicien qualifié ou un organisme agréé."},

{id:2067,prog:'LOURD',theme:'lo-social',d:2,
...
x:"La CTSA émet un avis consultatif préalable aux décisions préfectorales de sanctions administratives à l'encontre des entreprises de transport pour des infractions à la réglementation des transports et à la réglementation sociale applicable."},

{id:2068,prog:'LOURD',theme:'lo-fiscal',d:2,
...
x:"Le pied de facture d'indexation carburant est une clause permettant d'ajuster le prix du transport selon la variation mensuelle du prix du gazole (indices CNR). Il protège le transporteur contre les hausses de prix de l'énergie."},
...
x:"La trésorerie nette = FRNG − BFR. Une trésorerie négative signifie que le FRNG ne couvre pas le BFR. L'entreprise doit recourir à des financements à court terme (découvert, escompte) pour financer son cycle d'exploitation."},
...
x:"Selon la CMR, l'indemnité est calculée d'après la valeur de la marchandise au lieu et à la date de la prise en charge. Le plafond est de 8,33 DTS/kg brut. Une déclaration de valeur dans la lettre de voiture permet d'augmenter ce plafond."},
...
x:"Pour bénéficier du régime TIR, l'entreprise française obtient un certificat d'agrément auprès de l'AFTRI, association garante française agréée par les douanes nationales."},

{id:2072,prog:'LOURD',theme:'lo-secu',d:2,
...
x:"Des pneus de structures ou sculptures différentes sont autorisés sur des essieux différents. Sur un même essieu (ou en jumelage), les pneus doivent être identiques en structure et dimensions."},

{id:2073,prog:'LOURD',theme:'lo-social',d:3,
...
x:"Lors d'un contrôle routier dans un pays de l'UE, le document administratif à présenter est la copie certifiée conforme de la licence communautaire. C'est le titre d'autorisation d'exercer le transport international dans l'UE."},
...
x:"Les données de l'unité embarquée (le tachygraphe) doivent être téléchargées au moins tous les 90 jours calendaires. Les données de la carte conducteur doivent être téléchargées tous les 28 jours."},
...
x:"La largeur maximale d'un véhicule de transport de marchandises est de 2,55 mètres (toutes saillies comprises). Exception : les véhicules isothermes (transport sous température dirigée) peuvent avoir une largeur maximale de 2,60 mètres."},

{id:2076,prog:'LOURD',theme:'lo-gestion',d:2,
...
x:"Selon l'article L.3222-5 du Code des transports, toute prestation annexe non prévue initialement (déchargement non convenu, attente anormale, prestations complémentaires...) donne droit à un complément de rémunération pour le transporteur."},

{id:2077,prog:'LOURD',theme:'lo-intl',d:2,
...
x:"Le délai de prescription ordinaire en CMR est d'1 an à compter de la livraison ou de la date prévue de livraison. En cas de dol ou de faute inexcusable du transporteur, le délai est porté à 3 ans."},

{id:2078,prog:'LOURD',theme:'lo-intl',d:1,
...
x:"La lettre de voiture CMR est établie en 3 exemplaires originaux : le 1er (rouge) est remis à l'expéditeur, le 2ème (bleu) accompagne la marchandise jusqu'au destinataire, le 3ème (vert) est conservé par le transporteur."},

{id:2079,prog:'LOURD',theme:'lo-gestion',d:2,
...
x:"Un convoi dont la largeur dépasse 3 m constitue un transport exceptionnel de 1ère catégorie (entre 3 et 3,50 m) nécessitant une autorisation individuelle délivrée par la DREAL. Au-delà de 3,50 m, c'est la 2ème catégorie avec escorte."},

{id:2080,prog:'LOURD',theme:'lo-civil',d:3,
...
x:"L'amplitude hebdomadaire maximale d'un conducteur grand routier est de 60 heures sur une semaine isolée. En moyenne sur 4 mois (ou 12 semaines), elle ne peut dépasser 48 heures hebdomadaires."},

{id:2081,prog:'LOURD',theme:'lo-intl',d:2,
...
x:"Un EBE positif mais faible signifie que l'entreprise génère une ressource d'exploitation mais insuffisante pour couvrir confortablement ses charges financières, ses amortissements et avoir un résultat net satisfaisant. Une vigilance s'impose sur la rentabilité à terme."},

{id:2082,prog:'LOURD',theme:'lo-gestion',d:2,
...
x:"Un taux de sous-traitance de 18,5 % du CA transport est légal car il reste en dessous du seuil maximum de 25 % autorisé sans inscription au registre des commissionnaires de transport. Au-delà de 25 %, l'inscription comme commissionnaire serait nécessaire."},

{id:2083,prog:'LOURD',theme:'lo-intl',d:1,
...
x:"L'attestation de formation ADR du conducteur est délivrée par la DREAL après réussite aux examens théoriques et pratiques organisés en fin de formation dans un établissement agréé. La DREAL délivre également les licences de transport."},
...
x:"La CQC (obtenue par la FIMO puis maintenue par la FCOS) est obligatoire pour tous les conducteurs de véhicules >3,5t, qu'ils soient salariés ou travailleurs indépendants, effectuant des transports nationaux ou internationaux sur le territoire de l'UE."},
...
x:"Un FRNG négatif signifie que l'actif immobilisé n'est pas entièrement financé par des ressources stables (capitaux propres + dettes à LT). L'entreprise finance une partie de ses investissements avec des ressources à court terme, ce qui constitue un déséquilibre financier potentiellement dangereux."},
...
x:"Selon le règlement (CE) n°1072/2009, le cabotage est limité à 3 opérations de transport national dans les 7 jours suivant le déchargement complet d'un transport international entrant. Après ces 3 opérations ou les 7 jours, le véhicule doit quitter le pays."},

{id:2087,prog:'LOURD',theme:'lo-social',d:2,
...
x:"Les immobilisations nettes (ou valeur nette comptable - VNC) = Valeur brute d'acquisition - Amortissements cumulés. Elles représentent la valeur résiduelle des biens au bilan. À l'issue du plan d'amortissement, la VNC est nulle ou égale à la valeur résiduelle estimée."},
...
x:"La condition de capacité financière est une obligation permanente : elle doit être satisfaite à tout moment de la vie de l'entreprise, pas seulement lors de la création ou de modifications du parc. Un contrôle peut être effectué à tout moment par la DREAL."},
...
x:"Le certificat de travail doit mentionner les dates d'entrée et de sortie du salarié et la nature du ou des emplois occupés. Il ne doit pas comporter d'appréciations qualitatives ni le motif de rupture (ces mentions pourraient être discriminatoires)."},

{id:2091,prog:'LOURD',theme:'lo-social',d:2,
...
x:"Lors d'un contrôle routier, le conducteur de PL doit présenter : permis de conduire, CQC en cours de validité, carte conducteur tachygraphe, copie certifiée de la licence communautaire, lettre de voiture, données tachygraphe des 28 derniers jours."},
...
{id:2093,prog:'LOURD',theme:'lo-fiscal',d:2,
...
x:"La facture professionnelle doit mentionner notamment : identification des parties, date, numéro de facture, description de la prestation, prix HT, taux et montant de TVA, montant TTC, date d'échéance, conditions d'escompte (même si non accordé), et taux des pénalités de retard."},

{id:2094,prog:'LOURD',theme:'lo-intl',d:1,
...
x:"Pour le transport national (France-France) avec un véhicule >3,5t, le conducteur doit avoir à bord une copie certifiée conforme de la licence communautaire (et non l'original). La copie certifiée est propre à chaque véhicule."},
...
x:"Le taux de vétusté = Amortissements cumulés / Valeur brute × 100. Plus ce taux est élevé (proche de 100 %), plus le parc est ancien et amorti. Un taux supérieur à 70 % indique généralement un besoin de renouvellement important du parc."},
...
x:"Lors d'un détachement (cabotage ou transport international), les règles du pays d'accueil s'appliquent, notamment pour le salaire minimum. En cabotage en Allemagne, le conducteur doit percevoir au moins le salaire minimum légal allemand pour les jours travaillés sur le territoire allemand."},

{id:2097,prog:'LOURD',theme:'lo-regl',d:1,
...
x:"Avant chaque transport, le donneur d'ordre fournit généralement au transporteur une lettre de voiture pré-renseignée (lieu de chargement, de livraison, nature de la marchandise, etc.). Le conducteur la complète et signe à la prise en charge de la marchandise."},

{id:2098,prog:'LOURD',theme:'lo-acces',d:3,
...
x:"Exercer le transport public de marchandises sans être inscrit au RNET constitue un délit (art. L.3452-4 du Code des transports) passible d'une peine d'emprisonnement pouvant aller jusqu'à 1 an et d'une amende de 15 000 €, ainsi que l'immobilisation du véhicule."},
...
x:"Pour un conducteur routier embauché en CDD de 12 mois, la période d'essai est de 1 mois non renouvelable. Pour un CDD de 6 mois, elle est proportionnellement réduite. Ces durées peuvent être différentes selon la convention collective applicable."},
...
x:"Ratio d'indépendance financière = Capitaux propres / Dettes financières = 71 778 / 125 413 = 0,57. Ce ratio signifie que pour 1 € de dettes financières, l'entreprise dispose de 0,57 € de capitaux propres. Il est inférieur à 1, signalant une dépendance financière modérée."},

{id:2101,prog:'LOURD',theme:'lo-fiscal',d:2,
...
x:"Pour les prestations de transport intra-communautaires B2B (entre assujettis à la TVA), la facture est émise HT avec la mention 'Autoliquidation' ou 'Exonération article 44 de la directive TVA'. C'est l'acheteur (le client allemand) qui déclare et paie la TVA dans son pays."},

{id:2102,prog:'LOURD',theme:'lo-gestion',d:3,
...
x:"Lorsqu'une infraction est constatée (surcharge axiale ou totale), les frais de pesée et de déplacement éventuel du véhicule sont à la charge du transporteur responsable. Si le véhicule est conforme, les frais sont à la charge de l'autorité ayant demandé la pesée."},
...
x:"La semi-remorque standard a une longueur de plancher de chargement d'environ 13,6 à 13,8 mètres. La longueur totale de l'ensemble articulé est limitée à 16,5 mètres, le tracteur mesurant environ 2,5 à 3 mètres de l'avant jusqu'au point d'attelage."},
...
x:"Selon la réglementation européenne et la convention collective des transports routiers, tout conducteur a le droit de demander à son employeur la copie des données de sa carte conducteur. L'employeur doit lui remettre dans un délai raisonnable."},

{id:2105,prog:'LOURD',theme:'lo-fiscal',d:3,
...
x:"Le plan de trésorerie mensuel prévisible permet d'anticiper les flux de trésorerie (encaissements/décaissements) et d'identifier en avance les mois de tension. Cela permet de prendre des mesures : ligne de crédit, report de charges, négociation de délais avec les fournisseurs."},
...
x:"Les autorisations bilatérales de transport s'utilisent pour les pays qui ne sont pas membres de l'UE et avec lesquels un accord bilatéral a été conclu (Maroc, Turquie, pays des Balkans non-UE...). Au sein de l'UE, la licence communautaire suffit."},

{id:2107,prog:'LOURD',theme:'lo-social',d:2,
...
{id:2109,prog:'LOURD',theme:'lo-regl',d:2,
...
{id:2111,prog:'LOURD',theme:'lo-acces',d:1,
...
{id:2112,prog:'LOURD',theme:'lo-social',d:1,
...
{id:2114,prog:'LOURD',theme:'lo-gestion',d:3,
...
{id:2115,prog:'LOURD',theme:'lo-civil',d:2,
...
{id:2116,prog:'LOURD',theme:'lo-acces',d:2,
...
{id:2118,prog:'LOURD',theme:'lo-social',d:2,
...
{id:2119,prog:'LOURD',theme:'lo-social',d:3,
...
{id:2120,prog:'LOURD',theme:'lo-gestion',d:2,
...
{id:2122,prog:'LOURD',theme:'lo-social',d:1,
...
{id:2124,prog:'LOURD',theme:'lo-secu',d:1,
...
{id:2125,prog:'LOURD',theme:'lo-social',d:3,
...
{id:2126,prog:'LOURD',theme:'lo-social',d:2,
...
{id:2128,prog:'LOURD',theme:'lo-social',d:2,
...
{id:2129,prog:'LOURD',theme:'lo-social',d:2,
...
{id:2130,prog:'LOURD',theme:'lo-acces',d:1,
...
{id:2131,prog:'LOURD',theme:'lo-social',d:2,
...
{id:2132,prog:'LOURD',theme:'lo-social',d:1,
...
{id:2134,prog:'LOURD',theme:'lo-social',d:3,
...
{id:2136,prog:'LOURD',theme:'lo-secu',d:3,
...
{id:2137,prog:'LOURD',theme:'lo-secu',d:1,
...
{id:2139,prog:'LOURD',theme:'lo-fiscal',d:2,
...
{id:2140,prog:'LOURD',theme:'lo-social',d:1,
...
{id:2141,prog:'LOURD',theme:'lo-social',d:1,
...
{id:2142,prog:'LOURD',theme:'lo-fiscal',d:3,
...
{id:2143,prog:'LOURD',theme:'lo-civil',d:2,
...
{id:2144,prog:'LOURD',theme:'lo-secu',d:2,
...
{id:2145,prog:'LOURD',theme:'lo-social',d:3,
...
{id:2146,prog:'LOURD',theme:'lo-social',d:2,
...
{id:2147,prog:'LOURD',theme:'lo-social',d:1,
...
{id:2148,prog:'LOURD',theme:'lo-acces',d:2,
...
{id:2149,prog:'LOURD',theme:'lo-social',d:1,
e:"La durée maximale de conduite sur 2 semaines consécutives est de :",
...
{id:2150,prog:'LOURD',theme:'lo-acces',d:2,
...
{id:2151,prog:'LOURD',theme:'lo-intl',d:2,
...
{id:2153,prog:'LOURD',theme:'lo-social',d:2,
...
{id:2154,prog:'LOURD',theme:'lo-social',d:1,
...
{id:2155,prog:'LOURD',theme:'lo-secu',d:2,
...
{id:2156,prog:'LOURD',theme:'lo-social',d:2,
...
{id:2158,prog:'LOURD',theme:'lo-intl',d:2,
...
{id:2159,prog:'LOURD',theme:'lo-social',d:3,
...
{id:2160,prog:'LOURD',theme:'lo-civil',d:1,
...
{id:2162,prog:'LOURD',theme:'lo-regl',d:2,
...
{id:2164,prog:'LOURD',theme:'lo-social',d:3,
...
{id:2165,prog:'LOURD',theme:'lo-social',d:1,
...
{id:2166,prog:'LOURD',theme:'lo-intl',d:1,
...
{id:2167,prog:'LOURD',theme:'lo-secu',d:2,
...
{id:2168,prog:'LOURD',theme:'lo-social',d:2,
...
{id:2170,prog:'LOURD',theme:'lo-civil',d:1,
...
{id:2171,prog:'LOURD',theme:'lo-social',d:2,
...
{id:2172,prog:'LOURD',theme:'lo-secu',d:2,
...
{id:2173,prog:'LOURD',theme:'lo-social',d:3,
...
{id:2175,prog:'LOURD',theme:'lo-social',d:2,
...
{id:2177,prog:'LOURD',theme:'lo-social',d:2,
...
{id:2178,prog:'LOURD',theme:'lo-gestion',d:1,
...
{id:2179,prog:'LOURD',theme:'lo-social',d:2,
...
{id:2181,prog:'LOURD',theme:'lo-fiscal',d:2,
...
{id:2182,prog:'LOURD',theme:'lo-civil',d:2,
...
{id:2184,prog:'LOURD',theme:'lo-civil',d:2,
...
{id:2186,prog:'LOURD',theme:'lo-social',d:2,
...
{id:2187,prog:'LOURD',theme:'lo-civil',d:1,
...
{id:2188,prog:'LOURD',theme:'lo-social',d:1,
...
{id:2189,prog:'LOURD',theme:'lo-fiscal',d:2,
...
{id:2190,prog:'LOURD',theme:'lo-social',d:1,
...
{id:2191,prog:'LOURD',theme:'lo-secu',d:2,
...
{id:2194,prog:'LOURD',theme:'lo-social',d:2,
...
{id:2196,prog:'LOURD',theme:'lo-secu',d:3,
...
{id:2199,prog:'LOURD',theme:'lo-social',d:1,
...
{id:2201,prog:'LOURD',theme:'lo-secu',d:2,
...
{id:2204,prog:'LOURD',theme:'lo-intl',d:2,
...
{id:2205,prog:'LOURD',theme:'lo-social',d:2,
...
{id:2206,prog:'LOURD',theme:'lo-social',d:2,
...
{id:2207,prog:'LOURD',theme:'lo-social',d:3,
...
{id:2208,prog:'LOURD',theme:'lo-regl',d:2,
...
{id:2209,prog:'LOURD',theme:'lo-social',d:2,
...
{id:2211,prog:'LOURD',theme:'lo-civil',d:2,
...
{id:2214,prog:'LOURD',theme:'lo-secu',d:2,
...
{id:2215,prog:'LOURD',theme:'lo-fiscal',d:2,
...
{id:2217,prog:'LOURD',theme:'lo-secu',d:3,
...
{id:2220,prog:'LOURD',theme:'lo-secu',d:2,
...
{id:2221,prog:'LOURD',theme:'lo-civil',d:1,
...
{id:2224,prog:'LOURD',theme:'lo-social',d:3,
...
{id:2225,prog:'LOURD',theme:'lo-civil',d:1,
...
{id:2226,prog:'LOURD',theme:'lo-social',d:3,
...
{id:2228,prog:'LOURD',theme:'lo-secu',d:1,
...
{id:2229,prog:'LOURD',theme:'lo-secu',d:2,
...
{id:2233,prog:'LOURD',theme:'lo-intl',d:2,
...
{id:2234,prog:'LOURD',theme:'lo-social',d:2,
...
{id:2237,prog:'LOURD',theme:'lo-social',d:2,
...
{id:2239,prog:'LOURD',theme:'lo-social',d:2,
...
{id:2241,prog:'LOURD',theme:'lo-social',d:2,
...
{id:2242,prog:'LOURD',theme:'lo-intl',d:2,
...
{id:2244,prog:'LOURD',theme:'lo-gestion',d:3,
...
{id:2246,prog:'LOURD',theme:'lo-social',d:2,
...
{id:2247,prog:'LOURD',theme:'lo-secu',d:1,
...
{id:2248,prog:'LOURD',theme:'lo-civil',d:3,
...
{id:2249,prog:'LOURD',theme:'lo-social',d:3,
...
{id:2250,prog:'LOURD',theme:'lo-secu',d:2,
...
{id:2251,prog:'LOURD',theme:'lo-social',d:3,
...
{id:2252,prog:'LOURD',theme:'lo-fiscal',d:2,
...
{id:2255,prog:'LOURD',theme:'lo-fiscal',d:2,
...
{id:2256,prog:'LOURD',theme:'lo-civil',d:2,
...
{id:2257,prog:'LOURD',theme:'lo-secu',d:3,
...
{id:2258,prog:'LOURD',theme:'lo-social',d:2,
...
{id:2259,prog:'LOURD',theme:'lo-regl',d:1,
...
{id:2260,prog:'LOURD',theme:'lo-social',d:3,
...
{id:2262,prog:'LOURD',theme:'lo-civil',d:2,
...
{id:2263,prog:'LOURD',theme:'lo-gestion',d:2,
...
{id:2264,prog:'LOURD',theme:'lo-social',d:2,
...
{id:2266,prog:'LOURD',theme:'lo-secu',d:1,
...
{id:2267,prog:'LOURD',theme:'lo-social',d:1,
...
{id:2268,prog:'LOURD',theme:'lo-fiscal',d:2,
...
{id:2269,prog:'LOURD',theme:'lo-intl',d:1,
...
{id:2272,prog:'LOURD',theme:'lo-social',d:3,
...
{id:2276,prog:'LOURD',theme:'lo-social',d:1,
...
{id:2277,prog:'LOURD',theme:'lo-fiscal',d:2,
...
{id:2278,prog:'LOURD',theme:'lo-secu',d:2,
...
{id:2280,prog:'LOURD',theme:'lo-social',d:1,
...
{id:2281,prog:'LOURD',theme:'lo-acces',d:3,
...
{id:2282,prog:'LOURD',theme:'lo-regl',d:1,
...
{id:2285,prog:'LOURD',theme:'lo-acces',d:2,
...
{id:2286,prog:'LOURD',theme:'lo-social',d:1,
...
{id:2287,prog:'LOURD',theme:'lo-civil',d:2,
...
{id:2288,prog:'LOURD',theme:'lo-social',d:2,
...
{id:2289,prog:'LOURD',theme:'lo-acces',d:2,
...
{id:2290,prog:'LOURD',theme:'lo-fiscal',d:2,
...
{id:2292,prog:'LOURD',theme:'lo-social',d:3,
...
{id:2293,prog:'LOURD',theme:'lo-civil',d:3,
...
{id:2294,prog:'LOURD',theme:'lo-secu',d:1,
...
{id:2295,prog:'LOURD',theme:'lo-acces',d:3,
...
{id:2297,prog:'LOURD',theme:'lo-social',d:2,
...
{id:2298,prog:'LOURD',theme:'lo-secu',d:2,
...
{id:2300,prog:'LOURD',theme:'lo-fiscal',d:2,
...
{id:2302,prog:'LOURD',theme:'lo-social',d:2,
...
{id:2303,prog:'LOURD',theme:'lo-secu',d:2,
...
{id:2305,prog:'LOURD',theme:'lo-acces',d:2,
...
{id:2306,prog:'LOURD',theme:'lo-fiscal',d:2,
...
{id:2307,prog:'LOURD',theme:'lo-social',d:2,
...
{id:2309,prog:'LOURD',theme:'lo-social',d:2,
...
{id:2310,prog:'LOURD',theme:'lo-social',d:2,
...
{id:2311,prog:'LOURD',theme:'lo-intl',d:3,
...
{id:2313,prog:'LOURD',theme:'lo-gestion',d:2,
...
{id:2314,prog:'LOURD',theme:'lo-civil',d:3,
...
{id:2315,prog:'LOURD',theme:'lo-acces',d:1,
...
{id:2316,prog:'LOURD',theme:'lo-civil',d:2,
...
{id:2317,prog:'LOURD',theme:'lo-social',d:3,
...
{id:2318,prog:'LOURD',theme:'lo-social',d:2,
...
{id:2320,prog:'LOURD',theme:'lo-social',d:3,
...
{id:2321,prog:'LOURD',theme:'lo-social',d:2,
...
{id:2322,prog:'LOURD',theme:'lo-social',d:3,
...
{id:2323,prog:'LOURD',theme:'lo-social',d:3,
...
{id:2324,prog:'LOURD',theme:'lo-gestion',d:2,
...
{id:2325,prog:'LOURD',theme:'lo-intl',d:1,
...
{id:2327,prog:'LOURD',theme:'lo-social',d:1,
...
{id:2328,prog:'LOURD',theme:'lo-social',d:3,
...
{id:2329,prog:'LOURD',theme:'lo-secu',d:1,
...
{id:2330,prog:'LOURD',theme:'lo-social',d:3,
...
{id:2331,prog:'LOURD',theme:'lo-social',d:3,
...
{id:2332,prog:'LOURD',theme:'lo-social',d:1,
...
{id:2333,prog:'LOURD',theme:'lo-social',d:2,
...
{id:2334,prog:'LOURD',theme:'lo-civil',d:3,
...
{id:2335,prog:'LOURD',theme:'lo-social',d:1,
...
{id:2336,prog:'LOURD',theme:'lo-social',d:2,
...
{id:2337,prog:'LOURD',theme:'lo-civil',d:2,
...
x:"Les cotisations retraite de base (régime général) comprennent une part plafonnée (jusqu'au plafond SS, 48 060 €/an en 2026) et une part déplafonnée (sur la totalité du salaire). Le taux patronal total est d'environ 8,55 % + 2,02 % = 10,57 %. Ces taux varient légèrement chaque année. S'y ajoutent les cotisations AGIRC-ARRCO pour la retraite complémentaire."},

{id:2338,prog:'LOURD',theme:'lo-social',d:2,
...
{id:2339,prog:'LOURD',theme:'lo-social',d:1,
...
{id:2340,prog:'LOURD',theme:'lo-social',d:2,
...
{id:2341,prog:'LOURD',theme:'lo-social',d:3,
...
{id:2345,prog:'LOURD',theme:'lo-civil',d:2,
...
{id:2346,prog:'LOURD',theme:'lo-gestion',d:2,
...
{id:2347,prog:'LOURD',theme:'lo-civil',d:2,
...
{id:2351,prog:'LOURD',theme:'lo-civil',d:1,
...
{id:2352,prog:'LOURD',theme:'lo-secu',d:1,
...
{id:2353,prog:'LOURD',theme:'lo-social',d:2,
...
{id:2354,prog:'LOURD',theme:'lo-secu',d:2,
...
{id:2355,prog:'LOURD',theme:'lo-social',d:1,
...
{id:2356,prog:'LOURD',theme:'lo-social',d:2,
...
{id:2357,prog:'LOURD',theme:'lo-regl',d:2,
...
{id:2360,prog:'LOURD',theme:'lo-civil',d:1,
...
{id:2361,prog:'LOURD',theme:'lo-social',d:3,
...
{id:2362,prog:'LOURD',theme:'lo-social',d:2,
...
{id:2363,prog:'LOURD',theme:'lo-civil',d:1,
...
{id:2364,prog:'LOURD',theme:'lo-social',d:2,
...
{id:2365,prog:'LOURD',theme:'lo-social',d:2,
...
{id:2366,prog:'LOURD',theme:'lo-social',d:2,
...
{id:2367,prog:'LOURD',theme:'lo-secu',d:3,
...
{id:2368,prog:'LOURD',theme:'lo-regl',d:2,
...
{id:2369,prog:'LOURD',theme:'lo-social',d:1,
...
{id:2371,prog:'LOURD',theme:'lo-social',d:3,
...
{id:2372,prog:'LOURD',theme:'lo-secu',d:3,
...
{id:2373,prog:'LOURD',theme:'lo-gestion',d:2,
...
{id:2375,prog:'LOURD',theme:'lo-intl',d:2,
...
{id:2377,prog:'LOURD',theme:'lo-social',d:2,
...
{id:2378,prog:'LOURD',theme:'lo-social',d:2,
...
{id:2379,prog:'LOURD',theme:'lo-intl',d:2,
...
{id:2380,prog:'LOURD',theme:'lo-gestion',d:1,
...
{id:2381,prog:'LOURD',theme:'lo-secu',d:3,
...
{id:2382,prog:'LOURD',theme:'lo-social',d:3,
...
{id:2383,prog:'LOURD',theme:'lo-social',d:3,
...
{id:2384,prog:'LOURD',theme:'lo-civil',d:2,
...
{id:2385,prog:'LOURD',theme:'lo-social',d:2,
...
{id:2386,prog:'LOURD',theme:'lo-social',d:2,
...
{id:2387,prog:'LOURD',theme:'lo-social',d:3,
...
{id:2388,prog:'LOURD',theme:'lo-gestion',d:2,
...
{id:2390,prog:'LOURD',theme:'lo-gestion',d:2,
...
{id:2391,prog:'LOURD',theme:'lo-social',d:2,
...
{id:2392,prog:'LOURD',theme:'lo-social',d:3,
...
{id:2393,prog:'LOURD',theme:'lo-social',d:1,
...
{id:2396,prog:'LOURD',theme:'lo-intl',d:1,
...
{id:2397,prog:'LOURD',theme:'lo-fiscal',d:2,
...
{id:2398,prog:'LOURD',theme:'lo-social',d:1,
...
{id:2400,prog:'LOURD',theme:'lo-civil',d:2,
...
{id:2401,prog:'LOURD',theme:'lo-fiscal',d:2,
...
{id:2403,prog:'LOURD',theme:'lo-social',d:3,
...
x:"L'ADR est un accord international initialement applicable aux transports internationaux. En France, il a été transposé en droit national par arrêté, ce qui le rend applicable aux transports nationaux. La réglementation ADR est actualisée tous les 2 ans."},
...
x:"Toute entreprise dont l'activité comprend l'expédition, le conditionnement, le chargement, le remplissage ou le transport de marchandises dangereuses doit désigner un CSTMD (Conseiller à la Sécurité pour le Transport de Marchandises Dangereuses). Des seuils d'exemption existent pour les petites quantités."},
...
x:"Le certificat ADR du conducteur est valable 5 ans. Pour le renouveler, le conducteur doit suivre une formation de recyclage dans les 12 mois précédant l'expiration. S'il n'est pas renouvelé à temps, une nouvelle formation initiale complète est nécessaire."},
...
x:"La classe 6.1 de l'ADR regroupe les matières toxiques : substances qui, par inhalation, ingestion ou pénétration cutanée, peuvent provoquer la mort ou de graves lésions même en faible quantité."},
...
x:"Les 9 classes ADR classifient les marchandises dangereuses selon leur nature du danger principal : classe 1 (explosifs), classe 2 (gaz), classes 3 à 9 (liquides inflammables, solides inflammables, comburants, toxiques, radioactives, corrosives, divers)."},
...
x:"Les exemptions pour petites quantités (quantités limitées - LQ) sont accordées selon des seuils spécifiques définis dans le chapitre 3.4 de l'ADR pour chaque matière. Ces exemptions permettent d'expédier des matières dangereuses sans toutes les contraintes normales de l'ADR."},
...
x:"Le numéro ONU est un identifiant numérique à 4 chiffres attribué par les Nations Unies permettant d'identifier une matière dangereuse de manière unique et universelle, indépendamment de la langue. Il figure sur les panneaux orange réfléchissants du véhicule."},
...
x:"Les panneaux orange réfléchissants ADR doivent mesurer 400 mm de largeur × 300 mm de hauteur, avec un liseré noir de 15 mm. Ils indiquent en haut le code de danger (Kemler) et en bas le numéro ONU de la matière transportée."},
...
r:[{t:"1 an"},{t:"3 ans"},{t:"5 ans",ok:true},{t:"10 ans"}],
x:"Le rapport annuel du CSTMD (Conseiller à la Sécurité pour le Transport de Marchandises Dangereuses) doit être conservé par l'entreprise pendant 5 ans et être mis à la disposition de l'autorité compétente sur demande."},
...
x:"La classe 3 de l'ADR regroupe les liquides inflammables : substances liquides ayant un point d'éclair ≤60°C. Exemples : carburants, alcools, solvants organiques. Ces matières sont identifiées par une étiquette rouge en forme de losange avec une flamme."},
...
x:"La classe 8 de l'ADR regroupe les matières corrosives : substances qui, par action chimique, peuvent causer des dommages graves aux tissus vivants ou endommager ou détruire d'autres marchandises ou les moyens de transport. Exemples : acides, bases fortes, chlore."},
...
x:"La classe 2 de l'ADR regroupe les gaz : substances gazeuses à température ambiante et pression normale, ou transportées sous pression (comprimés), sous forme liquéfiée par refroidissement ou à l'état dissous. Exemples : propane, butane, dioxyde de carbone, acétylène."},
...
x:"Les groupes d'emballage de l'ADR indiquent le niveau de danger : groupe I = danger élevé, groupe II = danger moyen, groupe III = danger faible. Plus le groupe est bas (I), plus les exigences d'emballage sont strictes."},
...
x:"La classe 5.1 de l'ADR concerne les matières comburantes : substances qui, sans être nécessairement combustibles elles-mêmes, libèrent de l'oxygène et favorisent la combustion d'autres matières. Exemples : oxygène liquide, peroxyde d'hydrogène concentré, nitrates."},
...
x:"L'UN 1203 (ONU 1203) correspond à l'essence (carburant automobile, essence sans plomb). C'est une matière de classe 3 (liquide inflammable), groupe d'emballage II, très couramment transportée par les camions-citernes."},
...
x:"Dans le code Kemler (panneau orange), le premier chiffre indique le danger principal et le second les dangers secondaires. '3' = risque d'inflammation ; '33' = liquide très inflammable (point d'éclair <23°C). La répétition d'un chiffre intensifie le danger."},
...
x:"La classe 7 de l'ADR concerne les matières radioactives : matières contenant des radionucléides et dont l'activité massique et l'activité totale dépassent certains seuils. Exemples : uranium, plutonium, matières médicales radioactives, déchets nucléaires."},
...
x:"Le document de transport ADR doit mentionner : le numéro ONU précédé de 'UN', la désignation officielle de transport, la classe ADR, le groupe d'emballage (si applicable), la quantité (en kg ou litres) et d'autres mentions selon la matière."},
...
x:"Les consignes de sécurité (anciennement 'fiches de sécurité') doivent être rédigées dans les langues des pays traversés (expédition, transit, destination). Elles doivent être conservées à portée du conducteur dans la cabine et lui indiquer les mesures à prendre en cas d'accident."},
...
x:"Le certificat d'agrément ADR du véhicule-citerne (délivré après inspection par un organisme agréé) doit être à bord du véhicule et présenté lors de tout contrôle routier. Il atteste que le véhicule répond aux prescriptions de l'ADR."},
...
x:"L'attestation de formation ADR du conducteur (le certificat) doit être portée sur lui pendant le transport et présentée à toute réquisition des agents de contrôle. Elle prouve que le conducteur est habilité à transporter les matières dangereuses concernées."},
...
x:"Les emballages ADR doivent porter la marque ONU (symbole UN dans un hexagone) attestant qu'ils ont réussi les épreuves de performance requises pour la matière transportée. Cette marque inclut le type d'emballage, le groupe d'emballage maximum, l'année de fabrication et le pays de délivrance."},
...
x:"Le régime des quantités limitées (LQ) permet de transporter des petites quantités de matières dangereuses avec des exigences allégées : pas de formation ADR spécifique, pas de panneaux orange, marquage simplifié (carré blanc/noir sur colis). Des seuils par matière sont définis dans la table A."},
...
x:"Les quantités exceptées (EQ) concernent des quantités très petites (généralement quelques ml ou grammes par emballage intérieur) transportées avec des exemptions quasi-totales : pas de formation, pas de marquage spécial (sauf marque EQ), pas de document de transport ADR spécifique requis."},
...
x:"Pour le transport en vrac d'une seule matière dangereuse, le véhicule doit afficher à l'avant ET à l'arrière des panneaux orange réfléchissants portant en haut le code danger (Kemler) et en bas le numéro ONU de la matière transportée."},
...
x:"Lorsqu'un véhicule transporte plusieurs matières dangereuses en colis, il doit apposer des panneaux orange vierges (sans numéros) à l'avant et à l'arrière. Les étiquettes de danger sur les colis permettent d'identifier chaque matière."},
...
x:"Les étiquettes de danger ADR sur les colis doivent mesurer 100 mm × 100 mm minimum. Elles sont en forme de losange et utilisent des codes couleurs normalisés pour chaque classe. Pour les petits colis, elles peuvent être réduites proportionnellement."},
...
x:"Les grandes étiquettes (plaques-étiquettes) apposées sur les citernes, conteneurs-citernes et véhicules-citernes doivent mesurer au moins 250 mm × 250 mm. Elles sont de même forme et couleur que les étiquettes de danger normales mais en format agrandi."},
...
x:"En cas d'incident/accident, les consignes de sécurité ADR prescrivent : couper le moteur, ne pas fumer, garer et immobiliser le véhicule en lieu sûr, mettre les feux de détresse, baliser à distance, éloigner les personnes des abords, prévenir les secours (18, 15, 17 ou 112) en indiquant la nature du danger."},
...
x:"Tout véhicule soumis à l'ADR doit être équipé d'au moins un extincteur d'une capacité minimale de 6 kg de poudre (ou équivalent) pour lutter contre les incendies du moteur ou de la cabine. Des extincteurs supplémentaires peuvent être requis pour certains véhicules."},
...
x:"En cas d'immobilisation d'un véhicule transportant des marchandises dangereuses, les cônes ou triangles de signalisation doivent être implantés à au moins 100 mètres du véhicule de chaque côté. Des fusées de signalisation ne doivent pas être utilisées avec des matières inflammables."},
...
x:"Le stationnement d'un véhicule transportant des matières dangereuses doit être effectué en lieu sûr, à l'écart des habitations, des sources d'ignition et des installations à risques. Des dispositions spécifiques s'appliquent pour les matières les plus dangereuses (explosifs, radioactifs…)."},
...
x:"L'ADR est révisé tous les 2 ans par la CEE-ONU (Commission Économique pour l'Europe des Nations Unies). Les nouvelles éditions entrent en vigueur au 1er janvier des années impaires avec une période de transition de 6 mois."},
...
x:"La classe 4.1 comprend les matières solides inflammables, les matières et mélanges autoréactifs et les explosibles désensibilisés solides. Exemples : soufre, métaux en poudre, allumettes."},
...
x:"La classe 9 est une classe 'fourre-tout' regroupant les matières dangereuses ne rentrant dans aucune autre classe. Exemples : piles au lithium, appareils magnétisés, matières biodégradables transportées à chaud, véhicules."},
...
x:"Les consignes écrites doivent être conservées dans la cabine et accessibles au conducteur pendant tout le transport. Elles indiquent les mesures à prendre en cas d'accident, les EPI (Équipements de Protection Individuelle) requis et les numéros d'urgence."},
...
x:"Les consignes ADR en cas d'incident prévoient : couper le moteur, ne pas fumer, garer et immobiliser le véhicule en lieu sûr, mettre les feux de détresse, baliser à distance, éloigner les personnes, prévenir les secours (112) en indiquant la nature du danger."},
...
r:[{t:"2 kg"},{t:"6 kg",ok:true},{t:"9 kg"},{t:"12 kg"}],
x:"Tout véhicule soumis à l'ADR doit être équipé d'au moins un extincteur d'une capacité minimale de 6 kg de poudre (ou équivalent) pour lutter contre les incendies du moteur ou de la cabine."},
...
x:"Il existe différents modules de formation ADR : de base (matières en colis), citerne (pour les transports en citernes), et des formations spécifiques classes 1 et 7. Le conducteur doit posséder les modules correspondant aux matières et modes de transport effectivement utilisés."},
...
x:"Quand un véhicule transporte en vrac plusieurs matières dangereuses différentes, il doit apposer des panneaux orange vierges (sans numéros) à l'avant et à l'arrière. Les plaques-étiquettes sur les compartiments identifient chaque matière."},
...
x:"Le régime LQ permet de transporter de petites quantités de matières dangereuses avec des exigences allégées : pas de formation ADR spécifique du conducteur, pas de panneaux orange requis, marquage simplifié sur les colis. Des seuils spécifiques sont définis pour chaque matière."},
