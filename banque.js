...
r:[{t:"La perte de la moitié de son capital social"},{t:"Le passif exigible dépasse l'actif disponible",ok:true},{t:"Une infraction imputable automatiquement aux dirigeants"},{t:"La tenue d'une comptabilité irrégulière"}],
x:"Bonne réponse : Le passif exigible dépasse l'actif disponible. La cessation de paiement est définie comme l'impossibilité pour une entreprise de faire face à son passif exigible (dettes arrivées à échéance) avec son actif disponible (liquidités). C'est le déclencheur d'une procédure collective."},
...
r:[{t:"Requérant"},{t:"Transporteur obligatoirement"},{t:"Destinataire"},{t:"Le débiteur, ou l'un d'eux s'ils sont plusieurs",ok:true}],
x:"Bonne réponse : Le débiteur, ou l'un d'eux s'ils sont plusieurs. La procédure d'injonction de payer doit être introduite devant le tribunal compétent du lieu du domicile du débiteur (ou de l'un d'eux s'ils sont plusieurs). Le tribunal compétent en matière commerciale est le tribunal de commerce."},
...
r:[{t:"Dont la provision est bloquée pendant le délai légal de présentation"},{t:"Visé par le banquier"},{t:"Pour lequel le porteur a obtenu de la banque un certificat de non-paiement"},{t:"Le banquier atteste la provision, non bloquée",ok:true}],
x:"Bonne réponse : Le banquier atteste la provision, non bloquée. Un chèque certifié est un chèque sur lequel le banquier du tireur atteste l'existence de la provision au moment de la certification. Cette provision n'est pas bloquée (contrairement au chèque de banque)."},
...
r:[{t:"La signature des statuts par les associés"},{t:"La publication au journal d'annonces légales"},{t:"Son immatriculation au RNE",ok:true},{t:"La réalisation de son premier acte de commerce"}],
x:"Bonne réponse : Son immatriculation au RNE. La personnalité morale d'une société est acquise à partir de son immatriculation au Registre National des Entreprises (RNE), anciennement RCS, qui remplace depuis 2023 les différents registres d'entreprises."},
...
r:[{t:"Restent bloqués pendant toute la durée de vie de la société"},{t:"Bloqués jusqu'à l'immatriculation, puis disponibles",ok:true},{t:"Sont fictifs et ne sont jamais disponibles"},{t:"Restent bloqués pendant 2 ans"}],
x:"Bonne réponse : Bloqués jusqu'à l'immatriculation, puis disponibles. Les fonds constituant le capital social sont bloqués sur un compte spécial jusqu'à l'immatriculation de la société. Une fois immatriculée, ils sont débloqués et mis à la disposition de la société pour son activité."},
...
r:[{t:"La TVA est remboursée immédiatement à l'entreprise"},{t:"Pas de TVA facturée ni récupérable sur les achats",ok:true},{t:"La TVA est réduite à 5,5 %"},{t:"L'entreprise est exonérée d'impôt sur les bénéfices"}],
x:"Bonne réponse : Pas de TVA facturée ni récupérable sur les achats. Sous le régime de la franchise en base de TVA, l'entreprise ne facture pas de TVA à ses clients (facturation HT avec la mention 'TVA non applicable - article 293 B du CGI'). En contrepartie, elle ne peut pas récupérer la TVA sur ses achats."},
...
r:[{t:"La cotisation foncière des entreprises (CFE) uniquement"},{t:"La cotisation sur la valeur ajoutée (CVAE) uniquement"},{t:"La cotisation foncière (CFE) et la cotisation sur la valeur ajoutée (CVAE)",ok:true},{t:"L'impôt sur les sociétés et la taxe professionnelle"}],
x:"Bonne réponse : La cotisation foncière (CFE) et la cotisation sur la valeur ajoutée (CVAE). La contribution économique territoriale (CET) remplace l'ancienne taxe professionnelle depuis 2010. Elle comprend la CFE (Cotisation Foncière des Entreprises), assise sur la valeur locative des biens, et la CVAE (Cotisation sur la Valeur Ajoutée des Entreprises)."},

{id:31,prog:'LEGER',theme:'cl-fiscal',d:2,
e:"La TICPE (Taxe Intérieure de Consommation sur les Produits Énergétiques) est :",
r:[{t:"Une taxe sur les bénéfices des entreprises pétrolières"},{t:"Une taxe payée à l'État par les utilisateurs de carburant",ok:true},{t:"Un remboursement automatique de taxe pour les transporteurs"},{t:"Une cotisation sociale sur les salaires des chauffeurs"}],
x:"Bonne réponse : Une taxe payée à l'État par les utilisateurs de carburant. La TICPE est une taxe indirecte incluse dans le prix du carburant, payée à l'État lors de l'achat. Les transporteurs routiers professionnels bénéficient d'un remboursement partiel forfaitaire de TICPE sur le gazole professionnel."},
...
r:[{t:"Avant l'entretien préalable"},{t:"Après l'entretien préalable"},{t:"Dans les 8 jours suivant l'envoi du licenciement",ok:true},{t:"Avant la fin du délai-congé (préavis)"}],
x:"Bonne réponse : Dans les 8 jours suivant l'envoi du licenciement. Pour un licenciement économique individuel, l'employeur doit notifier l'administration (DREETS) dans les 8 jours ouvrables qui suivent l'envoi de la lettre de licenciement (art. R.1233-2 du Code du travail)."},
...
r:[{t:"Lors de la remise effective de la lettre par le facteur au salarié"},{t:"À la présentation de la lettre au domicile du salarié",ok:true},{t:"Lors du retrait de la lettre à la poste par le salarié absent"},{t:"À la date d'expédition de la lettre recommandée"}],
x:"Bonne réponse : À la présentation de la lettre au domicile du salarié. Le préavis commence à courir à la date de première présentation de la lettre recommandée au domicile du salarié, même si celui-ci est absent et ne l'a pas encore retirée."},
...
r:[{t:"Prive le salarié de ses droits à l'assurance chômage"},{t:"Est une démission déguisée"},{t:"Un accord commun employeur-salarié, avec droit au chômage",ok:true},{t:"N'ouvre droit à aucune indemnité pour le salarié"}],
x:"Bonne réponse : Un accord commun employeur-salarié, avec droit au chômage. La rupture conventionnelle (art. L.1237-11 du Code du travail) est une modalité de rupture d'un CDI d'un commun accord. Le salarié perçoit une indemnité spécifique (au moins égale à l'indemnité légale de licenciement) et peut percevoir les allocations chômage."},
...
r:[{t:"200 €/an pour tous les salariés sans distinction"},{t:"500 €/an pour les salariés sans qualification (plafond 5 000 €)"},{t:"500 €/an pour un salarié niveau bac (plafond 5 000 €)",ok:true},{t:"800 €/an pour tous les salariés (plafond 8 000 €)"}],
x:"Bonne réponse : 500 €/an pour un salarié niveau bac (plafond 5 000 €). Le CPF (Compte Personnel de Formation) est alimenté à 500 €/an pour les salariés à temps plein ayant au moins un niveau bac (plafond 5 000 €), et à 800 €/an pour les salariés sans qualification (plafond 8 000 €)."},

{id:48,prog:'LEGER',theme:'cl-gestion',d:1,
e:"Le seuil de rentabilité (ou point mort) est atteint lorsque :",
r:[{t:"L'entreprise dégage sa marge bénéficiaire prévisionnelle"},{t:"Le chiffre d'affaires permet de couvrir les charges fixes uniquement"},{t:"Le CA couvre toutes les charges, fixes et variables",ok:true},{t:"Le chiffre d'affaires permet de couvrir les charges sociales"}],
x:"Bonne réponse : Le CA couvre toutes les charges, fixes et variables. Le seuil de rentabilité est le niveau de chiffre d'affaires à partir duquel l'entreprise couvre l'intégralité de ses charges (fixes + variables) et commence à dégager un bénéfice. En dessous, elle est en perte."},

{id:49,prog:'LEGER',theme:'cl-gestion',d:2,
e:"Les disponibilités au bilan représentent :",
r:[{t:"Les sommes encaissées tout au long de l'exercice"},{t:"L'apport financier de l'entreprise ou des associés"},{t:"Les liquidités disponibles à la date du bilan",ok:true},{t:"Le bénéfice net de l'entreprise"}],
x:"Bonne réponse : Les liquidités disponibles à la date du bilan. Les disponibilités représentent les fonds immédiatement disponibles : soldes des comptes bancaires, solde caisse, valeurs mobilières de placement immédiatement réalisables. C'est la trésorerie active au sens strict."},

{id:50,prog:'LEGER',theme:'cl-gestion',d:2,
e:"Le fonds de roulement net global (FRNG) se calcule ainsi :",
r:[{t:"Capitaux propres − actif immobilisé"},{t:"(Capitaux propres + dettes long terme) − actif immobilisé",ok:true},{t:"Dettes à court terme − actif circulant"},{t:"Actif circulant − passif circulant"}],
x:"Bonne réponse : (Capitaux propres + dettes long terme) − actif immobilisé. Le FRNG (Fonds de Roulement Net Global) = Ressources stables (capitaux propres + emprunts LT) − Emplois stables (actif immobilisé net). Un FRNG positif signifie que les ressources stables financent non seulement les immobilisations mais aussi une partie de l'actif circulant."},
...
r:[{t:"Le bénéfice net après impôt uniquement"},{t:"Les ressources internes générées par l'activité",ok:true},{t:"La différence entre actif circulant et passif circulant"},{t:"Le montant des amortissements de l'exercice"}],
x:"Bonne réponse : Les ressources internes générées par l'activité. La CAF mesure la capacité de l'entreprise à générer des ressources par son activité. Formule simplifiée : CAF = Résultat net + Dotations aux amortissements et provisions − Reprises. Elle sert à rembourser les emprunts, investir, distribuer des dividendes."},

{id:53,prog:'LEGER',theme:'cl-gestion',d:2,
e:"Le crédit-bail (leasing) présente comme avantage principal pour un transporteur :",
r:[{t:"La propriété immédiate du véhicule dès le premier loyer"},{t:"L'absence de tout engagement contractuel sur la durée"},{t:"Préserve la trésorerie, loyers déductibles en charges",ok:true},{t:"Un coût global inférieur à l'achat comptant"}],
x:"Bonne réponse : Préserve la trésorerie, loyers déductibles en charges. Le crédit-bail préserve la trésorerie (pas d'immobilisation de capital), les loyers sont déductibles en charges d'exploitation, et le véhicule est récent. En contrepartie, le coût global est supérieur à l'achat comptant et l'entreprise n'est pas propriétaire pendant le contrat."},

{id:54,prog:'LEGER',theme:'cl-gestion',d:3,
e:"Le ratio d'indépendance financière se calcule ainsi :",
r:[{t:"Chiffre d'affaires / Dettes financières"},{t:"(Capitaux propres + provisions) / Dettes financières",ok:true},{t:"Actif immobilisé / Capitaux permanents"},{t:"Résultat net / Capitaux propres"}],
x:"Bonne réponse : (Capitaux propres + provisions) / Dettes financières. Le ratio d'indépendance financière = (Capitaux propres + provisions pour risques et charges) / Dettes financières. Plus ce ratio est élevé, plus l'entreprise est financièrement indépendante. Un ratio supérieur à 1 est généralement considéré comme sain."},
...
r:[{t:"Calculer son résultat fiscal pour l'exercice"},{t:"Prévoir les besoins et excédents de trésorerie",ok:true},{t:"Établir le bilan comptable prévisionnelle"},{t:"Planifier les effectifs de l'entreprise"}],
x:"Bonne réponse : Prévoir les besoins et excédents de trésorerie. Le plan de trésorerie est un tableau prévisionnel mensuel des encaissements et décaissements. Il permet d'anticiper les périodes de tension ou d'excédent de trésorerie et de prendre des décisions adaptées (ligne de crédit, placement…)."},

{id:57,prog:'LEGER',theme:'cl-gestion',d:3,
e:"La valeur ajoutée (VA) d'une entreprise se calcule ainsi :",
r:[{t:"Chiffre d'affaires − Achats de marchandises"},{t:"Production − Consommations intermédiaires",ok:true},{t:"Résultat d'exploitation − Dotations aux amortissements"},{t:"Excédent brut d'exploitation − Charges financières"}],
x:"Bonne réponse : Production − Consommations intermédiaires. La valeur ajoutée (VA) = Production (chiffre d'affaires ± variation stocks) − Consommations en provenance des tiers (achats de matières, sous-traitance, services externes). Elle mesure la richesse créée par l'entreprise."},
...
r:[{t:"Calculer le seuil de rentabilité de la première année"},{t:"Vérifier l'équilibre besoins / ressources du projet",ok:true},{t:"Prévoir les recrutements nécessaires"},{t:"Établir le budget prévisionnel de publicité"}],
x:"Bonne réponse : Vérifier l'équilibre besoins / ressources du projet. Le plan de financement met en regard les besoins (immobilisations, BFR, remboursements d'emprunts) et les ressources (apports, emprunts, CAF) sur plusieurs années. Il permet de vérifier l'équilibre financier du projet et de prévoir les éventuels besoins de financement complémentaire."},
...
r:[{t:"Uniquement un permis B en cours de validité"},{t:"Inscription au registre et capacité professionnelle légère",ok:true},{t:"Un permis C et une attestation FIMO (Formation Initiale Minimale Obligatoire)"},{t:"Uniquement un numéro SIRET actif"}],
x:"Bonne réponse : Inscription au registre et capacité professionnelle légère. Pour exercer le transport public de marchandises avec des véhicules ≤3,5t, l'exploitant doit satisfaire les 3 conditions d'accès : honorabilité professionnelle, capacité financière et capacité professionnelle. L'entreprise doit être inscrite au registre des transporteurs tenu par la DREAL."},
...
r:[{t:"Une copie certifiée conforme de la licence communautaire"},{t:"L'original de la licence de transport intérieur"},{t:"Lettre de voiture et copie conforme de la licence intérieure",ok:true},{t:"Uniquement sa carte d'identité et le permis de conduire"}],
x:"Bonne réponse : Lettre de voiture et copie conforme de la licence intérieure. Pour un transport public routier de marchandises avec un VUL, le conducteur doit avoir à bord : la lettre de voiture, la copie certifiée conforme de la licence de transport intérieur (LTI) pour les véhicules >3,5t ou le document attestant l'inscription au registre pour les <3,5t."},
...
r:[{t:"Une interdiction totale de circuler dans les agglomérations"},{t:"Vignette Crit'Air et restrictions selon les émissions",ok:true},{t:"Le remplacement obligatoire du parc de véhicules en 2025"},{t:"Uniquement des contraintes pour les poids lourds"}],
x:"Bonne réponse : Vignette Crit'Air et restrictions selon les émissions. Les ZFE-m restreignent la circulation selon la vignette Crit'Air (classement en 6 niveaux selon les émissions polluantes) du véhicule. Les VUL sont concernés au même titre que les voitures particulières et les poids lourds dans les agglomérations concernées."},

{id:65,prog:'LEGER',theme:'cl-regl',d:1,
e:"Les contrats types pour les transports routiers de marchandises s'appliquent :",
r:[{t:"Obligatoirement dans tous les cas"},{t:"Uniquement aux transports internationaux"},{t:"Quand les parties n'ont rien fixé par écrit",ok:true},{t:"Uniquement quand les parties se sont accordées expressément"}],
x:"Bonne réponse : Quand les parties n'ont rien fixé par écrit. Les contrats types (arrêté du 5 mai 1988) s'appliquent de plein droit quand les parties n'ont pas conclu de contrat écrit spécifique. Ils peuvent être écartés par une convention particulière plus favorable."},
...
r:[{t:"Un avis avant une sanction préfectorale (transports, social)",ok:true},{t:"Des décisions de sanctions administratives définitives"},{t:"Un avis préalablement à une décision d'autorisation d'exercer la profession"},{t:"Des avis de sanctions auprès du ministre des transports"}],
x:"Bonne réponse : Un avis avant une sanction préfectorale (transports, social). La commission territoriale des sanctions administratives (CTSA) émet un avis consultatif préalablement aux décisions préfectorales de sanctions administratives prises en matière d'infractions à la réglementation des transports et à la réglementation sociale applicable aux transporteurs routiers."},
...
r:[{t:"12 points dès l'obtention"},{t:"6 points, puis 2 de plus par an sans infraction sur 3 ans",ok:true},{t:"6 points définitivement et 3 autres chaque année pour atteindre 12 points"},{t:"6 points puis 6 autres au bout d'un an sans infraction"}],
x:"Bonne réponse : 6 points, puis 2 de plus par an sans infraction sur 3 ans. Un nouveau conducteur dispose de 6 points dès l'obtention du permis. Pendant la période probatoire de 3 ans, il gagne 2 points par année sans infraction (ou 3 points si aucune infraction sanctionnable), pour atteindre le capital maximum de 12 points."},
...
r:[{t:"Tous les 5 ans quelle que soit la taille de l'entreprise"},{t:"Chaque année uniquement pour les entreprises de plus de 50 salariés"},{t:"Chaque année si plus de 11 salariés, sinon par unité de travail",ok:true},{t:"Tous les 2 ans pour les entreprises de plus de 11 salariés"}],
x:"Bonne réponse : Chaque année si plus de 11 salariés, sinon par unité de travail. Le DUERP doit être mis à jour : chaque année dans les entreprises d'au moins 11 salariés, lors de toute décision d'aménagement modifiant les conditions de travail, et lors de tout accident du travail. Dans les entreprises de moins de 11 salariés, la mise à jour est faite lors de chaque nouvelle unité de travail."},
...
r:[{t:"La lettre de voiture nationale"},{t:"La lettre de voiture CMR (transport international par route)",ok:true},{t:"Uniquement le bon de livraison"},{t:"Un document bilingue franco-polonais"}],
x:"Bonne réponse : La lettre de voiture CMR (transport international par route). Pour tout transport international entre pays signataires de la CMR, la lettre de voiture CMR est obligatoire. Elle se compose de 3 exemplaires originaux : 1 pour l'expéditeur (rose), 1 accompagnant la marchandise (bleu), 1 conservé par le transporteur (vert)."},

{id:87,prog:'LEGER',theme:'cl-civil',d:3,
e:"Depuis le 1er janvier 2023, le RNE (Registre National des Entreprises) se substitue :",
r:[{t:"Au RCS (Registre du Commerce et des Sociétés) uniquement"},{t:"Au RM (Répertoire des Métiers) uniquement"},{t:"À tous les registres d'entreprises : RCS, RM, RAA",ok:true},{t:"Uniquement au RCS des sociétés anonymes"}],
x:"Bonne réponse : À tous les registres d'entreprises : RCS, RM, RAA. Depuis le 1er janvier 2023, le RNE (Registre National des Entreprises) remplace et unifie l'ensemble des registres d'entreprises : le RCS (Registre du Commerce et des Sociétés), le RM (Répertoire des Métiers) et le RAA (Registre des Actifs Agricoles)."},

{id:88,prog:'LEGER',theme:'cl-social',d:1,
e:"L'application d'une convention collective étendue est obligatoire pour :",
r:[{t:"Uniquement les employeurs ayant signé la convention"},{t:"Uniquement les employeurs qui ont demandé l'extension"},{t:"Tous les employeurs entrant dans son champ d'application",ok:true},{t:"Les employeurs de la branche ayant plus de 10 salariés"}],
x:"Bonne réponse : Tous les employeurs entrant dans son champ d'application. Une convention collective étendue s'applique obligatoirement à tous les employeurs de la branche concernée, qu'ils aient ou non adhéré à l'organisation patronale signataire. L'extension par arrêté ministériel la rend universellement applicable dans le secteur."},
...
r:[{t:"Licencié pour motif économique"},{t:"Invité à démissionner"},{t:"Licencié, avec indemnité spéciale de licenciement",ok:true},{t:"Licencié pour faute grave"}],
x:"Bonne réponse : Licencié, avec indemnité spéciale de licenciement. En cas d'inaptitude suite à un accident du travail ou maladie professionnelle, si le reclassement est impossible, l'employeur licencie le salarié et lui verse une indemnité spéciale de licenciement équivalente au double de l'indemnité légale normale."},
...
r:[{t:"Ceux possédés en pleine propriété uniquement"},{t:"Ceux en propriété et en location avec conducteur"},{t:"Tous : propriété, location et crédit-bail",ok:true},{t:"Uniquement ceux immatriculés au nom de l'entreprise"}],
x:"Bonne réponse : Tous : propriété, location et crédit-bail. Pour le calcul de la capacité financière, tous les véhicules motorisés exploités sont pris en compte, quelle que soit la modalité de détention : propriété, location avec conducteur, location sans conducteur (LLD), ou crédit-bail."},
...
r:[{t:"Pneus hiver uniquement"},{t:"Chaînes même avec des pneus hiver"},{t:"Pneus hiver OU dispositif antidérapant amovible",ok:true},{t:"Pneus à clous uniquement"}],
x:"Bonne réponse : Pneus hiver OU dispositif antidérapant amovible. Depuis novembre 2021, dans les 48 départements de montagne, entre le 1er novembre et le 31 mars, les PL doivent être équipés de pneus hiver OU de dispositifs antidérapants amovibles (chaînes ou chaussettes à neige) sur les roues motrices."},
...
r:[{t:"Gérant majoritaire car son apport est le plus élevé"},{t:"Gérant minoritaire : X et Y détiennent plus de 50 %",ok:true},{t:"Gérant égalitaire"},{t:"Gérant obligatoirement salarié"}],
x:"Bonne réponse : Gérant minoritaire : X et Y détiennent plus de 50 %. Parts sociales : X = 4 500/26 500 = 17 %, Y = 10 000/26 500 = 37,7 %, Z = 12 000/26 500 = 45,3 %. Z est minoritaire car il détient moins de 50 % des parts. X + Y ensemble = 54,7 % > Z. Z gérant minoritaire peut être salarié."},

{id:100,prog:'LEGER',theme:'cl-gestion',d:2,
e:"L'excédent brut d'exploitation (EBE) se calcule ainsi :",
r:[{t:"Chiffre d'affaires − Charges variables"},{t:"VA + Subventions − Impôts et taxes − Charges de personnel",ok:true},{t:"Résultat net + Dotations aux amortissements"},{t:"Chiffre d'affaires − Charges totales"}],
x:"Bonne réponse : VA + Subventions − Impôts et taxes − Charges de personnel. EBE = Valeur Ajoutée + Subventions d'exploitation − Impôts et taxes − Charges de personnel (salaires + charges sociales). L'EBE mesure la performance économique de l'entreprise indépendamment de sa politique de financement et d'amortissement."},

{id:101,prog:'LEGER',theme:'cl-regl',d:1,
e:"La carte entreprise du tachygraphe numérique permet principalement :",
r:[{t:"La conduite d'un véhicule équipé d'un tachygraphe numérique"},{t:"Le téléchargement des données des tachygraphes numériques",ok:true},{t:"L'étalonnage du tachygraphe numérique"},{t:"La conduite et le téléchargement simultanément"}],
x:"Bonne réponse : Le téléchargement des données des tachygraphes numériques. La carte entreprise permet uniquement le téléchargement (lecture) des données enregistrées dans les tachygraphes numériques de l'entreprise. La carte conducteur sert à la conduite. La carte atelier permet l'étalonnage et la programmation."},
...
r:[{t:"Le vendeur livre jusqu'au port de départ"},{t:"L'acheteur prend la marchandise à l'usine du vendeur",ok:true},{t:"Le vendeur paie le transport jusqu'au destinataire"},{t:"Les risques sont transférés à la livraison finale"}],
x:"Bonne réponse : L'acheteur prend la marchandise à l'usine du vendeur. La clause EXW (Ex Works / à l'usine) signifie que le vendeur met la marchandise à disposition dans ses locaux. L'acheteur prend en charge tous les frais et risques à partir du chargement chez le vendeur, y compris le transport principal."},
...
r:[{t:"Toujours, c'est son droit"},{t:"Jamais, la loi impose un fractionnement"},{t:"Sauf si l'entreprise emploie moins de 21 salariés"},{t:"Non, le congé principal est limité à 24 jours ouvrables",ok:true}],
x:"Bonne réponse : Non, le congé principal est limité à 24 jours ouvrables. La loi limite le congé principal à 24 jours ouvrables consécutifs maximum (sur les 30 jours annuels). Les 6 jours restants (5e semaine) doivent être pris séparément. Des dérogations existent notamment pour les salariés ayant des contraintes familiales particulières."},
...
r:[{t:"Repartir immédiatement sans attendre"},{t:"Facturer des frais d'immobilisation après la franchise",ok:true},{t:"Facturer une pénalité forfaitaire de 10 % du prix du transport"},{t:"Refuser le transport et facturer le déplacement"}],
x:"Bonne réponse : Facturer des frais d'immobilisation après la franchise. Selon le contrat type 'général', au-delà du délai de franchise (2 heures sans rendez-vous), le transporteur peut facturer des frais d'immobilisation selon le barème prévu. Ces frais s'ajoutent au prix de transport et sont dus par le chargeur."},
...
r:[{t:"Uniquement le nom, prénom et la date d'entrée"},{t:"Nom, nationalité, naissance, emploi, dates d'entrée/sortie",ok:true},{t:"Le salaire et les congés pris chaque année"},{t:"Uniquement les salariés en CDI (Contrat à Durée Indéterminée)"}],
x:"Bonne réponse : Nom, nationalité, naissance, emploi, dates d'entrée/sortie. Le registre unique du personnel (art. L.1221-13 du Code du travail) doit mentionner pour chaque salarié : nom, prénom, nationalité, date de naissance, sexe, emploi, qualification, date d'entrée et de sortie, et type de contrat. Il doit être présenté à tout contrôle de l'inspection du travail."},
...
r:[{t:"L'attestation France Travail et l'indemnité de congés payés",ok:true},{t:"Une indemnité de licenciement en plus de l'attestation France Travail"},{t:"Uniquement l'attestation France Travail sans aucune indemnité"},{t:"Un document d'information sur le CPF (Compte Personnel de Formation)"}],
x:"Bonne réponse : L'attestation France Travail et l'indemnité de congés payés. Lors d'un licenciement pour faute lourde, l'employeur doit remettre : l'attestation France Travail, le certificat de travail, et le solde de tout compte. Le salarié perd le droit à l'indemnité de licenciement et à l'indemnité compensatrice de préavis, mais conserve ses congés payés acquis."},
...
r:[{t:"Charges fixes / Chiffre d'affaires × 365"},{t:"(Charges fixes / Marge sur coûts variables) × Chiffre d'affaires"},{t:"(Charges fixes / Taux de MCV) / CA × 365",ok:true},{t:"Résultat / Chiffre d'affaires × 365"}],
x:"Bonne réponse : (Charges fixes / Taux de MCV) / CA × 365. Le seuil de rentabilité en jours (point mort) = (Charges fixes / Taux de MCV) / CA × 365. Il indique à partir de quel jour de l'année l'entreprise commence à dégager un bénéfice. Plus le point mort arrive tôt dans l'année, plus l'entreprise est en sécurité."},

{id:127,prog:'LEGER',theme:'cl-regl',d:2,
e:"Si le donneur d'ordre paie le transporteur au-delà du délai légal de 30 jours, il :",
r:[{t:"Commet une contravention"},{t:"Doit des pénalités de retard automatiques",ok:true},{t:"Doit modifier son contrat"},{t:"Commet un délit"}],
x:"Bonne réponse : Doit des pénalités de retard automatiques au transporteur. Des pénalités de retard sont dues automatiquement au transporteur en cas de dépassement du délai de paiement de 30 jours, sans qu'une mise en demeure soit nécessaire. Le taux légal de pénalités de retard est fixé à 3 fois le taux d'intérêt légal."},
...
r:[{t:"Dont la distance est supérieure à 150 km"},{t:"Dont le poids est supérieur à 3 tonnes"},{t:"Distance supérieure à 150 km ET poids supérieur à 3 tonnes",ok:true},{t:"Uniquement pour les transports d'une région à une autre"}],
x:"Bonne réponse : Distance supérieure à 150 km ET poids supérieur à 3 tonnes. Le contrat type 'longue distance' (arrêté du 5 mai 1988) s'applique aux transports de marchandises générales dépassant à la fois 3 tonnes ET 150 km. En dessous de ces seuils, le contrat type 'général' ou un contrat spécifique s'applique."},
...
r:[{t:"Un tableau récapitulatif des recettes et dépenses de l'année"},{t:"Une photographie du patrimoine de l'entreprise à un instant T",ok:true},{t:"Un document prévisionnel des flux de trésorerie"},{t:"Un état des salaires versés aux employés"}],
x:"Bonne réponse : Une photographie du patrimoine de l'entreprise à un instant T. Le bilan comptable est un document de synthèse qui décrit à un instant précis (date de clôture de l'exercice) le patrimoine de l'entreprise : à gauche l'actif (emplois des ressources), à droite le passif (ressources = capitaux propres + dettes)."},

{id:136,prog:'LEGER',theme:'cl-gestion',d:1,
e:"Dans un compte de résultat, le chiffre d'affaires (CA) représente :",
r:[{t:"Le bénéfice de l'entreprise sur l'exercice"},{t:"Le total des ventes de biens et services de l'exercice",ok:true},{t:"La différence entre recettes et dépenses"},{t:"La valeur du stock en fin d'exercice"}],
x:"Bonne réponse : Le total des ventes de biens et services de l'exercice. Le chiffre d'affaires (CA) représente le montant total hors taxes des ventes de biens et des prestations de services réalisées par l'entreprise au cours de l'exercice comptable. C'est l'indicateur de l'activité commerciale de l'entreprise."},
...
r:[{t:"La collecte des cotisations sociales des transporteurs"},{t:"La délivrance des licences et le contrôle des entreprises",ok:true},{t:"La fixation des prix du transport"},{t:"La gestion des permis de conduire des conducteurs"}],
x:"Bonne réponse : La délivrance des licences et le contrôle des entreprises. La DREAL est le service de l'État chargé du contrôle et de la régulation du transport routier. Elle délivre les titres d'autorisation (licences), gère le RNET (registre des entreprises de transport), et effectue les contrôles en entreprise et sur route."},

{id:139,prog:'LEGER',theme:'cl-regl',d:3,
e:"Le contrat type 'denrées périssables' s'applique :",
r:[{t:"À tous les transports de produits alimentaires"},{t:"Uniquement aux transports réfrigérés"},{t:"Les denrées périssables sous température dirigée",ok:true},{t:"Aux transports de fruits et légumes frais uniquement"}],
x:"Bonne réponse : Les denrées périssables sous température dirigée. Le contrat type 'denrées périssables' s'applique aux transports de marchandises périssables nécessitant le respect d'une température dirigée (chaîne du froid). Il impose des obligations spécifiques au transporteur en matière de température et de contrôle."},

{id:140,prog:'LEGER',theme:'cl-civil',d:2,
e:"L'hypothèque est :",
r:[{t:"Un gage sur les biens mobiliers d'une entreprise"},{t:"Une garantie de paiement donnée par le dirigeant à un créancier"},{t:"Une garantie réelle sur un bien immobilier conservé",ok:true},{t:"Une caution personnelle solidaire"}],
x:"Bonne réponse : Une garantie réelle sur un bien immobilier conservé. L'hypothèque est une garantie réelle conventionnelle portant sur un bien immobilier. Le débiteur reste en possession de son bien mais le créancier peut le faire saisir et vendre en cas de non-paiement. C'est la garantie couramment demandée par les banques pour les prêts immobiliers."},

{id:141,prog:'LEGER',theme:'cl-gestion',d:2,
e:"Le plan de financement d'une nouvelle entreprise de transport met en évidence :",
r:[{t:"Uniquement le chiffre d'affaires prévisionnel"},{t:"L'équilibre entre besoins de financement et ressources",ok:true},{t:"Le montant des impôts à payer sur 3 ans"},{t:"Le nombre de véhicules nécessaires à l'activité"}],
x:"Bonne réponse : L'équilibre entre besoins de financement et ressources. Le plan de financement est un tableau prévisionnel sur plusieurs années (généralement 3 à 5 ans) mettant en regard les besoins (investissements, BFR, remboursements) et les ressources (apports en capital, emprunts, CAF). Il permet de vérifier l'équilibre financier du projet."},

{id:142,prog:'LEGER',theme:'cl-civil',d:2,
e:"La mise en liquidation judiciaire d'une entreprise intervient quand :",
r:[{t:"Le CA (Chiffre d'Affaires) baisse de plus de 50 %"},{t:"L'entreprise ne paie pas ses charges sociales 2 mois de suite"},{t:"Cessation de paiement et redressement impossible",ok:true},{t:"Les capitaux propres sont inférieurs à la moitié du capital social"}],
x:"Bonne réponse : Cessation de paiement et redressement impossible. La liquidation judiciaire est prononcée quand l'entreprise est en cessation de paiement ET que le redressement est manifestement impossible. Elle entraîne la dissolution et la vente des actifs pour rembourser les créanciers dans un ordre légal."},
...
r:[{t:"Qui ne peut pas être encaissé"},{t:"Encaissable seulement par virement, pas en espèces",ok:true},{t:"Dont la provision est bloquée"},{t:"Qui est signé par deux personnes"}],
x:"Bonne réponse : Encaissable seulement par virement, pas en espèces. Un chèque barré (deux barres parallèles dessinées) ne peut pas être encaissé directement au guichet en espèces. Il doit obligatoirement être remis à une banque pour être porté au crédit d'un compte bancaire."},
...
r:[{t:"Chaque débiteur ne paye que sa part"},{t:"Le créancier peut exiger toute la dette à un seul débiteur",ok:true},{t:"Les débiteurs doivent payer ensemble"},{t:"Le paiement d'un débiteur libère tous les autres automatiquement"}],
x:"Bonne réponse : Le créancier peut exiger toute la dette à un seul débiteur. La solidarité passive (entre débiteurs) permet au créancier de réclamer le paiement de la totalité de la dette à n'importe lequel des codébiteurs solidaires. Le débiteur qui a tout payé dispose ensuite d'un recours contre les autres pour récupérer leurs parts."},
...
r:[{t:"Le taux français de 20 %"},{t:"Le taux espagnol applicable"},{t:"L'autoliquidation par le client espagnol",ok:true},{t:"Une exonération totale de TVA"}],
x:"Bonne réponse : L'autoliquidation par le client espagnol. Pour les prestations de services B2B intracommunautaires, c'est le principe de territorialité : la TVA est due dans le pays du preneur (client). Le transporteur français facture HT et le client espagnol déclare et paie la TVA espagnole par autoliquidation (article 44 de la directive TVA)."},

{id:148,prog:'LEGER',theme:'cl-fiscal',d:1,
e:"L'imposition des bénéfices d'une entreprise individuelle (EI) de transport est :",
r:[{t:"Soumise à l'IS (Impôt sur les Sociétés)"},{t:"Soumise à l'IR, catégorie BIC",ok:true},{t:"Exonérée d'impôt la première année"},{t:"Calculée sur le chiffre d'affaires et non le bénéfice"}],
x:"Bonne réponse : Soumise à l'IR, catégorie BIC. Une entreprise individuelle (EI) de transport est soumise à l'IR (Impôt sur le Revenu) dans la catégorie des BIC (Bénéfices Industriels et Commerciaux). Le bénéfice s'intègre au revenu global du foyer fiscal du dirigeant."},

{id:149,prog:'LEGER',theme:'cl-social',d:2,
e:"Le contrat d'apprentissage est réservé aux personnes âgées de :",
r:[{t:"16 à 25 ans uniquement"},{t:"16 à 29 ans révolus, dérogations possibles",ok:true},{t:"18 à 30 ans"},{t:"15 à 25 ans"}],
x:"Bonne réponse : 16 à 29 ans révolus, dérogations possibles. Le contrat d'apprentissage est ouvert aux personnes de 16 à 29 ans révolus. Des dérogations permettent d'aller au-delà pour les personnes handicapées, celles souhaitant créer une entreprise, ou en cas de rupture du contrat pour cause indépendante de leur volonté."},
...
r:[{t:"La déductibilité des loyers en charges"},{t:"La propriété immédiate du bien, coût total plus faible",ok:true},{t:"L'absence de mise de fonds initiale"},{t:"La flexibilité en cas de résiliation anticipée"}],
x:"Bonne réponse : La propriété immédiate du bien, coût total plus faible. L'emprunt bancaire permet d'acquérir la propriété du bien immédiatement (l'entreprise l'inscrit à l'actif). Son coût total est généralement inférieur au crédit-bail. En revanche, il nécessite un apport, immobilise des ressources et figure en dettes dans le bilan."},
...
r:[{t:"Un gage sur les actifs de l'entreprise"},{t:"Un nantissement sur les créances clients"},{t:"Une garantie du dirigeant sur ses biens personnels",ok:true},{t:"Une assurance souscrite au profit du créancier"}],
x:"Bonne réponse : Une garantie du dirigeant sur ses biens personnels. La caution personnelle (ou garantie personnelle) est un engagement par lequel le dirigeant s'engage sur ses biens personnels à rembourser la dette de la société en cas de défaillance. C'est la garantie la plus couramment demandée par les banques lors d'un emprunt."},
...
r:[{t:"Le compte bancaire professionnel de l'entreprise"},{t:"Des sommes prêtées à la société par un associé",ok:true},{t:"Un compte bloqué pendant 5 ans minimum"},{t:"Une forme de capital social non rémunéré"}],
x:"Bonne réponse : Des sommes prêtées à la société par un associé. Un compte courant d'associé est une créance de l'associé sur la société : il laisse des fonds à la disposition de l'entreprise (souvent sans intérêt ou à taux modeste). Ces sommes sont remboursables mais pas exigibles immédiatement comme un capital (sauf clause contraire)."},
...
r:[{t:"Exonérée au sein de l'UE (Union Européenne)"},{t:"Payée dans le pays d'achat"},{t:"Due en France par l'acquéreur (autoliquidation)",ok:true},{t:"Répartie entre les deux pays concernés"}],
x:"Bonne réponse : Due en France par l'acquéreur (autoliquidation). Pour les acquisitions intracommunautaires de moyens de transport neufs, la TVA est due dans le pays de l'acquéreur (France), quel que soit le statut de l'acheteur (assujetti ou non). L'acquéreur français déclare et paie la TVA française."},
...
r:[{t:"Elle est réservée aux grandes entreprises"},{t:"Ouvrable avant la cessation de paiement, à titre préventif",ok:true},{t:"Elle entraîne immédiatement la cession de l'entreprise"},{t:"Elle est réservée aux artisans"}],
x:"Bonne réponse : Ouvrable avant la cessation de paiement, à titre préventif. La procédure de sauvegarde est ouverte à la demande du débiteur qui, sans être en cessation de paiement, éprouve des difficultés qu'il ne peut surmonter seul. C'est un outil de prévention permettant de restructurer l'entreprise avant d'atteindre le stade de la cessation de paiement."},
...
r:[{t:"Racheter les dettes d'un concurrent"},{t:"Céder ses créances professionnelles à sa banque",ok:true},{t:"Transférer ses contrats de transport à un tiers"},{t:"Réduire son capital social"}],
x:"Bonne réponse : Céder ses créances professionnelles à sa banque. La cession Dailly (loi du 2 janvier 1981) permet à une entreprise de céder en bloc ses créances professionnelles à une banque (bordereau Dailly). En contrepartie, la banque avance les fonds. C'est un mode de financement à court terme qui améliore la trésorerie."},
...
r:[{t:"Soumis aux mêmes règles que le transport commercial"},{t:"Exempté car c'est un service public local",ok:true},{t:"Interdit aux VUL"},{t:"Soumis à une autorisation préfectorale spéciale"}],
x:"Bonne réponse : Exempté car c'est un service public local. Les services de collecte de déchets ménagers en régie communale relèvent d'une activité de service public et non du transport public de marchandises pour compte d'autrui. Ils sont exemptés de l'obligation d'inscription au registre des transporteurs, mais doivent respecter les réglementations environnementales et de sécurité routière."},
...
r:[{t:"D'un simple accord oral suffit"},{t:"D'un accord d'entreprise, ou d'une charte après avis du CSE",ok:true},{t:"D'une autorisation préfectorale"},{t:"D'un avenant obligatoire pour tout télétravail, même occasionnel"}],
x:"Bonne réponse : D'un accord d'entreprise, ou d'une charte après avis du CSE. Depuis l'ordonnance de 2017, le télétravail peut être mis en place par accord collectif ou charte unilatérale (après avis du CSE). En l'absence d'accord ou de charte, il peut être organisé par accord individuel entre l'employeur et le salarié (email suffisant). L'employeur prend en charge les frais liés au télétravail."},

{id:189,prog:'LEGER',theme:'cl-civil',d:2,
e:"L'enrichissement sans cause (enrichissement injustifié) permet à l'appauvri de :",
r:[{t:"Réclamer des dommages et intérêts"},{t:"Agir contre celui qui s'est enrichi sans justification",ok:true},{t:"Annuler tout contrat déséquilibré"},{t:"Récupérer uniquement les frais engagés"}],
x:"Bonne réponse : Agir contre celui qui s'est enrichi sans justification. L'enrichissement injustifié (art. 1303 du Code civil) permet à une personne appauvrie de réclamer restitution à celui qui s'est enrichi à ses dépens sans cause légitime. L'indemnité est limitée à la moindre des deux valeurs : enrichissement ou appauvrissement."},

{id:190,prog:'LEGER',theme:'cl-fiscal',d:2,
e:"Le crédit d'impôt formation dirigeant est calculé sur la base de :",
r:[{t:"100 % des frais de formation"},{t:"Nombre d'heures × taux horaire du SMIC (max 40h/an)",ok:true},{t:"Un forfait de 5 000 € par an"},{t:"50 % des frais de formation"}],
...
r:[{t:"Le conducteur était en état d'ivresse uniquement"},{t:"Une imprudence a causé le décès, même sans alcool",ok:true},{t:"Le conducteur conduisait trop vite uniquement"},{t:"L'accident était involontaire — jamais de responsabilité pénale"}],
x:"Bonne réponse : Une imprudence a causé le décès, même sans alcool. L'homicide involontaire (art. 221-6 du Code pénal) est retenu dès qu'une faute de conduite (imprudence, inattention, négligence) a causé le décès. Les peines vont de 3 ans d'emprisonnement et 45 000 € à 7 ans et 100 000 € en cas de circonstances aggravantes (alcool, stupéfiants, excès de vitesse, délit de fuite)."},
...
r:[{t:"Il inclut la TVA collectée"},{t:"Des charges non déductibles et des produits exonérés",ok:true},{t:"Il est calculé sur le CA brut"},{t:"Il est toujours supérieur au résultat comptable"}],
x:"Bonne réponse : Des charges non déductibles et des produits exonérés. Résultat fiscal = Résultat comptable + Réintégrations fiscales (charges non déductibles) - Déductions fiscales (provisions réglementées, certaines exonérations). L'IS est calculé sur le résultat fiscal, qui peut être supérieur ou inférieur au résultat comptable."},
...
r:[{t:"Un capital minimum de 37 000 €"},{t:"Grande liberté statutaire et pas de capital minimum",ok:true},{t:"L'obligation d'un conseil d'administration"},{t:"Un minimum de 7 associés"}],
x:"Bonne réponse : Grande liberté statutaire et pas de capital minimum. La SAS est la forme sociale la plus flexible : pas de capital minimum légal (1 € suffit), grande liberté dans l'organisation de la gouvernance et des droits des associés. Elle est présidée par un président (personne physique ou morale) obligatoire."},

{id:197,prog:'LEGER',theme:'cl-gestion',d:3,
e:"La méthode des SIG (Soldes Intermédiaires de Gestion) permet de :",
r:[{t:"Calculer uniquement le résultat net"},{t:"Décomposer la formation du résultat : VA, EBE, RCAI…",ok:true},{t:"Établir le tableau de financement"},{t:"Calculer le BFR normatif"}],
x:"Bonne réponse : Décomposer la formation du résultat : VA, EBE, RCAI…. Les SIG décomposent le compte de résultat en indicateurs intermédiaires : Marge commerciale → Production → Valeur Ajoutée → EBE → Résultat d'exploitation → RCAI → Résultat net. Chaque solde mesure un niveau différent de performance et permet d'analyser précisément d'où vient (ou ne vient pas) la rentabilité."},

{id:198,prog:'LEGER',theme:'cl-civil',d:2,
e:"Un transporteur VUL peut-il refuser un transport pour des raisons de sécurité ?",
r:[{t:"Non, il doit toujours assurer le transport si rémunéré"},{t:"Oui, si les conditions de sécurité ne sont pas réunies",ok:true},{t:"Oui, mais uniquement avec l'accord de la DREAL"},{t:"Non, le refus de transport est une infraction pénale"}],
x:"Bonne réponse : Oui, si les conditions de sécurité ne sont pas réunies. Le transporteur a le droit de refuser un transport s'il estime que les conditions de sécurité ne sont pas réunies (surcharge, mauvais conditionnement, risque pour autrui…). C'est même une obligation légale dans certains cas."},
...
r:[{t:"93 % des véhicules sont en activité"},{t:"93 % du CA absorbé par les charges, 7 % de marge",ok:true},{t:"L'entreprise perd de l'argent"},{t:"L'entreprise est très rentable"}],
x:"Bonne réponse : 93 % du CA absorbé par les charges, 7 % de marge. Coefficient d'exploitation = Charges totales / CA × 100. Un coefficient de 93 % laisse 7 % de marge bénéficiaire. Dans le transport VUL, les coefficients entre 88 % et 94 % sont normaux. Au-delà de 95 %, la rentabilité est fragile. Au-delà de 100 %, l'entreprise est déficitaire."},
...
e:"Le KBIS est :",
r:[{t:"Le document fiscal annuel de l'entreprise"},{t:"L'extrait du registre attestant l'existence d'une société",ok:true},{t:"Le relevé bancaire obligatoire pour les entreprises"},{t:"L'attestation d'immatriculation à l'URSSAF"}],
x:"Bonne réponse : L'extrait du registre attestant l'existence d'une société. Le KBIS est l'extrait du Registre du Commerce et des Sociétés (RCS). C'est la 'carte d'identité' officielle d'une entreprise commerciale, délivrée par le greffe du tribunal de commerce. Il atteste de l'existence légale de la société."},

{id:204,prog:'LEGER',theme:'cl-secu',d:2,
e:"L'angle mort d'un VUL se situe principalement :",
r:[{t:"À l'avant du véhicule"},{t:"Sur les côtés et à l'arrière, hors champ des rétroviseurs",ok:true},{t:"Uniquement à l'arrière"},{t:"Uniquement du côté passager"}],
x:"Bonne réponse : Sur les côtés et à l'arrière, hors champ des rétroviseurs. Les angles morts d'un VUL sont les zones non visibles dans les rétroviseurs, principalement sur les côtés (zones latérales arrière) et à l'arrière direct. Contrairement aux PL, les VUL ont des angles morts moins importants, mais restent significatifs, notamment du côté droit en milieu urbain. Des équipements comme les caméras de recul réduisent ce risque."},

{id:205,prog:'LEGER',theme:'cl-secu',d:1,
e:"La conduite sous l'effet de médicaments psychoactifs (somnifères, anxiolytiques) :",
r:[{t:"Est autorisée si la dose est médicale"},{t:"Aussi dangereuse que l'alcool, à signaler par le médecin",ok:true},{t:"Est sans danger si le conducteur se sent bien"},{t:"N'est sanctionnée que si accident avec blessé"}],
x:"Bonne réponse : Aussi dangereuse que l'alcool, à signaler par le médecin. Les médicaments de niveau 3 (pictogramme triangle rouge fond rouge) sont contre-indiqués à la conduite. Les niveaux 1 et 2 nécessitent une vigilance accrue. Le médecin prescripteur doit informer le patient des risques. La conduite sous l'effet de médicaments altérant les capacités est sanctionnable."},

{id:206,prog:'LEGER',theme:'cl-civil',d:2,
e:"La lettre de change est un titre par lequel :",
r:[{t:"La banque garantit un paiement"},{t:"Le tireur ordonne au tiré de payer à une échéance",ok:true},{t:"L'acheteur s'engage à payer dans 30 jours"},{t:"Le transporteur garantit la livraison"}],
x:"Bonne réponse : Le tireur ordonne au tiré de payer à une échéance. La lettre de change (traite) est un effet de commerce par lequel le tireur (créancier) ordonne au tiré (débiteur) de payer une somme déterminée à une date précise. Elle peut être endossée et escomptée auprès d'une banque pour obtenir des liquidités anticipées."},

{id:207,prog:'LEGER',theme:'cl-gestion',d:3,
e:"La valeur actuelle nette (VAN) d'un investissement est positive lorsque :",
r:[{t:"Les flux futurs actualisés dépassent le coût investi",ok:true},{t:"L'investissement est entièrement financé par emprunt"},{t:"Le délai de récupération est inférieur à 2 ans"},{t:"Le taux d'actualisation est nul"}],
x:"Bonne réponse : Les flux futurs actualisés dépassent le coût investi. La VAN = Somme des flux de trésorerie futurs actualisés - Investissement initial. Une VAN positive signifie que l'investissement crée de la valeur (les gains actualisés dépassent le coût). Une VAN négative indique une destruction de valeur. C'est le principal critère de sélection des investissements."},

{id:208,prog:'LEGER',theme:'cl-social',d:2,
e:"Le congé sabbatique est ouvert aux salariés ayant :",
r:[{t:"1 an d'ancienneté"},{t:"3 ans dans l'entreprise et 6 ans d'activité",ok:true},{t:"5 ans d'ancienneté"},{t:"10 ans d'ancienneté"}],
x:"Bonne réponse : 3 ans dans l'entreprise et 6 ans d'activité. Le congé sabbatique (art. L.3142-28 du Code du travail) est ouvert aux salariés justifiant d'au moins 36 mois d'ancienneté dans l'entreprise et de 6 années d'activité professionnelle. Sa durée est de 6 à 11 mois. L'employeur peut le refuser ou le reporter sous certaines conditions."},

{id:209,prog:'LEGER',theme:'cl-civil',d:3,
e:"Le 'dol' dans la formation d'un contrat est :",
r:[{t:"Une erreur involontaire d'une partie"},{t:"Une manœuvre frauduleuse provoquant l'erreur du cocontractant",ok:true},{t:"Un avantage excessif obtenu par une partie"},{t:"L'impossibilité d'exécuter le contrat"}],
x:"Bonne réponse : Une manœuvre frauduleuse provoquant l'erreur du cocontractant. Le dol est un vice du consentement (art. 1137 du Code civil). Il consiste en des manœuvres frauduleuses ou des mensonges délibérés destinés à tromper l'autre partie et à provoquer son consentement. Le dol entraîne la nullité relative du contrat."},
...
r:[{t:"Charges fixes / Taux de marge sur coûts variables",ok:true},{t:"SR = Charges variables / Taux de marge sur coûts fixes"},{t:"SR = Résultat net / Taux de TVA"},{t:"SR = CA × Taux d'amortissement"}],
x:"Bonne réponse : Charges fixes / Taux de marge sur coûts variables. SR = Charges fixes / Taux de MCV. Exemple : si les charges fixes sont 30 000 € et le taux de MCV est 40 %, le SR est de 75 000 €. C'est le CA minimum à réaliser pour ne pas perdre d'argent."},
...
r:[{t:"Une meilleure stabilité"},{t:"Un freinage allongé et une usure prématurée des pneus",ok:true},{t:"Une amélioration de la traction"},{t:"Aucun impact sur la sécurité active"}],
x:"Bonne réponse : Un freinage allongé et une usure prématurée des pneus. La surcharge dégrade la sécurité : allongement des distances de freinage (le système n'est pas dimensionné pour ce poids), usure prématurée et risque d'éclatement des pneumatiques, surcharge du châssis et des suspensions, perte de maniabilité. Elle peut invalider l'assurance en cas d'accident."},

{id:217,prog:'LEGER',theme:'cl-civil',d:2,
e:"La saisie-attribution permet de :",
r:[{t:"Saisir les biens immobiliers du débiteur"},{t:"Bloquer les sommes détenues par un tiers (ex : banque)",ok:true},{t:"Vendre aux enchères les biens meubles"},{t:"Suspendre un contrat en cours"}],
x:"Bonne réponse : Bloquer les sommes détenues par un tiers (ex : banque). La saisie-attribution permet à un créancier muni d'un titre exécutoire de saisir les créances de son débiteur détenues par un tiers (notamment son compte bancaire). Les sommes sont attribuées immédiatement au créancier saisissant."},

{id:218,prog:'LEGER',theme:'cl-gestion',d:1,
e:"Le résultat net comptable est calculé comme :",
r:[{t:"CA — charges variables"},{t:"(Résultat exploitation + financier + exceptionnel) − IS",ok:true},{t:"CA — charges fixes"},{t:"EBE — amortissements"}],
x:"Bonne réponse : (Résultat exploitation + financier + exceptionnel) − IS. Résultat net = Résultat d'exploitation + Résultat financier + Résultat exceptionnel — IS — Participation. C'est le résultat final après toutes les déductions. Il peut être distribué (dividendes), mis en réserve ou reporté à nouveau."},
...
r:[{t:"Est totalement exempt de toute réglementation"},{t:"Doit respecter des règles de sécurité minimales même hors ADR",ok:true},{t:"Doit disposer d'un certificat ADR conducteur"},{t:"Ne peut transporter que du propane professionnel"}],
x:"Bonne réponse : Doit respecter des règles de sécurité minimales même hors ADR. Même en dessous des seuils d'exemption ADR, le transport de gaz comprimés doit respecter des règles de base : bouteilles correctement arrimées et stockées à la verticale, ventilation du compartiment, extincteur, consignes de sécurité. Les bonnes pratiques professionnelles s'appliquent toujours."},
...
r:[{t:"50 m"},{t:"115 m (soit 2 secondes de temps)",ok:true},{t:"200 m"},{t:"30 m"}],
x:"Bonne réponse : 115 m (soit 2 secondes de temps). La distance de sécurité recommandée correspond à au moins 2 secondes de temps d'espacement (règle des 2 secondes). À 130 km/h, cela représente environ 72 m/s × 2 = soit environ 72 m minimum. La règle légale française (art. R.412-12) impose une distance au moins égale à la distance parcourue en 2 secondes, soit environ 72 m à 130 km/h."},

{id:221,prog:'LEGER',theme:'cl-gestion',d:2,
e:"Le budget de trésorerie prévisionnel permet de :",
r:[{t:"Calculer l'IS prévisionnel"},{t:"Anticiper les besoins de trésorerie à court terme",ok:true},{t:"Établir le bilan prévisionnel"},{t:"Calculer le seuil de rentabilité"}],
x:"Bonne réponse : Anticiper les besoins de trésorerie à court terme. Le budget de trésorerie est un tableau prévisionnel mensuel des encaissements et décaissements. Il permet d'identifier à l'avance les périodes de tension de trésorerie pour anticiper les solutions (ligne de crédit, affacturage, relance clients) avant d'être en difficulté."},

{id:222,prog:'LEGER',theme:'cl-civil',d:3,
e:"La subrogation dans un contrat d'assurance transport signifie que :",
r:[{t:"L'assuré renonce à toute indemnité"},{t:"L'assureur indemnise puis se retourne contre le responsable",ok:true},{t:"Le transporteur est exonéré de toute responsabilité"},{t:"L'assurance couvre automatiquement tous les risques"}],
x:"Bonne réponse : L'assureur indemnise puis se retourne contre le responsable. La subrogation légale (art. L.121-12 du Code des assurances) permet à l'assureur qui a indemnisé son assuré (l'expéditeur ou le destinataire) d'exercer en son nom les actions en responsabilité contre le transporteur ou tout autre tiers responsable du sinistre."},
...
r:[{t:"Un jugement rendu par un tribunal"},{t:"Une mise en demeure d'exécuter son obligation",ok:true},{t:"Une saisie conservatoire sur les biens du débiteur"},{t:"Un acte notarié obligatoire"}],
x:"Bonne réponse : Une mise en demeure d'exécuter son obligation. La mise en demeure (art. 1344 du Code civil) est une injonction formelle adressée au débiteur de remplir son obligation. Elle peut être faite par acte d'huissier ou lettre recommandée avec AR. Elle fait courir les intérêts moratoires et est souvent une étape préalable obligatoire avant toute action en justice."},

{id:228,prog:'LEGER',theme:'cl-social',d:2,
e:"Le licenciement d'une salariée enceinte est :",
r:[{t:"Autorisé pour faute grave"},{t:"Interdit pendant la grossesse et 10 semaines après",ok:true},{t:"Possible avec accord de l'inspecteur du travail"},{t:"Autorisé pour motif économique"}],
x:"Bonne réponse : Interdit pendant la grossesse et 10 semaines après. La salariée enceinte bénéficie d'une protection absolue : licenciement interdit pendant la grossesse et 10 semaines après le congé maternité. Seule exception : faute grave non liée à la grossesse ou impossibilité de maintenir le contrat pour un motif étranger à la grossesse (ex : fermeture totale de l'entreprise)."},
...
r:[{t:"Le sous-traitant l'exige par écrit"},{t:"Le sous-traitant a été accepté et ses conditions agréées",ok:true},{t:"Le marché dépasse 50 000 €"},{t:"La sous-traitance est déclarée en préfecture"}],
x:"Bonne réponse : Le sous-traitant a été accepté et ses conditions agréées. L'action directe du sous-traitant (loi 31/12/1975) est conditionnée à l'acceptation préalable du sous-traitant par le maître de l'ouvrage ET à l'agrément de ses conditions de paiement. Sans ces formalités, l'action directe est irrecevable."},

{id:235,prog:'LEGER',theme:'cl-acces',d:2,
e:"La capacité professionnelle peut être prouvée par :",
r:[{t:"Uniquement le diplôme de l'examen CPC"},{t:"L'examen CPC, une équivalence de diplôme ou l'expérience",ok:true},{t:"Uniquement l'expérience professionnelle de 5 ans"},{t:"Tout diplôme de l'enseignement supérieur"}],
x:"Bonne réponse : L'examen CPC, une équivalence de diplôme ou l'expérience. La capacité professionnelle peut être prouvée par : la réussite à l'examen CPC organisé par les CCI, un diplôme ou titre reconnu comme équivalent par arrêté ministériel, ou une attestation de capacité délivrée sur la base d'une expérience professionnelle antérieure à l'entrée en vigueur de la réglementation."},

{id:236,prog:'LEGER',theme:'cl-social',d:2,
e:"La visite médicale d'embauche doit avoir lieu :",
r:[{t:"Avant la prise de poste pour tout salarié"},{t:"Dans les 3 mois suivant la prise de poste",ok:true},{t:"Dans les 6 mois suivant la prise de poste"},{t:"Uniquement pour les postes à risque"}],
x:"Bonne réponse : Dans les 3 mois suivant la prise de poste. Depuis la réforme de 2017, la VIP (Visite d'Information et de Prévention) remplace la visite médicale d'embauche obligatoire. Elle doit avoir lieu dans les 3 mois suivant la prise de poste. Pour les postes à risque, la surveillance médicale renforcée s'applique avant l'embauche."},
...
r:[{t:"La modification des obligations"},{t:"L'anéantissement rétroactif du contrat avec restitutions",ok:true},{t:"Uniquement des dommages et intérêts"},{t:"La suspension temporaire du contrat"}],
x:"Bonne réponse : L'anéantissement rétroactif du contrat avec restitutions. La résolution (art. 1229 du Code civil) met fin au contrat et l'anéantit rétroactivement. Les parties sont remises dans l'état antérieur à la conclusion, avec restitutions mutuelles. Elle diffère de la résiliation qui ne vaut que pour l'avenir."},

{id:240,prog:'LEGER',theme:'cl-gestion',d:2,
e:"Pour un transporteur VUL, le coût kilométrique comprend notamment :",
r:[{t:"Uniquement le carburant et les pneus"},{t:"Carburant, entretien, assurance, amortissement, structure",ok:true},{t:"Uniquement les charges variables"},{t:"Uniquement le salaire du conducteur"}],
x:"Bonne réponse : Carburant, entretien, assurance, amortissement, structure. Le coût de revient kilométrique complet intègre : charges variables (carburant, pneus, entretien courant) + charges fixes (assurance, amortissement, loyer véhicule, charges de structure) divisés par le kilométrage annuel."},
...
r:[{t:"Acheter les dettes de ses fournisseurs"},{t:"Céder ses créances clients à un factor contre paiement",ok:true},{t:"Émettre des obligations sur le marché"},{t:"Bénéficier d'un crédit bancaire long terme"}],
x:"Bonne réponse : Céder ses créances clients à un factor contre paiement. L'affacturage permet à une entreprise de céder ses créances clients à un factor qui avance les fonds immédiatement (moins sa commission). Le factor se charge ensuite du recouvrement. Avantages : trésorerie immédiate, externalisation du recouvrement. Inconvénients : coût élevé, perte de contact direct avec le client."},
...
r:[{t:"Les deux actes sont nuls automatiquement"},{t:"L'acte secret prime entre parties, l'apparent envers les tiers",ok:true},{t:"L'acte apparent prime toujours sur l'acte secret"},{t:"Aucun des deux actes n'est opposable"}],
x:"Bonne réponse : L'acte secret prime entre parties, l'apparent envers les tiers. En cas de simulation (art. 1201 du Code civil), l'acte secret (contre-lettre) prime entre les parties contractantes. Mais les tiers de bonne foi peuvent se prévaloir de l'acte apparent. La simulation frauduleuse (pour tromper le fisc, les créanciers…) est sanctionnée pénalement."},
...
r:[{t:"Uniquement comme intermédiaire sans responsabilité"},{t:"Personnellement sur le transport, même en sous-traitant",ok:true},{t:"Uniquement si le transporteur est défaillant"},{t:"Dans la limite du prix du transport"}],
x:"Bonne réponse : Personnellement sur le transport, même en sous-traitant. Le commissionnaire de transport (art. L.132-3 Code de commerce) s'engage personnellement sur l'exécution du transport vis-à-vis du donneur d'ordre, même s'il confie l'exécution à des sous-traitants. Il répond des fautes de ses substitués comme de ses propres fautes."},
...
r:[{t:"Uniquement du donneur d'ordre (l'expéditeur final)"},{t:"Uniquement du client direct (commissionnaire ou transporteur)",ok:true},{t:"De tous les acteurs de la chaîne de transport"},{t:"Il n'a aucune responsabilité juridique"}],
x:"Bonne réponse : Uniquement du client direct (commissionnaire ou transporteur). Le sous-traitant est responsable contractuellement vis-à-vis de son donneur d'ordre direct (le transporteur principal ou le commissionnaire), pas directement vis-à-vis du chargeur initial."},
...
r:[{t:"Facultative"},{t:"Obligatoire, avec carnet de maintenance et formation",ok:true},{t:"Obligatoire uniquement pour les hayons > 1 tonne"},{t:"Réalisée lors du contrôle technique uniquement"}],
x:"Bonne réponse : Obligatoire, avec carnet de maintenance et formation. Les hayons élévateurs sont des équipements de travail soumis à vérification périodique annuelle obligatoire par un organisme agréé (arrêté du 1er mars 2004). Le carnet de maintenance doit être tenu à jour et les utilisateurs formés. Ces obligations s'appliquent dès l'installation, quelle que soit la taille du VUL."},

{id:260,prog:'LEGER',theme:'cl-civil',d:2,
e:"La clause pénale dans un contrat :",
r:[{t:"Est toujours exécutoire sans contrôle du juge"},{t:"Fixe d'avance les dommages et intérêts en cas d'inexécution",ok:true},{t:"Interdit tout recours judiciaire"},{t:"N'est valable que dans les contrats commerciaux"}],
x:"Bonne réponse : Fixe d'avance les dommages et intérêts en cas d'inexécution. La clause pénale (art. 1231-5 du Code civil) fixe à l'avance le montant de l'indemnité due en cas d'inexécution ou de retard. Le juge peut la modérer ou l'augmenter si elle est manifestement excessive ou dérisoire — il dispose d'un pouvoir modérateur."},
...
r:[{t:"Le franchiseur vend des produits à prix réduit"},{t:"Le franchiseur concède sa marque et son savoir-faire",ok:true},{t:"Deux entreprises s'associent en parts égales"},{t:"Un distributeur agit pour le compte d'un fabricant"}],
x:"Bonne réponse : Le franchiseur concède sa marque et son savoir-faire. La franchise est un accord par lequel le franchiseur (propriétaire d'une marque et d'un concept) accorde à des franchisés indépendants le droit d'exploiter son enseigne et son savoir-faire, en contrepartie d'un droit d'entrée et de redevances périodiques."},
...
r:[{t:"La distance de freinage à 50 km/h"},{t:"Le temps entre deux véhicules passant un point fixe",ok:true},{t:"Le temps de réaction moyen d'un conducteur"},{t:"La durée légale de pause après 2h de conduite en VUL"}],
x:"Bonne réponse : Le temps entre deux véhicules passant un point fixe. La règle des 2 secondes : choisissez un repère fixe (panneau, arbre), quand le véhicule devant le dépasse, comptez 2 secondes. Si votre véhicule dépasse ce repère avant les 2 secondes, vous êtes trop près. Par mauvais temps ou la nuit, portez ce délai à 4 secondes. Pour les PL, 3-4 secondes sont recommandées."},

{id:265,prog:'LEGER',theme:'cl-gestion',d:2,
e:"Le ratio de solvabilité générale mesure :",
r:[{t:"La capacité à rembourser les dettes à court terme"},{t:"La capacité à rembourser ses dettes avec l'actif total",ok:true},{t:"Le niveau d'endettement à long terme"},{t:"La rentabilité de l'entreprise"}],
x:"Bonne réponse : La capacité à rembourser ses dettes avec l'actif total. Solvabilité générale = Total actif / Total dettes. Un ratio > 1 signifie que l'actif total dépasse les dettes : l'entreprise serait solvable même en cas de liquidation. Un ratio < 1 indique une situation d'insolvabilité (capitaux propres négatifs)."},
...
r:[{t:"Céder ses créances clients à un factor contre paiement",ok:true},{t:"Racheter les dettes d'un fournisseur"},{t:"Émettre des obligations sur le marché financier"},{t:"Négocier un découvert bancaire"}],
...
r:[{t:"Un contrat de prestation de services uniquement"},{t:"Un contrat salarié avec des règles propres à la représentation",ok:true},{t:"Un statut d'indépendant avec protection sociale"},{t:"Un contrat à durée déterminée uniquement"}],
x:"Bonne réponse : Un contrat salarié avec des règles propres à la représentation. Le VRP est un salarié qui prospecte une clientèle pour le compte d'un ou plusieurs employeurs. Son statut est régi par les articles L.7311-1 et suivants du Code du travail, avec des règles spécifiques : clause de non-concurrence, indemnité de clientèle, commission sur chiffre d'affaires."},

{id:271,prog:'LEGER',theme:'cl-social',d:2,
e:"Le Plan d'Épargne Entreprise (PEE) permet aux salariés de :",
r:[{t:"Recevoir des primes défiscalisées sans condition"},{t:"Constituer une épargne collective avec abondement de l'employeur",ok:true},{t:"Racheter les parts de l'entreprise à tout moment"},{t:"Bénéficier d'une retraite complémentaire garantie"}],
x:"Bonne réponse : Constituer une épargne collective avec abondement de l'employeur. Le PEE est un système d'épargne collectif permettant aux salariés de se constituer un portefeuille de valeurs mobilières. L'employeur peut compléter les versements par un abondement exonéré de charges sociales dans certaines limites. Les fonds sont bloqués 5 ans (sauf cas de déblocage anticipé)."},
...
r:[{t:"Uniquement un thermomètre"},{t:"Un véhicule homologué ATP et un suivi de la chaîne du froid",ok:true},{t:"Une autorisation préfectorale annuelle"},{t:"Un conducteur avec un diplôme d'hygiène alimentaire"}],
x:"Bonne réponse : Un véhicule homologué ATP et un suivi de la chaîne du froid. L'accord ATP (Accord relatif aux Transports internationaux de denrées Périssables et aux engins spéciaux utilisés pour ces transports) impose des véhicules homologués (frigorifiques, isothermes…) pour le transport de produits frais, congelés ou surgelés. La chaîne du froid doit être documentée."},

{id:273,prog:'LEGER',theme:'cl-secu',d:2,
e:"La surcharge d'un VUL a pour principale conséquence sur la sécurité :",
r:[{t:"Amélioration de la traction"},{t:"Freinage dégradé, mauvaise tenue de route, risque de rupture",ok:true},{t:"Amélioration de la stabilité par le poids"},{t:"Aucun impact sur la sécurité active"}],
x:"Bonne réponse : Freinage dégradé, mauvaise tenue de route, risque de rupture. La surcharge dégrade considérablement la sécurité : allongement des distances de freinage (le système de freinage n'est pas dimensionné pour le poids supplémentaire), diminution de la maniabilité, surcharge des pneumatiques (risque d'éclatement), sollicitation excessive du châssis et des suspensions. La surcharge peut invalider l'assurance en cas d'accident."},

{id:274,prog:'LEGER',theme:'cl-secu',d:1,
e:"La pression des pneus d'un VUL chargé doit être :",
r:[{t:"Identique à un VUL vide"},{t:"Ajustée selon le constructeur, souvent augmentée en charge",ok:true},{t:"Toujours de 2,5 bars"},{t:"Vérifiée uniquement lors du contrôle technique"}],
x:"Bonne réponse : Ajustée selon le constructeur, souvent augmentée en charge. La pression des pneus doit être adaptée à la charge du véhicule selon les préconisations du constructeur (figurant souvent sur la plaque de custode ou dans le manuel). En charge maximale, la pression recommandée est généralement plus élevée qu'à vide pour éviter la surchauffe et l'éclatement du pneu."},
...
e:"La garantie AGS (Association pour la Gestion des créances des Salariés) intervient :",
r:[{t:"En cas de grève des salariés"},{t:"En cas de redressement ou liquidation, pour payer les salaires",ok:true},{t:"En cas d'accident du travail grave"},{t:"En cas de faillite personnelle du dirigeant uniquement"}],
x:"Bonne réponse : En cas de redressement ou liquidation, pour payer les salaires. L'AGS est un régime de garantie des salaires financé par les employeurs (cotisation patronale). Elle garantit le paiement des salaires, congés payés et indemnités de rupture lorsqu'une entreprise fait l'objet d'une procédure de sauvegarde, redressement ou liquidation judiciaire."},
...
r:[{t:"Est uniquement recommandé"},{t:"Obligatoire dans le véhicule, à revêtir avant de sortir dessus",ok:true},{t:"Est obligatoire uniquement sur autoroute"},{t:"N'est obligatoire que pour les conducteurs professionnels"}],
x:"Bonne réponse : Obligatoire dans le véhicule, à revêtir avant de sortir dessus. Le gilet de sécurité haute visibilité est obligatoire dans tout véhicule à moteur (art. R.416-19 du Code de la route). Il doit être accessible (dans l'habitacle, pas dans le coffre) et revêtu avant de sortir du véhicule sur la chaussée ou ses abords. L'absence est une contravention de 2ème classe."},
...
r:[{t:"Uniquement la carrosserie"},{t:"La carrosserie, le carburant et les équipements fixes",ok:true},{t:"Le châssis et le moteur uniquement"},{t:"La tare + conducteur + 75 kg"}],
x:"Bonne réponse : La carrosserie, le carburant et les équipements fixes. La masse en ordre de marche comprend le poids du véhicule avec carrosserie, le plein de carburant, les fluides (huile, liquide de refroidissement, frein) et les équipements fixes d'origine. Elle exclut le conducteur, les passagers et le chargement. Charge utile = PTAC — masse en ordre de marche."},
...
r:[{t:"Obtenir des dommages et intérêts"},{t:"Suspendre sa propre obligation tant que l'autre n'exécute pas",ok:true},{t:"Résilier le contrat immédiatement"},{t:"Transférer ses obligations à un tiers"}],
x:"Bonne réponse : Suspendre sa propre obligation tant que l'autre n'exécute pas. L'exception d'inexécution (art. 1219 Code civil) est un mécanisme de suspension légitime de ses propres obligations lorsque l'autre partie n'exécute pas les siennes et que l'inexécution est suffisamment grave. C'est une mesure provisoire qui ne rompt pas le contrat."},

{id:289,prog:'LEGER',theme:'cl-acces',d:3,
e:"Le retrait de l'autorisation d'exercer peut être prononcé en cas de :",
r:[{t:"Tout redressement fiscal de l'entreprise"},{t:"Perte d'une des 3 conditions d'accès non régularisée",ok:true},{t:"Tout accident de la route impliquant un VUL de l'entreprise"},{t:"Retard de paiement d'une cotisation CCI"}],
x:"Bonne réponse : Perte d'une des 3 conditions d'accès non régularisée. L'autorisation d'exercer peut être suspendue ou retirée si l'entreprise ne satisfait plus l'une des 3 conditions (honorabilité, capacité financière, capacité professionnelle) et ne régularise pas sa situation dans le délai accordé (généralement 6 mois). Le retrait est prononcé par l'autorité compétente (DREAL)."},
...
r:[{t:"D'obtenir des dommages et intérêts sans preuve"},{t:"Suspendre sa propre obligation tant que l'autre n'exécute pas",ok:true},{t:"De résilier unilatéralement le contrat sans préavis"},{t:"D'obtenir la nullité du contrat"}],
x:"Bonne réponse : Suspendre sa propre obligation tant que l'autre n'exécute pas. L'exception d'inexécution (art. 1219 du Code civil) est un mécanisme de défense : une partie peut légitimement refuser d'exécuter son obligation si l'autre partie n'exécute pas ou n'est pas prête à exécuter la sienne, et si l'inexécution est suffisamment grave."},

{id:298,prog:'LEGER',theme:'cl-secu',d:1,
e:"Le port de la ceinture de sécurité est obligatoire pour :",
r:[{t:"Uniquement le conducteur"},{t:"Tous les occupants, sur les places équipées",ok:true},{t:"Uniquement sur autoroute"},{t:"Seulement sur les places avant"}],
x:"Bonne réponse : Tous les occupants, sur les places équipées. Le port de la ceinture est obligatoire pour tous les occupants d'un véhicule, sur toutes les places équipées de ceinture (art. R.412-1 du Code de la route). L'amende est de 135 € et le retrait de 3 points. Le conducteur peut être verbalisé pour chaque passager non attaché."},
...
r:[{t:"La durée de l'opération de freinage complète"},{t:"Le temps entre la perception du danger et le début du freinage",ok:true},{t:"Le temps nécessaire pour s'arrêter complètement"},{t:"Le temps de réaction du système ABS"}],
x:"Bonne réponse : Le temps entre la perception du danger et le début du freinage. Le temps de réaction moyen est d'environ 1 seconde entre la perception du danger et l'appui effectif sur la pédale de frein. À 90 km/h, cette seconde représente 25 mètres parcourus AVANT même de commencer à freiner. La fatigue, la distraction ou l'alcool peuvent doubler ou tripler ce temps de réaction."},

{id:301,prog:'LEGER',theme:'cl-fiscal',d:2,
e:"L'amortissement dégressif d'un véhicule utilitaire est :",
r:[{t:"Possible pour tout véhicule professionnel"},{t:"Possible pour certains biens, selon un coefficient de durée",ok:true},{t:"Interdit pour les véhicules de transport"},{t:"Identique à l'amortissement linéaire"}],
x:"Bonne réponse : Possible pour certains biens, selon un coefficient de durée. L'amortissement dégressif est possible pour les biens d'équipement amortissables sur au moins 3 ans. Le taux est obtenu en multipliant le taux linéaire par un coefficient (1,25 pour 3-4 ans, 1,75 pour 5-6 ans, 2,25 pour plus de 6 ans). Il permet des charges plus élevées les premières années."},

{id:302,prog:'LEGER',theme:'cl-social',d:2,
e:"L'auto-entrepreneur (micro-entreprise) cotise :",
r:[{t:"Aux mêmes caisses qu'un salarié"},{t:"Au régime des indépendants sur son chiffre d'affaires",ok:true},{t:"Au régime agricole (MSA)"},{t:"À aucune caisse de retraite"}],
x:"Bonne réponse : Au régime des indépendants sur son chiffre d'affaires. L'auto-entrepreneur cotise au régime des travailleurs non salariés (SSI, géré par l'URSSAF) via un taux forfaitaire appliqué à son chiffre d'affaires. Ces cotisations couvrent retraite, maladie et prévoyance."},
...
r:[{t:"Obligatoire par décret"},{t:"Prévue par la loi mais mise en œuvre par contrat",ok:true},{t:"Interdite par la réglementation anti-concurrentielle"},{t:"Obligatoire uniquement pour les transports de plus de 50 km"}],
x:"Bonne réponse : Prévue par la loi mais mise en œuvre par contrat. La loi permet la révision des prix de transport en fonction des indices CNR (carburant, salaires, matières premières). Cette révision doit être prévue dans le contrat par une clause d'indexation. Elle n'est pas automatique mais son intégration dans les contrats est fortement recommandée pour protéger le transporteur des hausses de coûts."},

{id:312,prog:'LEGER',theme:'cl-civil',d:2,
e:"Le dol comme vice du consentement se caractérise par :",
r:[{t:"Une erreur involontaire"},{t:"Des manœuvres frauduleuses pour tromper l'autre",ok:true},{t:"Un avantage excessif"},{t:"L'impossibilité d'exécuter"}],
x:"Bonne réponse : Des manœuvres frauduleuses pour tromper l'autre. Le dol (art. 1137 Code civil) est constitué de manœuvres frauduleuses, mensonges ou dissimulations délibérés destinés à provoquer le consentement de l'autre partie. Le dol entraîne la nullité relative du contrat et peut ouvrir droit à des dommages et intérêts."},
...
e:"Le besoin en fonds de roulement (BFR) représente :",
r:[{t:"Le capital social de l'entreprise"},{t:"Le besoin de financement du cycle d'exploitation",ok:true},{t:"Les dettes à long terme de l'entreprise"},{t:"Le bénéfice net après impôts"}],
x:"Bonne réponse : Le besoin de financement du cycle d'exploitation. Le BFR = Stocks + Créances clients - Dettes fournisseurs. C'est le besoin de financement à court terme généré par le cycle d'exploitation. Un BFR négatif est favorable (encaissement avant décaissement)."},

{id:315,prog:'LEGER',theme:'cl-civil',d:2,
e:"Les conditions générales de vente (CGV) d'un professionnel :",
r:[{t:"Ne sont jamais applicables sans signature manuscrite du client"},{t:"Si elles ont été portées à la connaissance du client avant",ok:true},{t:"Ne sont valables qu'entre entreprises de même secteur"},{t:"Doivent être approuvées par une autorité administrative"}],
x:"Bonne réponse : Si elles ont été portées à la connaissance du client avant. Les CGV sont opposables au client professionnel dès lors qu'elles lui ont été communiquées avant la passation de commande (même sans signature spécifique de sa part, si la communication est prouvée). Pour les consommateurs, des règles plus protectrices s'appliquent (information précontractuelle obligatoire)."},
...
r:[{t:"Un CDI avec formation intégrée"},{t:"Un contrat associant formation en CFA et entreprise",ok:true},{t:"Un stage longue durée rémunéré"},{t:"Un contrat réservé aux moins de 18 ans"}],
x:"Bonne réponse : Un contrat associant formation en CFA et entreprise. Le contrat d'apprentissage est un contrat de travail en alternance associant formation théorique dans un CFA et formation pratique en entreprise. Depuis la loi de 2018, il peut être un CDI. La rémunération est un pourcentage du SMIC selon l'âge et l'année de formation."},

{id:318,prog:'LEGER',theme:'cl-fiscal',d:1,
e:"La déclaration de TVA mensuelle (régime normal) doit être déposée :",
r:[{t:"Le 31 décembre de chaque année"},{t:"Chaque mois, avant la date limite fixée par le fisc",ok:true},{t:"Chaque trimestre uniquement"},{t:"Uniquement si la TVA collectée dépasse 1 000 €"}],
x:"Bonne réponse : Chaque mois, avant la date limite fixée par le fisc. Au régime normal de TVA, la déclaration CA3 est déposée chaque mois (en ligne) avec paiement correspondant. Le régime simplifié permet des acomptes semestriels et une déclaration annuelle."},

{id:319,prog:'LEGER',theme:'cl-gestion',d:2,
e:"La CAF (Capacité d'Autofinancement) se calcule comme :",
r:[{t:"Résultat net uniquement"},{t:"Résultat net + Dotations aux amortissements − Reprises",ok:true},{t:"Résultat avant IS"},{t:"Chiffre d'affaires - Charges variables"}],
x:"Bonne réponse : Résultat net + Dotations aux amortissements − Reprises. CAF = Résultat net + Dotations aux amortissements et provisions - Reprises sur provisions. Elle représente le flux de trésorerie interne généré par l'activité. Les amortissements sont rajoutés car ils sont des charges calculées sans décaissement. La CAF sert à rembourser les emprunts, investir et distribuer des dividendes."},

{id:320,prog:'LEGER',theme:'cl-acces',d:2,
e:"Un transporteur VUL peut-il exercer sans local professionnel en France ?",
r:[{t:"Oui, son domicile personnel suffit"},{t:"Non, il doit avoir un établissement stable réel",ok:true},{t:"Oui, avec une simple boîte postale"},{t:"Oui, si son véhicule est stationné en France"}],
x:"Bonne réponse : Non, il doit avoir un établissement stable réel. La condition d'établissement impose un établissement réel et stable : locaux où sont conservés les documents principaux, matériel de gestion adapté et véhicules disponibles dans l'État d'établissement. Une boîte aux lettres ou domicile personnel ne suffisent pas."},

{id:321,prog:'LEGER',theme:'cl-social',d:2,
e:"L'inaptitude médicale déclarée par le médecin du travail oblige l'employeur à :",
r:[{t:"Licencier immédiatement le salarié"},{t:"Rechercher un reclassement ou licencier pour inaptitude",ok:true},{t:"Accorder un congé maladie indéfini"},{t:"Proposer une rupture conventionnelle obligatoire"}],
x:"Bonne réponse : Rechercher un reclassement ou licencier pour inaptitude. En cas d'inaptitude déclarée par le médecin du travail, l'employeur doit rechercher un reclassement du salarié dans un emploi compatible avec ses restrictions. Si le reclassement est impossible ou refusé, l'employeur peut licencier pour inaptitude. Le salarié reçoit alors une indemnité spéciale de licenciement."},
...
r:[{t:"Uniquement aux transporteurs de plus de 3,5t"},{t:"Aux plus de 3,5t et aux moins de 3,5t pour compte d'autrui",ok:true},{t:"À tous les véhicules professionnels"},{t:"Uniquement aux transports internationaux"}],
x:"Bonne réponse : Aux plus de 3,5t et aux moins de 3,5t pour compte d'autrui. Le règlement 1071/2009 s'applique historiquement aux transports de marchandises avec des véhicules de plus de 3,5t. Le règlement 2020/1055 a étendu certaines de ses dispositions aux transporteurs utilisant des véhicules de moins de 3,5t effectuant des transports internationaux, avec application progressive depuis 2022."},
...
r:[{t:"Le salarié lui-même"},{t:"L'administration fiscale, d'après la déclaration",ok:true},{t:"L'employeur en fonction du salaire brut"},{t:"L'URSSAF"}],
x:"Bonne réponse : L'administration fiscale, d'après la déclaration. Le taux du prélèvement à la source est calculé et communiqué par la DGFiP à l'employeur. Il est basé sur la déclaration de revenus de l'année précédente. Le salarié peut opter pour un taux neutre (sur barème) ou pour un taux individualisé au sein du foyer fiscal."},
...
r:[{t:"La rentabilité des actifs"},{t:"La capacité à rembourser ses dettes par son résultat brut",ok:true},{t:"Le niveau de liquidité immédiate"},{t:"L'autonomie financière"}],
x:"Bonne réponse : La capacité à rembourser ses dettes par son résultat brut. Ratio levier = Dette nette / EBITDA. Un ratio < 3-4 est considéré sain pour les entreprises industrielles/transport. Au-delà de 5-6, le risque financier est élevé et les banques peuvent refuser de nouveaux prêts. Ce ratio est l'un des covenants financiers les plus utilisés dans les contrats de crédit."},
...
r:[{t:"La valeur de la marque enregistrée"},{t:"L'écart entre le prix payé et la valeur nette des actifs",ok:true},{t:"La valeur des brevets déposés"},{t:"Les stocks de l'entreprise achetée"}],
x:"Bonne réponse : L'écart entre le prix payé et la valeur nette des actifs. Le goodwill (ou fonds commercial) = Prix payé — Juste valeur des actifs nets identifiables. Il représente la réputation, les relations clients, les savoir-faire non comptabilisés. En normes françaises il s'amortit. En IFRS, il est soumis à un test de dépréciation annuel (impairment test)."},
...
r:[{t:"La rentabilité économique dépasse le coût de la dette",ok:true},{t:"L'entreprise n'a pas de dettes"},{t:"Le CA augmente chaque année"},{t:"Le taux d'intérêt est supérieur à la rentabilité économique"}],
x:"Bonne réponse : La rentabilité économique dépasse le coût de la dette. L'effet de levier est favorable quand le taux de rentabilité économique (ROA) est supérieur au taux d'intérêt de la dette : l'endettement améliore la rentabilité des capitaux propres (ROE). Il est défavorable (effet de massue) quand les intérêts dépassent la rentabilité économique."},
...
r:[{t:"40 km/h dans les zones scolaires uniquement"},{t:"30 km/h en zone 30, zone résidentielle et zone de rencontre",ok:true},{t:"20 km/h uniquement dans les parcs"},{t:"Il n'y a pas de limitation inférieure à 50 km/h en agglomération"}],
x:"Bonne réponse : 30 km/h en zone 30, zone résidentielle et zone de rencontre. En agglomération, la limitation à 30 km/h s'applique dans les zones 30 (signalées par un panneau rond bleu/blanc), dans les zones résidentielles et zones de rencontre. La vitesse peut également être réduite par des arrêtés municipaux locaux. Depuis 2021, Paris a généralisé la zone 30 sur l'ensemble de la ville."},
...
r:[{t:"Rembourser la dette par anticipation"},{t:"Remplacer une obligation ancienne par une obligation nouvelle",ok:true},{t:"Transférer la dette à un tiers"},{t:"Suspendre temporairement le paiement"}],
x:"Bonne réponse : Remplacer une obligation ancienne par une obligation nouvelle. La novation (art. 1329 du Code civil) est un mécanisme qui éteint une obligation existante pour la remplacer par une nouvelle. Elle peut porter sur l'objet de la dette (novation par changement d'objet) ou sur les parties (novation par changement de débiteur = délégation)."},
...
r:[{t:"La Préfecture"},{t:"Le Ministère de la Transition Écologique en ligne",ok:true},{t:"La Chambre de Commerce"},{t:"L'assureur du véhicule"}],
x:"Bonne réponse : Le Ministère de la Transition Écologique en ligne. La vignette Crit'Air est un certificat officiel délivré par le Ministère de la Transition Écologique sur le site certificat-air.gouv.fr (1,84 € de frais d'envoi). Elle est attribuée selon les émissions du véhicule (motorisation, norme Euro) et est obligatoire pour circuler dans les ZFE-m."},
...
r:[{t:"Vendre son fonds sans accord des créanciers"},{t:"Affecter son fonds en garantie d'emprunt en l'exploitant",ok:true},{t:"Suspendre le paiement de ses dettes"},{t:"Transférer la propriété temporairement"}],
x:"Bonne réponse : Affecter son fonds en garantie d'emprunt en l'exploitant. Le nantissement de fonds de commerce (art. L.142-1 du Code de commerce) est une sûreté mobilière permettant d'affecter le fonds en garantie d'un crédit sans en perdre la possession. Le créancier bénéficie d'un droit de préférence sur le prix de vente du fonds en cas de défaillance du débiteur."},
...
r:[{t:"20h par semaine"},{t:"24h par semaine (sauf exceptions légales)",ok:true},{t:"Toute durée inférieure à 35h"},{t:"Il n'y a pas de minimum légal"}],
x:"Bonne réponse : 24h par semaine (sauf exceptions légales). La durée minimale du temps partiel est de 24 heures hebdomadaires (art. L.3123-7 du Code du travail). Des exceptions sont prévues : à la demande écrite du salarié, par accord de branche, pour les étudiants de moins de 26 ans. En dessous de 24h, le salarié peut refuser sans motif."},

{id:353,prog:'LEGER',theme:'cl-gestion',d:2,
e:"Le délai de récupération d'un investissement (DRI ou payback) :",
r:[{t:"Mesure la rentabilité de l'investissement en %"},{t:"Le temps pour récupérer le capital investi via les flux",ok:true},{t:"Calcule la valeur future d'un investissement"},{t:"Determine la valeur de revente du bien"}],
x:"Bonne réponse : Le temps pour récupérer le capital investi via les flux. Le DRI = Capital investi / Flux de trésorerie annuel moyen généré. Un DRI de 3 ans signifie que l'investissement sera remboursé en 3 ans par les flux qu'il génère. C'est un critère simple de sélection : plus le DRI est court, plus l'investissement est rapidement rentabilisé."},
...
e:"Le CPF (Compte Personnel de Formation) est alimenté à hauteur de :",
r:[{t:"300 €/an"},{t:"500 €/an pour un temps plein (800 € si peu qualifié)",ok:true},{t:"1 000 €/an systématiquement"},{t:"En fonction du salaire brut"}],
x:"Bonne réponse : 500 €/an pour un temps plein (800 € si peu qualifié). Le CPF est alimenté à 500 €/an pour les salariés à temps plein ayant au moins un niveau bac (plafond 5 000 €), et à 800 €/an pour les salariés sans qualification (plafond 8 000 €). Les droits sont utilisables pour financer des formations certifiantes de son choix."},
...
r:[{t:"Le délai de livraison moyen aux clients"},{t:"Le délai moyen d'encaissement des factures clients",ok:true},{t:"La durée de conservation des marchandises en stock"},{t:"Le délai de paiement accordé aux fournisseurs"}],
x:"Bonne réponse : Le délai moyen d'encaissement des factures clients. Délai de rotation créances = (Créances clients / CA TTC) × 360. Il mesure le nombre de jours moyen avant d'encaisser les paiements clients. Plus il est court, meilleure est la trésorerie."},

{id:361,prog:'LEGER',theme:'cl-fiscal',d:3,
e:"Le déficit fiscal d'une entreprise à l'IS peut être :",
r:[{t:"Reporté en avant sur les exercices bénéficiaires suivants",ok:true},{t:"Remboursé par l'État immédiatement"},{t:"Reporté uniquement sur les 3 exercices précédents"},{t:"Perdu définitivement à la clôture de l'exercice"}],
x:"Bonne réponse : Reporté en avant sur les exercices bénéficiaires suivants. Le déficit fiscal à l'IS est reportable en avant (sur les exercices bénéficiaires suivants) sans limitation de durée, mais plafonné à 1 M€ + 50 % du bénéfice imposable excédant ce seuil (art. 209 I du CGI). Il peut aussi être reporté en arrière (carry-back) sur l'exercice précédent, dans la limite de 1 M€."},

{id:362,prog:'LEGER',theme:'cl-gestion',d:1,
e:"Le résultat exceptionnel dans le compte de résultat comprend :",
r:[{t:"Les opérations courantes de l'activité principale"},{t:"Les produits et charges hors exploitation normale",ok:true},{t:"Uniquement les pertes sur créances"},{t:"Les charges financières de l'emprunt"}],
x:"Bonne réponse : Les produits et charges hors exploitation normale. Le résultat exceptionnel regroupe les produits et charges non récurrents : cessions d'immobilisations (plus ou moins-values), indemnités d'assurance pour sinistre, subventions exceptionnelles, pénalités, rappels d'impôts. Il se distingue du résultat d'exploitation (activité normale) et du résultat financier."},
...
r:[{t:"300 €/an"},{t:"500 €/an pour un temps plein (800 € si peu qualifié)",ok:true},{t:"1 000 €/an systématiquement"},{t:"En fonction du salaire brut uniquement"}],
...
r:[{t:"Uniquement la réglementation transport"},{t:"Droit, social, fiscalité, gestion, accès et règles techniques",ok:true},{t:"Uniquement la sécurité routière et la fiscalité"},{t:"Uniquement les mathématiques financières"}],
x:"Bonne réponse : Droit, social, fiscalité, gestion, accès et règles techniques. L'examen CPC pour le transport léger (<3,5t) couvre 6 domaines selon le règlement européen 1071/2009 : droit civil et commercial, droit social, fiscalité, gestion financière et comptable, accès au marché, normes techniques. Organisé par les CCI, il comprend des épreuves écrites (QCM + questions rédigées)."},
...
r:[{t:"Ne jamais payer d'IR"},{t:"Payer l'IR forfaitairement sur le CA déclaré",ok:true},{t:"Bénéficier d'une exonération d'IR pendant 2 ans"},{t:"Réduire le taux d'IR à 5 %"}],
x:"Bonne réponse : Payer l'IR forfaitairement sur le CA déclaré. Le versement libératoire (art. 151-0 du CGI) permet de payer l'IR en même temps que les cotisations sociales, à un taux forfaitaire sur le CA (1 % vente, 1,7 % services BIC, 2,2 % BNC). Réservé aux foyers sous un certain plafond de revenu fiscal de référence."},

{id:373,prog:'LEGER',theme:'cl-gestion',d:2,
e:"L'escompte commercial de 2 % à 30 jours correspond à un taux annualisé de :",
r:[{t:"2 %"},{t:"Environ 24 % si l'échéance est à 60 jours",ok:true},{t:"12 %"},{t:"48 %"}],
x:"Bonne réponse : Environ 24 % si l'échéance est à 60 jours. Taux annualisé = (Taux escompte / Durée gagnée) × 360. Si l'escompte est 2 % pour 30 jours gagnés (paiement à 30j vs échéance à 60j) : 2 / 30 × 360 = 24 % par an. Ce coût élevé incite le client à profiter de l'escompte (payer tôt) plutôt que d'utiliser un découvert bancaire coûteux."},

{id:374,prog:'LEGER',theme:'cl-secu',d:2,
e:"Le système ESP (Electronic Stability Program) d'un VUL intervient en cas de :",
r:[{t:"Freinage d'urgence uniquement"},{t:"Perte de contrôle directionnelle, corrigée automatiquement",ok:true},{t:"Démarrage sur sol glissant"},{t:"Changement de vitesse automatique"}],
x:"Bonne réponse : Perte de contrôle directionnelle, corrigée automatiquement. L'ESP détecte les situations de sous-virage (le véhicule part tout droit dans un virage) ou de survirage (l'arrière chasse) en comparant la trajectoire souhaitée (angle du volant) à la trajectoire réelle (capteurs gyroscopiques). Il corrige automatiquement en freinant sélectivement une ou plusieurs roues. Obligatoire sur tous les véhicules neufs depuis 2014."},

{id:375,prog:'LEGER',theme:'cl-gestion',d:2,
e:"La valeur ajoutée d'une entreprise se répartit entre :",
r:[{t:"Actionnaires et banques uniquement"},{t:"Salariés, État, créanciers et actionnaires",ok:true},{t:"Uniquement les charges d'exploitation"},{t:"Le dirigeant et les seuls investisseurs"}],
x:"Bonne réponse : Salariés, État, créanciers et actionnaires. La valeur ajoutée = richesse créée par l'entreprise = CA — Consommations intermédiaires. Elle est répartie entre : salariés (rémunérations), État (impôts et taxes), créanciers (charges financières) et apporteurs de capitaux (dividendes + autofinancement). L'analyse de cette répartition reflète la politique sociale et financière."},

{id:376,prog:'LEGER',theme:'cl-gestion',d:3,
e:"La structure de financement optimale d'une entreprise de transport cherche à :",
r:[{t:"Maximiser l'endettement pour profiter de l'effet de levier"},{t:"Équilibrer fonds propres et dettes pour optimiser le capital",ok:true},{t:"Financer uniquement par fonds propres pour éviter tout endettement"},{t:"Minimiser les capitaux propres pour réduire les obligations vis-à-vis des actionnaires"}],
x:"Bonne réponse : Équilibrer fonds propres et dettes pour optimiser le capital. La structure optimale de financement (théorie de Modigliani-Miller avec fiscalité) consiste à utiliser l'endettement pour profiter de la déductibilité des intérêts (économie fiscale), tout en évitant un endettement excessif qui augmenterait le risque de faillite. Dans la pratique, les entreprises de transport visent une autonomie financière de 30 à 40 %."},
...
r:[{t:"Un licenciement interdit pendant toute la durée de l'arrêt"},{t:"Possible pour une cause étrangère à la maladie",ok:true},{t:"Un licenciement interdit pendant 6 mois"},{t:"Aucune protection spécifique"}],
x:"Bonne réponse : Possible pour une cause étrangère à la maladie. Le salarié en arrêt maladie ordinaire bénéficie d'une protection relative : il peut être licencié pour motif étranger à la maladie (faute, motif économique) ou si son absence prolongée perturbe l'entreprise au point de nécessiter son remplacement définitif. L'employeur doit chercher des alternatives avant de licencier dans ce cas."},

{id:379,prog:'LEGER',theme:'cl-civil',d:2,
e:"La résolution d'un contrat pour inexécution entraîne :",
r:[{t:"La modification des obligations des parties"},{t:"L'anéantissement rétroactif du contrat avec restitutions",ok:true},{t:"Uniquement le versement de dommages et intérêts"},{t:"La suspension temporaire du contrat"}],
x:"Bonne réponse : L'anéantissement rétroactif du contrat avec restitutions. La résolution (art. 1229 du Code civil) met fin au contrat et l'anéantit rétroactivement : les parties sont remises dans l'état où elles étaient avant la conclusion du contrat (restitutions mutuelles). Elle diffère de la résiliation qui ne vaut que pour l'avenir."},
...
r:[{t:"Le paiement de la facture"},{t:"L'exigibilité de la TVA chez le fournisseur",ok:true},{t:"La réception des marchandises uniquement"},{t:"La revente des marchandises"}],
x:"Bonne réponse : L'exigibilité de la TVA chez le fournisseur. Le droit à déduction de la TVA prend naissance à la date à laquelle la taxe devient exigible chez le fournisseur. Pour les livraisons de biens : à la livraison. Pour les prestations de services : à l'encaissement (sauf option pour les débits). La facture est obligatoire pour exercer ce droit."},

{id:383,prog:'LEGER',theme:'cl-secu',d:1,
e:"En cas de crevaison sur autoroute, il faut :",
r:[{t:"Freiner brusquement et s'arrêter sur la voie rapide"},{t:"Ralentir doucement et rejoindre la bande d'arrêt d'urgence",ok:true},{t:"Accélérer pour atteindre la prochaine sortie"},{t:"Allumer les feux de détresse uniquement"}],
x:"Bonne réponse : Ralentir doucement et rejoindre la bande d'arrêt d'urgence. En cas de crevaison : tenir fermement le volant (le véhicule tire d'un côté), ralentir très progressivement sans freiner brusquement, ne pas faire de mouvement brusque de direction, rejoindre la BAU le plus vite possible, puis allumer les feux de détresse, sortir du véhicule par la droite et placer les triangles de signalisation."},

{id:384,prog:'LEGER',theme:'cl-gestion',d:1,
e:"Un flux de trésorerie négatif sur l'activité (Operating Cash Flow < 0) signifie :",
r:[{t:"L'entreprise est forcément en faillite"},{t:"L'exploitation consomme plus de trésorerie qu'elle n'en génère",ok:true},{t:"L'entreprise investit beaucoup"},{t:"L'entreprise a remboursé ses dettes"}],
x:"Bonne réponse : L'exploitation consomme plus de trésorerie qu'elle n'en génère. Un OCF négatif signifie que l'activité opérationnelle consomme de la trésorerie. C'est préoccupant car une entreprise doit normalement générer de la trésorerie via son exploitation. Cela peut indiquer un BFR trop élevé, une rentabilité insuffisante ou des délais de paiement défavorables. À distinguer des flux d'investissement et de financement."},

{id:385,prog:'LEGER',theme:'cl-civil',d:2,
e:"Le nantissement du fonds de commerce permet au commerçant de :",
r:[{t:"Vendre son fonds sans accord des créanciers"},{t:"Affecter son fonds en garantie d'emprunt en l'exploitant",ok:true},{t:"Suspendre le paiement de ses dettes"},{t:"Transférer temporairement la propriété"}],
x:"Bonne réponse : Affecter son fonds en garantie d'emprunt en l'exploitant. Le nantissement de fonds de commerce (art. L.142-1 du Code de commerce) est une sûreté mobilière permettant d'affecter le fonds en garantie d'un crédit sans en perdre la possession. Le créancier bénéficie d'un droit de préférence sur le prix de vente du fonds en cas de défaillance du débiteur."},
...
r:[{t:"Vend son entreprise à un repreneur étranger"},{t:"Transfère son domicile fiscal hors de France avec des titres",ok:true},{t:"Réalise une plus-value supérieure à 1 M€"},{t:"Cède des actions cotées en bourse"}],
x:"Bonne réponse : Transfère son domicile fiscal hors de France avec des titres. L'exit tax (art. 167 bis du CGI) s'applique aux personnes physiques qui transfèrent leur domicile fiscal hors de France, si elles ont été résidentes françaises pendant 6 des 10 dernières années et détiennent des participations ≥ 50 % ou d'une valeur > 800 000 €. Elle impose les plus-values latentes lors du départ."},
...
r:[{t:"Elle est moins contraignante pour le garant"},{t:"Le garant paie sans pouvoir opposer les exceptions du contrat",ok:true},{t:"Elle ne couvre que les dettes commerciales"},{t:"Elle nécessite l'accord du débiteur principal"}],
x:"Bonne réponse : Le garant paie sans pouvoir opposer les exceptions du contrat. La garantie autonome (ou garantie à première demande) est indépendante du contrat garanti : le garant paie sur simple demande du bénéficiaire, sans pouvoir opposer les exceptions que le débiteur principal pourrait invoquer. Contrairement au cautionnement, elle est totalement détachée de la dette principale."},
...
r:[{t:"Une réduction de 2 % sur le prix de vente brut"},{t:"Une réduction si la facture est payée sous 30 jours",ok:true},{t:"Une majoration de 2 % en cas de retard"},{t:"Une remise annuelle de 2 %"}],
x:"Bonne réponse : Une réduction si la facture est payée sous 30 jours. L'escompte commercial est une réduction financière accordée au client qui paie avant l'échéance normale. '2 % à 30 jours' signifie que si le client paie dans les 30 jours, il bénéficie d'une réduction de 2 % sur le montant HT de la facture. Le coût annualisé de ne pas prendre cet escompte peut être très élevé."},
...
r:[{t:"Non, aucune réglementation spécifique"},{t:"Oui : respect du règlement CE 852/2004 sur l'hygiène",ok:true},{t:"Oui, uniquement si le CA dépasse 100 000 €"},{t:"Non si le transport est de moins de 50 km"}],
x:"Bonne réponse : Oui : respect du règlement CE 852/2004 sur l'hygiène. Même les denrées sèches sont soumises au règlement CE 852/2004 sur l'hygiène des denrées alimentaires. Le transporteur doit : maintenir les véhicules propres et en bon état, éviter la contamination croisée, assurer la traçabilité, et former son personnel à l'hygiène. Un plan de nettoyage est recommandé."},

{id:397,prog:'LEGER',theme:'cl-social',d:2,
e:"Pour l'embauche d'un premier salarié, l'employeur doit effectuer en priorité :",
r:[{t:"Une déclaration à la Chambre des Métiers uniquement"},{t:"Une Déclaration Préalable à l'Embauche (DPAE)",ok:true},{t:"Un enregistrement au tribunal de commerce"},{t:"Une demande d'autorisation à la DREAL"}],
x:"Bonne réponse : Une Déclaration Préalable à l'Embauche (DPAE). La Déclaration Préalable à l'Embauche (DPAE) doit être envoyée à l'URSSAF dans les 8 jours précédant l'embauche. C'est obligatoire pour tout premier salarié."},
...
r:[{t:"Conserver sa mutuelle en payant lui-même les cotisations"},{t:"Maintien gratuit de la couverture pendant le chômage",ok:true},{t:"Adhérer à la mutuelle de son futur employeur sans délai de carence"},{t:"Transférer ses droits à un membre de sa famille"}],
x:"Bonne réponse : Maintien gratuit de la couverture pendant le chômage. La portabilité (art. L.911-8 du Code de la sécurité sociale) permet aux anciens salariés dont le contrat a été rompu (sauf faute lourde) de conserver les garanties santé et prévoyance de l'entreprise pendant le chômage, gratuitement, dans la limite de 12 mois. Les cotisations sont mutualisées entre actifs et anciens salariés."},
...
r:[{t:"Calculer le salaire moyen de l'entreprise"},{t:"Actualiser les flux futurs pour évaluer un investissement",ok:true},{t:"Fixer le taux d'intérêt des emprunts"},{t:"Calculer la valeur comptable des actifs"}],
x:"Bonne réponse : Actualiser les flux futurs pour évaluer un investissement. Le WACC (Weighted Average Cost of Capital) est le taux d'actualisation utilisé pour évaluer les investissements ou la valeur d'une entreprise. Il pondère le coût des fonds propres et le coût de la dette selon leur poids dans le financement. Un investissement est rentable si son TRI dépasse le WACC."},

{id:402,prog:'LEGER',theme:'cl-regl',d:2,
e:"Le transport de médicaments et produits pharmaceutiques par VUL nécessite :",
r:[{t:"Aucune réglementation spécifique"},{t:"Un agrément ANSM et des conditions de transport adaptées",ok:true},{t:"Uniquement un VUL fermé"},{t:"Le permis C obligatoirement"}],
x:"Bonne réponse : Un agrément ANSM et des conditions de transport adaptées. Le transport de médicaments est réglementé par les Bonnes Pratiques de Distribution (BPD) de l'ANSM. Il requiert : des véhicules adaptés aux conditions de conservation (température dirigée si nécessaire), une traçabilité rigoureuse, des procédures d'urgence en cas de dommage, et dans certains cas un agrément spécifique."},
...
r:[{t:"Uniquement de l'expéditeur"},{t:"Uniquement du commissionnaire s'il est intervenu"},{t:"Uniquement du destinataire"},{t:"L'expéditeur, le commissionnaire ou le destinataire",ok:true}],
x:"Bonne réponse : L'expéditeur, le commissionnaire ou le destinataire. L'article L.132-8 du Code de commerce consacre l'action directe en paiement du transporteur. Le voiturier (transporteur) bénéficie d'un privilège sur la marchandise et peut agir directement contre l'expéditeur, le destinataire ou le commissionnaire de transport."},
...
r:[{t:"D'indemniser uniquement les dommages sur la valeur d'achat des marchandises"},{t:"D'indemniser les dommages justifiés, dans la limite des plafonds",ok:true},{t:"De faire procéder au remplacement des objets perdus ou à la remise en état des avariés"},{t:"De vendre la marchandise pour indemniser le destinataire"}],
x:"Bonne réponse : D'indemniser les dommages justifiés, dans la limite des plafonds. Le transporteur doit indemniser tous les dommages justifiés dont il est légalement tenu pour responsable. L'indemnisation est plafonnée par les contrats types (exprimés en €/kg) et ne peut dépasser la valeur réelle de la marchandise. Une déclaration de valeur permet d'augmenter ce plafond."},
...
r:[{t:"13 heures par jour maximum"},{t:"48 heures hebdomadaires en moyenne sur 12 semaines",ok:true},{t:"56 heures maximum sur une semaine isolée"},{t:"11 heures maximum par jour avec possibilité de 12h30"}],
x:"Bonne réponse : 48 heures hebdomadaires en moyenne sur 12 semaines. Le temps de service (temps de conduite + autres travaux + disponibilités) d'un conducteur grand routier est limité à 48 heures hebdomadaires en moyenne sur 12 semaines (ou 4 mois par accord). La durée maximale sur une semaine isolée est de 60 heures."},
...
r:[{t:"La conduite d'un véhicule équipé d'un tachygraphe numérique"},{t:"La conduite et le téléchargement des données de l'appareil"},{t:"Le téléchargement des données des tachygraphes",ok:true},{t:"L'étalonnage du tachygraphe numérique"}],
x:"Bonne réponse : Le téléchargement des données des tachygraphes. La carte entreprise permet uniquement le téléchargement (lecture) des données enregistrées dans la mémoire des tachygraphes numériques. La carte conducteur est nécessaire pour conduire. La carte atelier permet l'étalonnage."},
...
r:[{t:"Des permis C et CE, et de la carte conducteur tachygraphe en cours de validité"},{t:"Permis C, CQC et carte conducteur en cours de validité",ok:true},{t:"Du permis C en cours de validité et de l'attestation de capacité professionnelle"},{t:"Du permis D et de la carte conducteur tachygraphe en cours de validité"}],
x:"Bonne réponse : Permis C, CQC et carte conducteur en cours de validité. Pour conduire un camion isolé (>7,5t), le conducteur doit avoir : le permis C en cours de validité, la CQC (Carte de Qualification du Conducteur) valide (initiale ou renouvelée par FCO), et la carte conducteur pour le tachygraphe numérique."},

{id:2026,prog:'LOURD',theme:'lo-gestion',d:2,
e:"Le coût de revient kilométrique (CRK) d'un ensemble routier se calcule ainsi :",
r:[{t:"(Charges variables annuelles) / Kilométrage annuel"},{t:"(Charges fixes + Charges variables) / Kilométrage annuel",ok:true},{t:"(Charges fixes annuelles) / Nombre de jours d'exploitation"},{t:"Coût du carburant / Kilométrage annuel"}],
x:"Bonne réponse : (Charges fixes + Charges variables) / Kilométrage annuel. Le CRK = Total des charges annuelles (fixes + variables) / Kilométrage annuel. Les charges fixes comprennent : amortissements, salaires, assurances, structure. Les charges variables comprennent : carburant, entretien/pneus, péages, AdBlue."},
...
r:[{t:"Payer les salaires des conducteurs"},{t:"Rembourser les emprunts, investir et verser des dividendes",ok:true},{t:"Calculer l'impôt sur les sociétés dû"},{t:"Déterminer le montant des cotisations sociales"}],
x:"Bonne réponse : Rembourser les emprunts, investir et verser des dividendes. La CAF représente les ressources internes dégagées par l'activité. Elle permet de : rembourser les emprunts, financer de nouveaux investissements (renouvellement du parc), constituer des réserves et éventuellement distribuer des dividendes."},
...
r:[{t:"De réduire la valeur d'achat du véhicule"},{t:"D'amortir le véhicule sur une durée plus longue"},{t:"Déduire un amortissement supérieur à la dépréciation réelle",ok:true},{t:"D'obtenir un remboursement direct de l'État"}],
x:"Bonne réponse : Déduire un amortissement supérieur à la dépréciation réelle. Le suramortissement permet de déduire fiscalement un amortissement supplémentaire (ex. 40 % du prix d'achat en plus de l'amortissement normal) pour les investissements dans des véhicules à énergies alternatives. Cela réduit la base imposable et donc l'IS."},
...
r:[{t:"Ignorer le crédit-bail car ce n'est pas un bien propriété de l'entreprise"},{t:"Inscrire le bien à l'actif et les engagements en dettes",ok:true},{t:"Inscrire uniquement les loyers versés en charges d'exploitation"},{t:"Déduire les loyers restant à payer du résultat prévisionnel"}],
x:"Bonne réponse : Inscrire le bien à l'actif et les engagements en dettes. Le retraitement du crédit-bail en analyse financière consiste à : ajouter la valeur brute du bien en actif immobilisé (comme s'il était propriétaire) et ajouter les engagements restants du crédit-bail aux dettes financières. Cela donne une image plus fidèle de la structure financière."},
...
r:[{t:"Chiffre d'affaires − Achats de carburant"},{t:"Production vendue − Consommations intermédiaires",ok:true},{t:"Chiffre d'affaires − Charges de personnel"},{t:"Excédent brut d'exploitation − Dotations aux amortissements"}],
x:"Bonne réponse : Production vendue − Consommations intermédiaires. VA = Production (CA ± variation de stocks) − Consommations intermédiaires. Dans le transport, les consommations intermédiaires comprennent notamment : carburant, sous-traitance transport, entretien, assurances, loyers de crédit-bail…"},
...
r:[{t:"1 800 € pour le 1er véhicule et 900 € par véhicule supplémentaire"},{t:"9 000 € pour le 1er véhicule, 5 000 € par suivant",ok:true},{t:"50 000 € quelle que soit la taille du parc"},{t:"100 000 € minimum imposés par la loi"}],
x:"Bonne réponse : 9 000 € pour le 1er véhicule, 5 000 € par suivant. Pour le transport lourd (>3,5t), la capacité financière est de 9 000 € pour le 1er véhicule et 5 000 € par véhicule supplémentaire. Cette condition doit être satisfaite à tout moment de la vie de l'entreprise."},
...
r:[{t:"Ses gérants et la personne dirigeant les transports",ok:true},{t:"Ses gérants obligatoirement majoritaires et du gestionnaire de transport"},{t:"Ses gérants uniquement"},{t:"Ses gérants obligatoirement minoritaires et du gestionnaire de transport"}],
x:"Bonne réponse : Ses gérants et la personne dirigeant les transports. L'honorabilité professionnelle doit être prouvée pour toutes les personnes ayant une responsabilité dans la direction de l'entreprise : les gérants (ou dirigeants) ET le gestionnaire de transport (ou directeur des transports), qu'il soit interne ou externe."},
...
r:[{t:"Exercer quand même sans gestionnaire de transport"},{t:"Faire appel à un gestionnaire de transport externe",ok:true},{t:"Utiliser la capacité professionnelle d'un associé retraité"},{t:"Se passer de la condition de capacité professionnelle"}],
x:"Bonne réponse : Faire appel à un gestionnaire de transport externe. Si l'entreprise n'a pas de gestionnaire de transport interne (salarié ou dirigeant), elle peut faire appel à un gestionnaire de transport externe : une personne physique habilitée, liée à l'entreprise par un contrat de mandat. Ce gestionnaire ne peut gérer que 4 entreprises au maximum avec un total de 50 véhicules."},
...
r:[{t:"Le K-bis délivré par le greffe du tribunal de commerce"},{t:"La licence de transport intérieur ou communautaire",ok:true},{t:"L'attestation de capacité professionnelle"},{t:"Le certificat d'inscription délivré par l'INSEE"}],
x:"Bonne réponse : La licence de transport intérieur ou communautaire. L'inscription au RNET est matérialisée par la délivrance d'une licence de transport intérieur (LTI) pour le transport national, ou d'une licence communautaire (LC) pour le transport international dans l'UE. Ces titres sont délivrés par la DREAL."},
...
r:[{t:"Uniquement aux transports entre la France et ses voisins directs"},{t:"À tout transport international entre deux pays signataires",ok:true},{t:"Uniquement aux transports avec des véhicules de plus de 3,5t"},{t:"Aux transports nationaux et internationaux de marchandises dangereuses"}],
x:"Bonne réponse : À tout transport international entre deux pays signataires. La Convention CMR s'applique à tout contrat de transport international de marchandises par route à titre onéreux lorsque le lieu de prise en charge de la marchandise et le lieu de livraison sont situés dans deux pays différents, dont l'un au moins est signataire de la Convention."},
...
r:[{t:"Les transports entre pays membres de l'UE (Union Européenne) uniquement"},{t:"Les transports sous scellés douaniers traversant des pays hors UE",ok:true},{t:"Les transports de marchandises dangereuses uniquement"},{t:"Les transports de plus de 44 tonnes en transport exceptionnel"}],
x:"Bonne réponse : Les transports sous scellés douaniers traversant des pays hors UE. Le carnet TIR est un document douanier international permettant le transport de marchandises sous scellés, en suspendant les droits et taxes dans les pays de transit. Il est principalement utilisé pour les transports traversant des pays hors UE (Turquie, Maroc, pays de la CEI...)."},
...
r:[{t:"Le transporteur obligatoirement lors du chargement"},{t:"L'expéditeur dès la conclusion du contrat de vente"},{t:"Le transporteur dès réception de l'ordre de transport"},{t:"L'expéditeur ou le transporteur sous sa responsabilité",ok:true}],
x:"Bonne réponse : L'expéditeur ou le transporteur sous sa responsabilité. Selon la CMR, la lettre de voiture est établie par l'expéditeur ou par le transporteur agissant sous la responsabilité de l'expéditeur. Elle est établie en 3 exemplaires minimum : 1 pour l'expéditeur, 1 accompagne la marchandise (pour le destinataire), 1 conservé par le transporteur."},
...
r:[{t:"La licence communautaire française uniquement"},{t:"La licence communautaire belge uniquement"},{t:"La licence communautaire française et la licence communautaire belge"},{t:"La licence communautaire du tracteur (français)",ok:true}],
x:"Bonne réponse : La licence communautaire du tracteur (français). La licence communautaire est délivrée au transporteur, pas au véhicule. Le transporteur français utilisant son tracteur (propriété française) avec une semi-remorque étrangère est couvert par sa propre licence communautaire française pour l'ensemble du transport."},
...
r:[{t:"Toute sanction pénale pour infractions délictuelles des conducteurs"},{t:"Toute sanction préfectorale pour infractions transports/social",ok:true},{t:"Toute décision d'autorisation d'exercer la profession"},{t:"Toute décision du conseil de prud'hommes"}],
x:"Bonne réponse : Toute sanction préfectorale pour infractions transports/social. La CTSA émet un avis consultatif préalable aux décisions préfectorales de sanctions administratives à l'encontre des entreprises de transport pour des infractions à la réglementation des transports et à la réglementation sociale applicable."},
...
r:[{t:"Que l'entreprise est en faillite imminente"},{t:"Que le FRNG ne couvre pas le BFR",ok:true},{t:"Que le chiffre d'affaires est trop faible"},{t:"Que les capitaux propres sont négatifs"}],
x:"Bonne réponse : Que le FRNG ne couvre pas le BFR. La trésorerie nette = FRNG − BFR. Une trésorerie négative signifie que le FRNG ne couvre pas le BFR. L'entreprise doit recourir à des financements à court terme (découvert, escompte) pour financer son cycle d'exploitation."},
...
r:[{t:"Une APL (Autorisation de Portée Locale) délivrée par le préfet"},{t:"Une autorisation individuelle délivrée par la DREAL",ok:true},{t:"Une autorisation du ministère des transports"},{t:"Une simple déclaration en préfecture"}],
x:"Bonne réponse : Une autorisation individuelle délivrée par la DREAL. Un convoi dont la largeur dépasse 3 m constitue un transport exceptionnel de 1ère catégorie (entre 3 et 3,50 m) nécessitant une autorisation individuelle délivrée par la DREAL. Au-delà de 3,50 m, c'est la 2ème catégorie avec escorte."},
...
r:[{t:"Que l'entreprise est très rentable"},{t:"Que l'entreprise couvre ses charges mais avec peu de marge",ok:true},{t:"Que l'entreprise ne peut pas investir"},{t:"Que l'entreprise est en cessation de paiement"}],
x:"Bonne réponse : Que l'entreprise couvre ses charges mais avec peu de marge. Un EBE positif mais faible signifie que l'entreprise génère une ressource d'exploitation mais insuffisante pour couvrir confortablement ses charges financières, ses amortissements et avoir un résultat net satisfaisant. Une vigilance s'impose sur la rentabilité à terme."},
...
r:[{t:"L'organisme de formation agréé"},{t:"La préfecture du département de résidence"},{t:"La DREAL",ok:true},{t:"L'employeur du conducteur"}],
x:"Bonne réponse : La DREAL. L'attestation de formation ADR du conducteur est délivrée par la DREAL après réussite aux examens théoriques et pratiques organisés en fin de formation dans un établissement agréé. La DREAL délivre également les licences de transport."},
...
r:[{t:"L'entreprise est en faillite"},{t:"Les ressources stables ne couvrent pas l'actif immobilisé",ok:true},{t:"Les dettes à court terme sont inférieures à l'actif circulant"},{t:"Le chiffre d'affaires est insuffisant"}],
x:"Bonne réponse : Les ressources stables ne couvrent pas l'actif immobilisé. Un FRNG négatif signifie que l'actif immobilisé n'est pas entièrement financé par des ressources stables (capitaux propres + dettes à LT). L'entreprise finance une partie de ses investissements avec des ressources à court terme, ce qui constitue un déséquilibre financier potentiellement dangereux."},
...
r:[{t:"1 opération en 7 jours après un transport international"},{t:"3 opérations en 7 jours après un transport international",ok:true},{t:"5 opérations en 7 jours"},{t:"Sans limitation après un transport international"}],
x:"Bonne réponse : 3 opérations en 7 jours après un transport international. Selon le règlement (CE) n°1072/2009, le cabotage est limité à 3 opérations de transport national dans les 7 jours suivant le déchargement complet d'un transport international entrant. Après ces 3 opérations ou les 7 jours, le véhicule doit quitter le pays."},
...
r:[{t:"Son permis et son contrat de travail"},{t:"Permis, CQC, carte conducteur, licence et lettre de voiture",ok:true},{t:"Uniquement le permis de conduire et la lettre de voiture"},{t:"Le K-bis de l'entreprise et l'assurance du véhicule"}],
x:"Bonne réponse : Permis, CQC, carte conducteur, licence et lettre de voiture. Lors d'un contrôle routier, le conducteur de PL doit présenter : permis de conduire, CQC en cours de validité, carte conducteur tachygraphe, copie certifiée de la licence communautaire, lettre de voiture, données tachygraphe des 28 derniers jours."},
...
r:[{t:"Uniquement le montant HT et TTC"},{t:"Le numéro SIREN du client"},{t:"Échéance de paiement, escompte et pénalités de retard",ok:true},{t:"Le numéro de TVA intracommunautaire uniquement pour les transports internationaux"}],
x:"Bonne réponse : Échéance de paiement, escompte et pénalités de retard. La facture professionnelle doit mentionner notamment : identification des parties, date, numéro de facture, description de la prestation, prix HT, taux et montant de TVA, montant TTC, date d'échéance, conditions d'escompte (même si non accordé), et taux des pénalités de retard."},
...
r:[{t:"Calculer le résultat fiscal de l'exercice"},{t:"Anticiper les déficits de trésorerie pour réagir à temps",ok:true},{t:"Établir le bilan prévisionnel de l'exercice"},{t:"Planifier le renouvellement du parc de véhicules"}],
x:"Bonne réponse : Anticiper les déficits de trésorerie pour réagir à temps. Le plan de trésorerie mensuel prévisible permet d'anticiper les flux de trésorerie (encaissements/décaissements) et d'identifier en avance les mois de tension. Cela permet de prendre des mesures : ligne de crédit, report de charges, négociation de délais avec les fournisseurs."},
...
r:[{t:"Tout déplacement hors de l'établissement"},{t:"Une distance minimale du domicile, selon la CCN",ok:true},{t:"Un déplacement à l'étranger uniquement"},{t:"L'accord du responsable hiérarchique"}],
x:"Bonne réponse : Une distance minimale du domicile, selon la CCN. Les indemnités de grand déplacement (repas, couchées) sont versées aux conducteurs lorsque les conditions de déplacement les empêchent de regagner leur domicile ou l'établissement, selon des critères de distance et de durée fixés par la Convention Collective Nationale des Transports Routiers."},

{id:2108,prog:'LOURD',theme:'lo-regl',d:2,
e:"La visite technique annuelle d'un PL est réalisée dans :",
r:[{t:"N'importe quel garage agréé"},{t:"Un centre de contrôle technique agréé PL",ok:true},{t:"La concession du constructeur"},{t:"Les services de la DREAL"}],
x:"Bonne réponse : Un centre de contrôle technique agréé PL. Les contrôles techniques des PL (PTAC > 3,5t) sont réalisés dans des centres agréés spécifiquement équipés pour les véhicules lourds (bancs de freinage adaptés, fosse de visite…). Ces centres sont distincts des centres de contrôle technique VL. L'agrément est délivré par le Ministère des Transports."},

{id:2109,prog:'LOURD',theme:'lo-gestion',d:2,
e:"L'assurance marchandises transportées (AMT) est souscrite par :",
r:[{t:"Le transporteur pour son compte"},{t:"L'expéditeur ou le destinataire, pour la valeur réelle",ok:true},{t:"Elle est incluse dans la RC du transporteur"},{t:"Elle est obligatoire pour le transporteur"}],
x:"Bonne réponse : L'expéditeur ou le destinataire, pour la valeur réelle. L'AMT (ou assurance Ad Valorem) est souscrite par l'expéditeur ou le destinataire. Elle couvre la valeur réelle des marchandises contre perte, vol ou dommage. Elle est distincte et complémentaire de la responsabilité civile du transporteur (plafonnée par la loi). Sans AMT, en cas de sinistre, l'indemnisation est limitée au plafond légal/conventionnel."},
...
r:[{t:"Le TCP ne nécessite aucune réglementation"},{t:"Dans le TCP, transporteur et propriétaire sont la même entité",ok:true},{t:"Le TCP est exempté de la réglementation sociale"},{t:"Le TCP est réservé aux grandes entreprises"}],
x:"Bonne réponse : Dans le TCP, transporteur et propriétaire sont la même entité. Le transport pour compte propre (TCP) est effectué par une entreprise pour ses propres besoins, avec ses propres véhicules et conducteurs salariés. Le TCP est exempté de l'obligation de licence de transport mais doit respecter les règles sociales (tachygraphe, temps de conduite), techniques et de sécurité. Il n'est pas autorisé à transporter des marchandises de tiers."},

{id:2111,prog:'LOURD',theme:'lo-intl',d:1,
e:"Le registre européen ERRU (European Register of Road Transport Undertakings) permet :",
r:[{t:"D'immatriculer les véhicules PL dans toute l'Europe"},{t:"L'échange d'informations entre États sur les transporteurs",ok:true},{t:"De suivre les trajets des PL en temps réel"},{t:"D'harmoniser les tarifs de transport dans l'UE"}],
x:"Bonne réponse : L'échange d'informations entre États sur les transporteurs. L'ERRU est un système de registres électroniques nationaux interconnectés (créé par le règlement 1071/2009) permettant aux autorités compétentes des États membres de l'UE d'échanger des informations sur les entreprises de transport (infractions graves, pertes d'honorabilité, suspensions/retraits d'autorisations)."},
...
r:[{t:"Le taux d'occupation des sièges"},{t:"Le rapport entre la charge réelle et la capacité du véhicule",ok:true},{t:"La durée d'utilisation journalière"},{t:"Le rapport km chargés / km totaux"}],
x:"Bonne réponse : Le rapport entre la charge réelle et la capacité du véhicule. Taux de remplissage = Charge réelle / Capacité maximale × 100. Un PL de 25t chargé à 20t = 80 % de taux de remplissage. Améliorer ce taux (chargement optimisé, groupage) réduit le coût par tonne transportée et améliore la rentabilité. Un taux < 70 % signale une sous-optimisation des tournées."},
...
r:[{t:"Le transporteur et son assureur"},{t:"L'entreprise d'accueil et l'entreprise de transport",ok:true},{t:"Le conducteur et le chef de dépôt uniquement"},{t:"Le gouvernement et les syndicats"}],
x:"Bonne réponse : L'entreprise d'accueil et l'entreprise de transport. Selon l'arrêté du 26 avril 1996, lorsque des opérations de chargement ou déchargement sont effectuées dans des lieux de travail extérieurs à l'entreprise de transport, un protocole de sécurité doit être établi entre l'entreprise d'accueil et l'entreprise de transport. Il définit les mesures de prévention des risques lors des opérations."},
...
r:[{t:"Uniquement infliger une amende"},{t:"Retirer temporairement ou définitivement l'autorisation",ok:true},{t:"Uniquement envoyer un avertissement"},{t:"Suspendre uniquement la carte conducteur"}],
x:"Bonne réponse : Retirer temporairement ou définitivement l'autorisation. Les autorités compétentes (DREAL en France) peuvent, en cas d'infractions graves et répétées aux réglementations routières ou sociales, suspendre ou retirer l'autorisation d'exercer (licence de transport). C'est la sanction la plus sévère possible pour une entreprise de transport."},

{id:2117,prog:'LOURD',theme:'lo-intl',d:2,
e:"Le principe 'lex loci delicti' (lieu du délit) s'applique à la CMR pour :",
r:[{t:"Déterminer la juridiction compétente pour les litiges"},{t:"Choisir la loi applicable hors des cas couverts par la CMR",ok:true},{t:"Fixer les tarifs douaniers"},{t:"Déterminer la nationalité du conducteur"}],
x:"Bonne réponse : Choisir la loi applicable hors des cas couverts par la CMR. La CMR est la loi applicable aux transports internationaux qu'elle couvre. Pour les questions non réglementées par la CMR (elle s'applique à l'exclusion de la plupart des droits nationaux), c'est généralement le droit du pays où le transport a eu lieu ou où le dommage est survenu qui s'applique à titre subsidiaire."},
...
r:[{t:"Uniquement aux transports au sein de l'UE"},{t:"Aux transports internationaux entre États signataires",ok:true},{t:"Uniquement aux transports en dehors de l'Europe"},{t:"À tous les transports de plus de 500 km"}],
x:"Bonne réponse : Aux transports internationaux entre États signataires. La CMR s'applique à tout contrat de transport international de marchandises par route à titre onéreux lorsque le lieu de prise en charge de la marchandise et le lieu de livraison sont situés dans deux pays différents, dont l'un au moins est signataire."},

{id:2122,prog:'LOURD',theme:'cl-social',d:1,
e:"Le code 95 sur le permis de conduire d'un chauffeur PL signifie :",
r:[{t:"Il a le permis CE"},{t:"Il a la qualification CQC initiale ou en cours de validité",ok:true},{t:"Il est autorisé à conduire des citernes"},{t:"Il a passé une formation ADR"}],
x:"Bonne réponse : Il a la qualification CQC initiale ou en cours de validité. Le code 95 (suivi d'une date d'expiration) apposé sur le permis de conduire atteste que le titulaire a satisfait aux exigences de qualification initiale (FIMO) et de formation continue (FCOS) pour conduire des véhicules de transport de marchandises ou de voyageurs à titre professionnel."},

{id:2123,prog:'LOURD',theme:'lo-regl',d:1,
e:"Un conducteur PL peut-il transporter des passagers (auto-stoppeurs) dans son camion ?",
r:[{t:"Oui, illimité"},{t:"Non, sauf personnes autorisées par l'employeur",ok:true},{t:"Oui, jusqu'à 3 passagers"},{t:"Oui, si le trajet est court"}],
x:"Bonne réponse : Non, sauf personnes autorisées par l'employeur. Il est interdit de transporter des personnes non autorisées dans un PL (raisons de sécurité, couverture assurance, responsabilité). Seules les personnes expressément autorisées par l'employeur (technicien accompagnateur, stagiaire, etc.) peuvent monter à bord. Le transport de passagers non autorisés peut engager la responsabilité du conducteur et de l'employeur."},
...
r:[{t:"Plus de 10 salariés licenciant plus de 2 personnes"},{t:"Plus de 50 salariés licenciant 10 personnes sur 30 jours",ok:true},{t:"Plus de 100 salariés uniquement"},{t:"Toutes les tailles dès 5 licenciements"}],
x:"Bonne réponse : Plus de 50 salariés licenciant 10 personnes sur 30 jours. Le PSE est obligatoire pour les entreprises d'au moins 50 salariés qui envisagent de licencier au moins 10 salariés sur une période de 30 jours pour motif économique. Il doit prévoir des mesures de reclassement interne et externe, des formations et des aides à la création d'entreprise."},

{id:2127,prog:'LOURD',theme:'lo-gestion',d:2,
e:"La méthode du coût marginal en transport permet de décider si :",
r:[{t:"Un investissement est rentable"},{t:"Accepter une commande à bas prix vaut mieux que refuser",ok:true},{t:"Sous-traiter est plus rentable"},{t:"Embaucher un conducteur supplémentaire"}],
x:"Bonne réponse : Accepter une commande à bas prix vaut mieux que refuser. Le coût marginal = coût de la dernière unité produite (ici : coût de la tournée supplémentaire = uniquement les charges variables directes). Si le prix proposé pour une commande supplémentaire > coût marginal, il est préférable de l'accepter car elle contribue aux charges fixes (déjà couvertes par l'activité normale). C'est la base de la tarification différenciée et de la gestion des surplus de capacité."},
...
r:[{t:"Uniquement les recettes et dépenses"},{t:"Les emplois et ressources de financement de chaque année",ok:true},{t:"Uniquement la CAF et les emprunts"},{t:"La trésorerie du dernier exercice uniquement"}],
x:"Bonne réponse : Les emplois et ressources de financement de chaque année. Le plan de financement pluriannuel présente sur 3-5 ans : les emplois (investissements, remboursements de dettes, BFR supplémentaire) et les ressources (CAF prévisionnelle, nouveaux emprunts, cessions, apports). Il doit être équilibré chaque année pour confirmer la faisabilité financière du projet d'investissement."},
...
r:[{t:"Il peut éteindre son tachygraphe pendant les pauses"},{t:"Il n'a pas à répondre aux appels pro pendant ses repos",ok:true},{t:"Il peut désactiver son GPS pendant la nuit"},{t:"Il n'a pas accès aux réseaux sociaux en service"}],
x:"Bonne réponse : Il n'a pas à répondre aux appels pro pendant ses repos. Le droit à la déconnexion (art. L.2242-17 du Code du travail, négociation obligatoire en entreprise > 50 salariés) protège le salarié des sollicitations professionnelles hors temps de travail. Pour les conducteurs PL, cela signifie notamment qu'ils ne peuvent pas être tenus de répondre aux appels du dispatcher ou de l'employeur pendant leurs repos obligatoires."},

{id:2135,prog:'LOURD',theme:'lo-gestion',d:2,
e:"La LLD (Location Longue Durée) d'un PL se distingue du crédit-bail car :",
r:[{t:"Le locataire est propriétaire en fin de contrat"},{t:"La LLD n'a pas d'option d'achat — le véhicule est restitué",ok:true},{t:"La LLD est moins chère"},{t:"La LLD ne peut pas inclure l'entretien"}],
x:"Bonne réponse : La LLD n'a pas d'option d'achat — le véhicule est restitué. En LLD, le locataire utilise le véhicule pendant une durée déterminée (3-5 ans) avec un loyer mensuel fixe (pouvant inclure entretien, pneus, assurance). À l'échéance, le véhicule est restitué. Contrairement au crédit-bail (leasing), il n'y a pas d'option d'achat. La LLD préserve les lignes de crédit et maîtrise les budgets."},

{id:2136,prog:'LOURD',theme:'lo-regl',d:3,
e:"Le tachygraphe numérique G2 (2ème génération) a la capacité d'enregistrer :",
r:[{t:"Uniquement les temps de conduite"},{t:"Positions GNSS, frontières, activités, vitesse, conducteur",ok:true},{t:"Uniquement les données du conducteur"},{t:"Les communications radios du conducteur"}],
x:"Bonne réponse : Positions GNSS, frontières, activités, vitesse, conducteur. Le tachygraphe G2 (règl. 2016/799) enregistre : positions GPS toutes les 3h en conduite et à chaque traversée de frontière, données complètes d'activité (conduite, autres travaux, disponibilité, repos), vitesse instantanée, données du véhicule (immatriculation, VIN) et de la carte conducteur. Il peut être interrogé à distance via DSRC lors des contrôles."},

{id:2137,prog:'LOURD',theme:'lo-gestion',d:1,
e:"L'assurance marchandises transportées (AMT) couvre :",
r:[{t:"La responsabilité civile du transporteur"},{t:"La valeur des marchandises en cas de perte ou dommage",ok:true},{t:"Les dommages causés aux tiers"},{t:"Les accidents du travail du conducteur"}],
x:"Bonne réponse : La valeur des marchandises en cas de perte ou dommage. L'assurance AMT (ou assurance 'ad valorem') couvre la valeur des marchandises transportées contre les risques de perte, vol ou dommage pendant le transport. Elle est souscrite par l'expéditeur ou le destinataire. Elle complète la responsabilité légale du transporteur qui est plafonnée."},
...
r:[{t:"Un préavis de 2 mois"},{t:"Une rupture sans préavis ni indemnité (CP maintenus)",ok:true},{t:"Le remboursement du véhicule"},{t:"Une suspension automatique du permis"}],
x:"Bonne réponse : Une rupture sans préavis ni indemnité (CP maintenus). La faute grave rend impossible le maintien du salarié dans l'entreprise. Elle entraîne une rupture immédiate sans préavis et sans indemnité de licenciement. Le salarié conserve toutefois ses droits aux congés payés acquis et peut prétendre aux allocations chômage (contrairement à la faute lourde)."},
...
r:[{t:"D'une exonération de TVA automatique"},{t:"De droits de douane réduits dans un pays lié à l'UE",ok:true},{t:"D'un tarif de transport réduit"},{t:"D'une priorité aux frontières douanières"}],
x:"Bonne réponse : De droits de douane réduits dans un pays lié à l'UE. Les règles d'origine préférentielle définissent les critères qu'un produit doit respecter pour être considéré comme 'originaire' d'un pays et bénéficier des tarifs préférentiels prévus par les accords commerciaux (ex: CETA avec le Canada, EPA avec le Japon). L'exportateur doit pouvoir justifier l'origine par des preuves (EUR.1, déclaration d'origine)."},

{id:2143,prog:'LOURD',theme:'cl-social',d:2,
e:"Le conducteur en grand déplacement perçoit des indemnités de :",
r:[{t:"Uniquement la nuit"},{t:"Repas et/ou couchée selon l'éloignement, barèmes CCN",ok:true},{t:"Un montant forfaitaire unique quel que soit le déplacement"},{t:"Aucune indemnité si le camion a une cabine couchette"}],
x:"Bonne réponse : Repas et/ou couchée selon l'éloignement, barèmes CCN. Les indemnités de grand déplacement des conducteurs PL couvrent les frais de repas et d'hébergement lors des déplacements professionnels. Leurs montants sont fixés par la CCN transports routiers et doivent respecter les barèmes URSSAF pour être exonérés de cotisations. Même avec cabine couchette, des indemnités peuvent être dues selon la CCN."},

{id:2144,prog:'LOURD',theme:'lo-gestion',d:2,
e:"L'indice CNR (Comité National Routier) sert à :",
r:[{t:"Fixer les tarifs de transport réglementés"},{t:"Publier des références de coûts pour les révisions tarifaires",ok:true},{t:"Contrôler les entreprises de transport"},{t:"Former les conducteurs PL"}],
x:"Bonne réponse : Publier des références de coûts pour les révisions tarifaires. Le CNR (organisme public sous tutelle des Ministères des Transports et des Finances) publie mensuellement des indices de coûts de transport routier : carburant, pneumatiques, péages, salaires conducteurs, entretien, amortissement. Ces indices servent de base aux clauses de révision de prix dans les contrats de transport."},
...
r:[{t:"1 an"},{t:"1 an (données numériques et disques)",ok:true},{t:"5 ans"},{t:"3 mois"}],
x:"Bonne réponse : 1 an (données numériques et disques). L'employeur doit conserver les données du tachygraphe (disques analogiques ou fichiers numériques téléchargés) pendant au moins 12 mois (1 an) et les présenter lors des contrôles. Des délais plus longs peuvent s'appliquer en cas de contentieux. Les données doivent être téléchargées régulièrement (au moins tous les 90 jours pour les véhicules, 28 jours pour les cartes conducteur)."},
...
r:[{t:"Uniquement le salaire brut et net"},{t:"Salaire brut, cotisations, net, net imposable et taux PAS",ok:true},{t:"Uniquement le salaire net"},{t:"Le détail des tournées effectuées"}],
x:"Bonne réponse : Salaire brut, cotisations, net, net imposable et taux PAS. Le bulletin de paie doit obligatoirement mentionner : identité employeur et salarié, qualification, période de paie, salaire brut, ensemble des cotisations patronales et salariales détaillées par ligne, net imposable, prélèvement à la source, salaire net à payer. Sa conservation est recommandée sans limite de durée."},
...
r:[{t:"Parking sécurisé uniquement"},{t:"Un établissement stable avec locaux et véhicules sur place",ok:true},{t:"Capital social minimum de 50 000 €"},{t:"Comptable agréé exclusivement"}],
x:"Bonne réponse : Un établissement stable avec locaux et véhicules sur place. Le règlement 1071/2009 fixe trois conditions d'accès à la profession : établissement stable dans un État membre (locaux, documents, véhicules disponibles), honorabilité professionnelle (gestionnaire sans condamnations incompatibles), et capacité financière (fonds propres ou garanties). Ces trois conditions doivent être satisfaites en permanence."},
...
r:[{t:"Circuler librement dans toute l'UE sans restriction"},{t:"Des transports internationaux UE et du cabotage limité",ok:true},{t:"Circuler également hors UE"},{t:"Transporter des passagers"}],
x:"Bonne réponse : Des transports internationaux UE et du cabotage limité. La licence communautaire (délivrée pour 10 ans par l'autorité compétente du pays d'établissement) autorise les transports internationaux de marchandises entre États membres de l'UE. Une copie certifiée conforme doit être à bord. Le cabotage (transports internes dans un autre État membre) est limité à 3 opérations en 7 jours après un transport international entrant."},

{id:2152,prog:'LOURD',theme:'lo-intl',d:2,
e:"Le transitaire douanier joue le rôle de :",
r:[{t:"Conducteur international spécialisé"},{t:"Un représentant en douane agissant pour les importateurs",ok:true},{t:"Agent d'assurance pour les marchandises"},{t:"Commissionnaire de transport uniquement"}],
x:"Bonne réponse : Un représentant en douane agissant pour les importateurs. Le transitaire (ou commissionnaire en douane agréé) est un professionnel mandaté par l'importateur ou l'exportateur pour accomplir les formalités douanières. Il peut agir en son nom propre (commissionnaire) ou au nom du client (représentant direct). Il est agréé par les douanes et engage sa responsabilité professionnelle sur les déclarations qu'il fait."},
...
r:[{t:"Aucun droit supplémentaire par rapport au droit commun"},{t:"Le Congé de Reclassement ou le Contrat de Sécurisation",ok:true},{t:"Une prime de licenciement majorée"},{t:"Un an de salaire maintenu"}],
x:"Bonne réponse : Le Congé de Reclassement ou le Contrat de Sécurisation. En cas de licenciement économique, les salariés bénéficient : dans les entreprises ≥ 1 000 salariés du congé de reclassement (formation, bilan de compétences, maintien du salaire) ; dans les entreprises < 1 000 salariés du CSP (Contrat de Sécurisation Professionnelle, géré par France Travail). Ces dispositifs visent à favoriser le reclassement rapide."},
...
r:[{t:"Que l'EPI est fabriqué en France"},{t:"Sa conformité aux exigences des directives européennes",ok:true},{t:"Sa durée de vie garantie"},{t:"Son homologation par la DREAL"}],
x:"Bonne réponse : Sa conformité aux exigences des directives européennes. Le marquage CE sur les EPI (casques, gilets, gants, chaussures de sécurité…) atteste que le fabricant déclare la conformité de son produit aux exigences essentielles des directives et règlements européens applicables. C'est une exigence de mise sur le marché dans l'UE, pas un label de qualité supérieure."},

{id:2156,prog:'LOURD',theme:'cl-social',d:2,
e:"La sanction maximale d'un avertissement disciplinaire a pour effet :",
r:[{t:"La perte d'un mois de salaire"},{t:"Une mention au dossier, base d'une sanction ultérieure",ok:true},{t:"La suspension immédiate du permis"},{t:"L'impossibilité de bénéficier d'augmentations pendant 1 an"}],
x:"Bonne réponse : Une mention au dossier, base d'une sanction ultérieure. L'avertissement est une sanction disciplinaire légère (la plus légère dans l'échelle disciplinaire). Il est mentionné dans le dossier du salarié. Si le même comportement se reproduit, l'employeur peut invoquer la persistance de la faute pour prononcer une sanction plus sévère (mise à pied, mutation, licenciement). L'avertissement n'a aucune incidence financière directe."},

{id:2157,prog:'LOURD',theme:'lo-regl',d:1,
e:"Le permis CE est obligatoire pour conduire :",
r:[{t:"Tout PL de plus de 3,5t"},{t:"Un ensemble tracteur + semi ou porteur + remorque >3,5t",ok:true},{t:"Uniquement les ensembles de plus de 40 tonnes"},{t:"Les tracteurs agricoles"}],
x:"Bonne réponse : Un ensemble tracteur + semi ou porteur + remorque >3,5t. Le permis CE permet de conduire : des véhicules de catégorie C (PTAC > 3,5t) avec une remorque de PTAC > 750 kg, soit les ensembles tracteur + semi-remorque ou porteur + grande remorque. Le permis C seul ne permet de tracter qu'une remorque de moins de 750 kg."},

{id:2158,prog:'LOURD',theme:'cl-social',d:2,
e:"Le détachement d'un conducteur PL en Europe (règlement 2020/1057) implique que :",
r:[{t:"Les règles sociales du pays d'origine s'appliquent toujours"},{t:"Les règles sociales du pays d'accueil s'appliquent",ok:true},{t:"Seul l'ADR du pays d'accueil s'applique"},{t:"Le conducteur bénéficie d'un régime allégé"}],
x:"Bonne réponse : Les règles sociales du pays d'accueil s'appliquent. Le règlement 2020/1057 (paquet mobilité) impose que lors du cabotage et de certains transports bilatéraux, les règles sociales du pays d'accueil s'appliquent (salaire minimum, temps de travail). Pour les transports en transit, les règles du pays d'origine s'appliquent. L'employeur doit se déclarer dans le pays d'accueil."},
...
r:[{t:"Immatriculer des véhicules dans l'UE"},{t:"Prouver l'origine préférentielle pour réduire les douanes",ok:true},{t:"Certifier la conformité sanitaire des aliments"},{t:"Déclarer la valeur d'un colis postal"}],
x:"Bonne réponse : Prouver l'origine préférentielle pour réduire les douanes. Le certificat EUR.1 (ou la déclaration d'origine sur facture pour les petites valeurs) est un document douanier qui atteste de l'origine préférentielle d'une marchandise. Il permet au destinataire dans le pays importateur de bénéficier des tarifs préférentiels prévus dans les accords commerciaux entre l'UE et ce pays."},

{id:2162,prog:'LOURD',theme:'lo-intl',d:2,
e:"Le chargé d'expédition (freight forwarder) est :",
r:[{t:"Un conducteur international spécialisé"},{t:"Un intermédiaire organisant le transport multimodal",ok:true},{t:"Un douanier privé"},{t:"Un assureur maritime"}],
x:"Bonne réponse : Un intermédiaire organisant le transport multimodal. Le freight forwarder (ou commissionnaire de transport) organise le transport de bout en bout pour ses clients, en combinant si nécessaire plusieurs modes (route, mer, air, rail) et plusieurs prestataires. Il agit en son nom propre et engage sa responsabilité vis-à-vis du client sur l'ensemble de la chaîne logistique."},
...
r:[{t:"Uniquement la réglementation du transport de marchandises"},{t:"La loi de 1983 et la réglementation TFV spécifique",ok:true},{t:"Uniquement la réglementation ADR"},{t:"Aucune réglementation spécifique au-delà des PL normaux"}],
x:"Bonne réponse : La loi de 1983 et la réglementation TFV spécifique. Le transport de fonds, billets de banque et valeurs est réglementé par la loi du 12 juillet 1983 : autorisation préfectorale de l'entreprise, agrément des agents de transport de fonds, véhicules homologués, protocoles de sécurité stricts. Cette réglementation TFV (Transport de Fonds et Valeurs) est très contraignante et nécessite une formation spécifique des salariés."},
...
r:[{t:"Être transmis annuellement à la Préfecture"},{t:"Enregistrer les acquisitions et cessions de véhicules",ok:true},{t:"Être visé par un commissaire de police mensuel"},{t:"Être disponible uniquement pour les douanes"}],
x:"Bonne réponse : Enregistrer les acquisitions et cessions de véhicules. Les professionnels de la récupération automobile doivent tenir un registre des véhicules acquis et cédés, présenté lors des contrôles de police. Cette réglementation vise à lutter contre le recel de véhicules volés et le trafic de pièces détachées d'origine douteuse."},
...
r:[{t:"Uniquement si le site a plus de 50 salariés"},{t:"Pour toute opération hors de l'entreprise de transport",ok:true},{t:"Uniquement pour les matières dangereuses"},{t:"À la demande du client uniquement"}],
x:"Bonne réponse : Pour toute opération hors de l'entreprise de transport. L'arrêté du 26 avril 1996 (art. R.4515-1 du Code du travail) impose qu'un protocole de sécurité soit établi entre l'entreprise d'accueil (donneur d'ordre) et l'entreprise de transport pour toute opération de chargement ou déchargement réalisée dans un établissement soumis aux règles de prévention des risques professionnels."},
...
r:[{t:"N'est pas possible en droit français"},{t:"Le commissionnaire exerce les droits qu'il a indemnisés",ok:true},{t:"Oblige le commissionnaire à rembourser le sous-traitant"},{t:"Est limitée à 50 % du montant indemnisé"}],
x:"Bonne réponse : Le commissionnaire exerce les droits qu'il a indemnisés. Après avoir indemnisé son client, le commissionnaire peut se retourner contre le transporteur sous-traitant défaillant via l'action récursoire. Il exerce les droits de son client contre le sous-traitant, en subrogation. Cette action est soumise aux mêmes délais de prescription que l'action directe."},
...
r:[{t:"Totalement interdit"},{t:"Possible, mais conduite et repos partagés entre employeurs",ok:true},{t:"Libre sans restriction"},{t:"Possible uniquement à temps partiel"}],
x:"Bonne réponse : Possible, mais conduite et repos partagés entre employeurs. Un conducteur PL peut travailler pour plusieurs employeurs, mais les durées de conduite et de repos s'appliquent globalement (pas de double quota). Les employeurs doivent coordonner les plannings pour respecter les règles 561/2006. Chaque employeur doit disposer de toutes les informations nécessaires."},
...
r:[{t:"Transports de déménagement"},{t:"Transports de denrées périssables et urgences médicales",ok:true},{t:"Transports de matériaux de construction"},{t:"Transports de machines agricoles"}],
x:"Bonne réponse : Transports de denrées périssables et urgences médicales. De nombreuses dérogations aux restrictions de circulation du week-end existent : denrées périssables, transports médicaux urgents, transports de carburant, animaux vivants, livraison de journaux, transports pour des événements sportifs ou culturels, approvisionnement des marchés… Ces dérogations sont listées dans l'arrêté du 2 mars 2015."},

{id:2183,prog:'LOURD',theme:'lo-intl',d:2,
e:"L'Incoterm FCA (Free Carrier) est recommandé pour le transport routier car :",
r:[{t:"Il est le moins cher"},{t:"Le transfert des risques se fait chez le vendeur",ok:true},{t:"Il inclut le dédouanement"},{t:"Il est obligatoire pour les transports dangereux"}],
x:"Bonne réponse : Le transfert des risques se fait chez le vendeur. FCA est l'Incoterm recommandé pour les transports routiers (par opposition à EXW) car il permet à l'acheteur de désigner son propre transporteur tout en laissant au vendeur la responsabilité du dédouanement à l'export. Le risque se transfère dès la remise au transporteur désigné par l'acheteur. C'est plus pratique et juridiquement clair que EXW."},
...
r:[{t:"Vérifier uniquement les comptes du dernier exercice"},{t:"Analyser les 3-5 derniers bilans, litiges, parc et contrats",ok:true},{t:"Vérifier uniquement le capital social"},{t:"S'assurer que les licences sont valides"}],
x:"Bonne réponse : Analyser les 3-5 derniers bilans, litiges, parc et contrats. La due diligence financière est un audit approfondi réalisé avant une acquisition. Elle comprend : analyse des comptes historiques (3-5 ans), vérification des engagements hors-bilan (crédit-bail, cautions, contentieux), état réel du parc de véhicules (inspection physique et documentation), analyse de la base clients (concentration, pérennité des contrats) et vérification de la conformité réglementaire (licences, infractions en cours)."},

{id:2186,prog:'LOURD',theme:'cl-social',d:2,
e:"L'employeur doit remettre au conducteur, en fin de semaine de travail, :",
r:[{t:"Sa feuille de temps individuelle"},{t:"Les données téléchargées de sa carte conducteur"},{t:"Une attestation d'activités pour les jours non travaillés",ok:true},{t:"Son planning de la semaine suivante"}],
x:"Bonne réponse : Une attestation d'activités pour les jours non travaillés. L'attestation d'activités (ou certificat d'activités) est établie et signée par l'employeur pour les jours où le conducteur n'a pas conduit de véhicule équipé d'un tachygraphe (jours de repos, de maladie, de congés, de formation…). Elle permet aux contrôleurs de reconstituer l'historique des 28 derniers jours lors d'un contrôle routier."},

{id:2187,prog:'LOURD',theme:'lo-intl',d:1,
e:"L'accord ATP (transport sous température dirigée) s'applique :",
r:[{t:"Uniquement aux transports nationaux"},{t:"Aux transports internationaux de denrées périssables",ok:true},{t:"Uniquement aux transports > 100 km"},{t:"Uniquement aux produits congelés"}],
x:"Bonne réponse : Aux transports internationaux de denrées périssables. L'accord ATP (Accord sur les Transports internationaux de denrées Périssables) fixe les conditions techniques (efficacité isotherme, température) pour le transport de denrées périssables entre pays signataires (principalement européens). Il impose des normes pour les équipements de transport (isothermes, réfrigérants, frigorifiques) et des températures maximales selon les produits."},

{id:2188,prog:'LOURD',theme:'lo-intl',d:1,
e:"Le T2 (transit communautaire interne) est utilisé pour :",
r:[{t:"Les marchandises non communautaires"},{t:"Les marchandises communautaires passant par un pays tiers",ok:true},{t:"Tous les transports intra-UE"},{t:"Les transports de matières dangereuses uniquement"}],
x:"Bonne réponse : Les marchandises communautaires passant par un pays tiers. Le document T2 (transit externe de marchandises communautaires) est utilisé quand des marchandises communautaires (en libre pratique dans l'UE) doivent traverser un pays tiers (ex : Suisse, Serbie) pour rejoindre une autre partie de l'UE. Il garantit qu'aucune importation n'a eu lieu dans le pays de transit."},

{id:2189,prog:'LOURD',theme:'lo-gestion',d:2,
e:"La CAF (Capacité d'Autofinancement) permet principalement de :",
r:[{t:"Calculer la TVA à payer"},{t:"Rembourser les emprunts et investir sur fonds propres",ok:true},{t:"Calculer les cotisations sociales"},{t:"Mesurer la liquidité immédiate"}],
x:"Bonne réponse : Rembourser les emprunts et investir sur fonds propres. CAF = Résultat net + Dotations amortissements et provisions - Reprises. Elle représente le flux interne de trésorerie généré par l'activité. Une CAF suffisante permet de rembourser les annuités d'emprunt, de financer une partie des nouveaux investissements et de constituer des réserves. Elle est l'indicateur clé de la santé financière d'un transporteur PL."},
...
r:[{t:"105 heures (3 semaines)"},{t:"280 heures (8 semaines) pour les débutants",ok:true},{t:"35 heures"},{t:"140 heures"}],
x:"Bonne réponse : 280 heures (8 semaines) pour les débutants. La FIMO initiale (CQC Initial) est de 280 heures (8 semaines) pour les conducteurs n'ayant aucune expérience. Elle peut être réduite à 140 heures pour les conducteurs justifiant d'une expérience antérieure. Elle est sanctionnée par un examen."},
...
r:[{t:"Les loyers de crédit-bail"},{t:"Les produits et charges liés au financement",ok:true},{t:"Les plus-values de cession de véhicules"},{t:"Les subventions d'exploitation"}],
x:"Bonne réponse : Les produits et charges liés au financement. Le résultat financier = Produits financiers (intérêts reçus, revenus de participations, gains de change) - Charges financières (intérêts d'emprunt, agios, pertes de change, charges d'escompte). Il est généralement négatif pour les entreprises de transport endettées. Les loyers de crédit-bail sont des charges d'exploitation, pas financières."},
...
r:[{t:"Tous les dommages survenus pendant le transport"},{t:"Les pertes et avaries entre prise en charge et livraison",ok:true},{t:"Uniquement les accidents corporels"},{t:"Uniquement les dommages au véhicule"}],
x:"Bonne réponse : Les pertes et avaries entre prise en charge et livraison. Le transporteur est présumé responsable des pertes et avaries survenant entre la prise en charge et la livraison (responsabilité de plein droit, art. L.133-1 du Code de commerce). Il peut s'exonérer en prouvant une cause étrangère (force majeure, vice propre de la marchandise, faute de l'expéditeur). Cette responsabilité est limitée aux plafonds légaux."},

{id:2197,prog:'LOURD',theme:'lo-intl',d:2,
e:"Le transport routier de marchandises entre deux États membres de l'UE nécessite :",
r:[{t:"Une autorisation bilatérale spécifique"},{t:"Une licence communautaire valide et sa copie à bord",ok:true},{t:"Un carnet TIR"},{t:"Une autorisation préfectorale française"}],
x:"Bonne réponse : Une licence communautaire valide et sa copie à bord. Pour les transports de marchandises entre États membres de l'UE, seule la licence communautaire (délivrée pour 10 ans par l'autorité compétente du pays d'établissement) est nécessaire. La copie certifiée conforme doit être à bord du véhicule. Aucune autorisation bilatérale supplémentaire n'est requise au sein de l'UE (principe de libre circulation)."},
...
r:[{t:"Crit'Air 1 à 3 uniquement"},{t:"Crit'Air 1 (Euro 6) à Crit'Air 5 (Euro 2) + non classé",ok:true},{t:"Crit'Air 3 à 5 uniquement pour les PL"},{t:"Les PL ne sont pas concernés"}],
x:"Bonne réponse : Crit'Air 1 (Euro 6) à Crit'Air 5 (Euro 2) + non classé. Les PL sont classés de Crit'Air 1 (norme Euro 6, le moins polluant) à Crit'Air 5 (norme Euro 2) et non classé (avant Euro 1 ou normes antérieures). Les ZFE-m interdisent l'accès aux véhicules les plus polluants selon le calendrier local. Les PL Euro 5 = Crit'Air 2, Euro 4 = Crit'Air 3, Euro 3 = Crit'Air 4."},

{id:2202,prog:'LOURD',theme:'lo-gestion',d:3,
e:"La méthode ABC (Activity Based Costing) appliquée au transport PL permet de :",
r:[{t:"Calculer uniquement le coût du carburant"},{t:"Affecter les coûts indirects aux activités réelles",ok:true},{t:"Automatiser la facturation"},{t:"Calculer les charges sociales"}],
x:"Bonne réponse : Affecter les coûts indirects aux activités réelles. L'ABC costing répartit les charges indirectes (structure, administration, management) selon des inducteurs d'activité réels plutôt que par des clés de répartition arbitraires. Pour le transport PL, elle permet d'identifier les tournées ou clients réellement rentables vs ceux qui consomment trop de ressources administratives ou opérationnelles."},
...
r:[{t:"À tout moment, même après livraison"},{t:"Tant qu'il détient la marchandise et n'est pas payé",ok:true},{t:"Uniquement en cas de faillite du client"},{t:"Uniquement pour les transports > 10 000 €"}],
x:"Bonne réponse : Tant qu'il détient la marchandise et n'est pas payé. Le transporteur peut exercer son droit de rétention sur la marchandise tant qu'elle est en sa possession et que sa créance (fret, frais, accessoires) n'est pas réglée. Une fois la marchandise livrée, ce droit disparaît. C'est une sûreté efficace pour garantir le paiement."},

{id:2205,prog:'LOURD',theme:'cl-social',d:2,
e:"Un conducteur peut prendre son repos hebdomadaire en cabine :",
r:[{t:"Toujours, c'est autorisé"},{t:"Jamais — le repos normal se prend hors du véhicule",ok:true},{t:"Uniquement pour le repos réduit (24h)"},{t:"Uniquement à l'étranger"}],
x:"Bonne réponse : Jamais — le repos normal se prend hors du véhicule. Depuis l'arrêt de la CJUE (2020) et le règlement (UE) 2020/1054, le repos hebdomadaire normal (45h) ne peut pas être pris dans la cabine du véhicule. Il doit être pris dans un hébergement adéquat (hôtel, chambre d'hôte…) avec des installations sanitaires. Le repos hebdomadaire réduit (24h) peut être pris en cabine."},
...
r:[{t:"Planifier les tournées de livraison"},{t:"Réduire les trajets domicile-travail en voiture seule",ok:true},{t:"Optimiser les itinéraires des PL"},{t:"Gérer les congés des conducteurs"}],
x:"Bonne réponse : Réduire les trajets domicile-travail en voiture seule. Le PDE (ou PDMe pour les PME) est une démarche volontaire visant à optimiser les déplacements des salariés entre leur domicile et leur lieu de travail : covoiturage, transport en commun, vélo, télétravail. Il peut donner accès au Forfait Mobilités Durables (FMD). Pour une entreprise de transport, c'est distinct de l'optimisation des tournées de livraison."},
...
r:[{t:"Uniquement un contrat de transport"},{t:"Un agrément déchets dangereux et des documents de suivi",ok:true},{t:"Uniquement un véhicule fermé"},{t:"Aucune réglementation spécifique"}],
x:"Bonne réponse : Un agrément déchets dangereux et des documents de suivi. Le transport de déchets dangereux est soumis à la réglementation ADR (si déchets classés matières dangereuses) ET à la réglementation sur les déchets (Code de l'environnement) : agrément préfectoral pour le transporteur de déchets dangereux, Bordereau de Suivi des Déchets Dangereux (BSDD) obligatoire pour tracer les déchets de leur producteur à leur élimination."},

{id:2212,prog:'LOURD',theme:'lo-gestion',d:2,
e:"Le prix de revient d'un transport est composé de :",
r:[{t:"Uniquement du carburant et des péages"},{t:"Charges fixes, charges variables et charges de structure",ok:true},{t:"Uniquement du salaire du conducteur"},{t:"Du prix facturé moins la marge"}],
x:"Bonne réponse : Charges fixes, charges variables et charges de structure. Le prix de revient d'un transport intègre : charges directes fixes (amortissement véhicule, assurance), charges directes variables (carburant, pneus, entretien, péages) et une quote-part des charges de structure (loyer, personnel administratif, frais généraux)."},
...
r:[{t:"Seulement si le conducteur était en faute grave"},{t:"Si l'organisation rendait les dépassements inévitables",ok:true},{t:"Jamais — seul le conducteur est responsable"},{t:"Uniquement si l'infraction a causé un accident"}],
x:"Bonne réponse : Si l'organisation rendait les dépassements inévitables. L'employeur peut être poursuivi pour complicité ou participation aux infractions aux règles de conduite si : il a fixé des délais impossibles à respecter, il a ordonné ou toléré les dépassements, ou si l'organisation des tournées rendait le non-respect inévitable. La charge de la preuve incombe aux autorités de contrôle."},
...
r:[{t:"Illimité en UE"},{t:"3 opérations en 7 jours après un transport international",ok:true},{t:"1 seule opération par voyage"},{t:"5 opérations par mois"}],
x:"Bonne réponse : 3 opérations en 7 jours après un transport international. Le règlement (CE) 1072/2009 limite le cabotage à 3 opérations de transport intérieur dans le pays d'accueil, dans les 7 jours suivant le déchargement du transport international entrant. Après ce délai, le véhicule doit quitter le pays avant de pouvoir effectuer un nouveau cabotage. Cette règle vise à éviter la concurrence déloyale."},
...
r:[{t:"L'acheteur paie le transport uniquement"},{t:"L'acheteur prend tous les frais et risques dès le départ",ok:true},{t:"Le vendeur livre jusqu'à la frontière"},{t:"L'acheteur paie les droits de douane d'import uniquement"}],
x:"Bonne réponse : L'acheteur prend tous les frais et risques dès le départ. EXW est l'Incoterm le moins favorable à l'acheteur : le vendeur met les marchandises à disposition dans ses locaux. L'acheteur assume tous les frais et risques depuis ce point : chargement, transport, dédouanement à l'export (difficile pour un acheteur étranger) et à l'import, livraison finale. FCA est souvent préféré à EXW pour les transports routiers."},

{id:2223,prog:'LOURD',theme:'lo-intl',d:3,
e:"Le principe de réciprocité dans le transport routier international signifie :",
r:[{t:"Les transporteurs de deux pays se partagent les revenus"},{t:"Chaque pays accorde aux transporteurs de l'autre les mêmes droits",ok:true},{t:"Les deux pays appliquent les mêmes tarifs"},{t:"Le transit est gratuit entre pays réciprocitaires"}],
x:"Bonne réponse : Chaque pays accorde aux transporteurs de l'autre les mêmes droits. Le principe de réciprocité (accordé bilatéralement) permet à des transporteurs de deux pays de circuler sur le territoire de l'autre avec les mêmes droits que les nationaux. En l'absence d'accord ou de réciprocité, des autorisations spéciales (contingents de passages) sont nécessaires. Au sein de l'UE, la libre circulation est garantie par la licence communautaire."},

{id:2224,prog:'LOURD',theme:'lo-gestion',d:3,
e:"Le ratio de couverture des frais fixes mesure :",
r:[{t:"Le nombre d'heures de conduite par jour"},{t:"La marge sur coûts variables qui couvre les charges fixes",ok:true},{t:"Le niveau de trésorerie disponible"},{t:"Le taux d'endettement de l'entreprise"}],
x:"Bonne réponse : La marge sur coûts variables qui couvre les charges fixes. Ratio de couverture des frais fixes = MCV / Charges fixes × 100. Un ratio > 100 % signifie que la MCV couvre l'intégralité des charges fixes (l'entreprise est bénéficiaire). Un ratio < 100 % indique que les charges fixes ne sont pas entièrement couvertes."},
...
r:[{t:"Une simple contravention de 1ère classe"},{t:"Un délit jusqu'à 2 ans de prison et 30 000 € d'amende",ok:true},{t:"Uniquement une suspension de permis"},{t:"Une amende forfaitaire de 500 €"}],
x:"Bonne réponse : Un délit jusqu'à 2 ans de prison et 30 000 € d'amende. La falsification du tachygraphe est un délit grave : elle peut entraîner jusqu'à 2 ans d'emprisonnement et 30 000 € d'amende pour le conducteur. L'employeur complice encourt des peines similaires. La carte conducteur peut être suspendue ou annulée."},
...
r:[{t:"Uniquement les heures de conduite"},{t:"Conduite, repos, autres travaux et disponibilités",ok:true},{t:"Uniquement la vitesse et le kilométrage"},{t:"Uniquement les infractions"}],
x:"Bonne réponse : Conduite, repos, autres travaux et disponibilités. Le tachygraphe numérique enregistre en temps réel : les activités du conducteur (conduite, repos, travail, disponibilité), la vitesse, la distance, l'heure et les données d'identification. Le conducteur sélectionne son activité sur l'appareil."},

{id:2229,prog:'LOURD',theme:'cl-social',d:2,
e:"La protection du conducteur PL en cas d'accident du travail inclut :",
r:[{t:"Uniquement les soins médicaux"},{t:"Soins à 100 %, IJ majorées, rente AT et protection renforcée",ok:true},{t:"Uniquement la prise en charge du véhicule"},{t:"Aucune protection spécifique"}],
x:"Bonne réponse : Soins à 100 %, IJ majorées, rente AT et protection renforcée. En cas d'accident du travail (dont les accidents de la route en mission), le conducteur bénéficie : de la prise en charge à 100 % des soins, d'indemnités journalières majorées (60 % puis 80 % vs 50-66 % en maladie ordinaire), et d'une rente si incapacité permanente partielle (IPP). Le licenciement pendant l'arrêt AT est très encadré."},
...
r:[{t:"Une période de repos"},{t:"Le temps d'attente connu d'avance, non travaillé",ok:true},{t:"Les heures supplémentaires"},{t:"Le temps de formation"}],
x:"Bonne réponse : Le temps d'attente connu d'avance, non travaillé. La disponibilité (art. 3 de la directive 2002/15/CE) est le temps pendant lequel le conducteur attend sans conduire, dont il connaît la durée à l'avance (attente de chargement, frontière, ferry…). Ce n'est pas du travail effectif mais il est rémunéré (à taux réduit selon CCN) et ne peut pas servir de repos."},

{id:2235,prog:'LOURD',theme:'lo-intl',d:2,
e:"Le taux de change CMR pour les indemnisations (DTS) est :",
r:[{t:"Fixe à 1,27 €"},{t:"Variable, publié chaque jour par le FMI (~1,30 €)",ok:true},{t:"Fixé annuellement par l'OCDE"},{t:"Équivalent à 1 €"}],
x:"Bonne réponse : Variable, publié chaque jour par le FMI (~1,30 €). Le DTS (Droit de Tirage Spécial) est une unité de compte du FMI basée sur un panier de grandes devises (USD, EUR, GBP, JPY, CNY). Sa valeur fluctue quotidiennement. Pour les indemnisations CMR (8,33 DTS/kg), on utilise la valeur du DTS à la date de l'indemnisation. En 2024, 1 DTS ≈ 1,27-1,35 €."},

{id:2236,prog:'LOURD',theme:'lo-intl',d:2,
e:"Le formulaire DA1 (anciennement E101) est utilisé pour :",
r:[{t:"Déclarer des marchandises à la douane"},{t:"Prouver le maintien à la sécurité sociale du pays d'origine",ok:true},{t:"Justifier l'origine des marchandises"},{t:"Immatriculer un véhicule à l'étranger"}],
x:"Bonne réponse : Prouver le maintien à la sécurité sociale du pays d'origine. Le formulaire A1 (anciennement E101) est délivré par l'organisme de sécurité sociale du pays d'origine d'un travailleur détaché. Il atteste que le travailleur reste soumis à la législation de sécurité sociale de son pays d'origine pendant la période de détachement, et qu'il n'est donc pas assujetti au régime du pays d'accueil."},

{id:2237,prog:'LOURD',theme:'cl-social',d:2,
e:"L'embauche d'un conducteur PL nécessite de vérifier :",
r:[{t:"Uniquement son permis de conduire"},{t:"Permis CE, carte conducteur, aptitude médicale, titre de séjour",ok:true},{t:"Uniquement son casier judiciaire"},{t:"Uniquement son code 95"}],
x:"Bonne réponse : Permis CE, carte conducteur, aptitude médicale, titre de séjour. À l'embauche d'un conducteur PL, l'employeur doit vérifier : permis de conduire de catégorie CE valide, carte conducteur ADR valide (si transport ADR prévu), certificat médical d'aptitude valide délivré par un médecin agréé préfectoral, et code 95 valide (CQC). Pour les ressortissants hors UE, vérifier le titre de séjour avec autorisation de travail."},
...
r:[{t:"Uniquement aux périodes précédentes de la même entreprise"},{t:"Aux périodes précédentes et aux références sectorielles",ok:true},{t:"Uniquement aux concurrents directs"},{t:"Exclusivement aux normes bancaires"}],
x:"Bonne réponse : Aux périodes précédentes et aux références sectorielles. Une analyse de ratios pertinente compare : 1) l'évolution dans le temps (ratios N vs N-1, N-2) pour détecter les tendances, et 2) les références sectorielles (données CNR, FNTR, TLF, observatoires des PME transport) pour évaluer le positionnement par rapport aux concurrents. Une seule comparaison sans l'autre est insuffisante."},

{id:2241,prog:'LOURD',theme:'cl-social',d:2,
e:"Le conducteur PL qui constate une défaillance de son tachygraphe doit :",
r:[{t:"Continuer à conduire normalement sans signalement"},{t:"Réparer le tachygraphe dès que possible, noter à la main",ok:true},{t:"Immobiliser le véhicule jusqu'à réparation"},{t:"Appeler la police"}],
x:"Bonne réponse : Réparer le tachygraphe dès que possible, noter à la main. En cas de défaillance du tachygraphe, le conducteur doit : noter manuellement ses activités (sur feuille ou papier en l'absence de disques/carte) depuis le moment de la panne, faire réparer l'appareil dès que possible. Si le retour au dépôt est impossible dans les 7 jours, la réparation doit être effectuée pendant le trajet."},

{id:2242,prog:'LOURD',theme:'cl-social',d:2,
e:"Le conducteur PL détaché à l'étranger dans l'UE doit respecter :",
r:[{t:"Uniquement les règles sociales de son pays d'origine"},{t:"Le droit du travail du pays d'accueil pour certaines règles",ok:true},{t:"Uniquement les règles ADR du pays traversé"},{t:"Aucune règle spécifique — libre circulation totale"}],
x:"Bonne réponse : Le droit du travail du pays d'accueil pour certaines règles. Le règlement 2020/1057 sur le détachement des conducteurs prévoit que les conducteurs effectuant des transports internationaux doivent respecter les règles sociales du pays d'accueil pour les opérations de cabotage et de transport bilatéral chargé/déchargé. Les transports en transit sont exemptés."},
...
r:[{t:"Le code civil uniquement"},{t:"La loi de 1975 sur la sous-traitance et les règles transport",ok:true},{t:"Aucune réglementation spécifique"},{t:"Uniquement les conventions collectives"}],
x:"Bonne réponse : La loi de 1975 sur la sous-traitance et les règles transport. La sous-traitance dans le transport est encadrée à la fois par la loi générale du 31 décembre 1975 sur la sous-traitance (action directe du sous-traitant accepté, obligation de déclaration) et par les règles spécifiques du transport routier (le sous-traitant doit être titulaire de sa propre licence de transport et ne peut pas subir des prix manifestement abusifs)."},
...
r:[{t:"Les CPAM"},{t:"Les services de santé au travail",ok:true},{t:"La DREAL"},{t:"L'Assurance Maladie uniquement"}],
x:"Bonne réponse : Les services de santé au travail. Les conducteurs PL sont suivis par les services de santé au travail interentreprises (SSTIMT) ou les services internes de santé au travail pour les grandes entreprises. Le médecin du travail réalise les visites d'information et de prévention, les examens d'aptitude périodiques, et conseille l'employeur sur la prévention des risques professionnels."},

{id:2249,prog:'LOURD',theme:'lo-civil',d:3,
e:"La clause de hardship (imprévision) dans un contrat de transport longue durée :",
r:[{t:"Permet au transporteur de résilier sans préavis"},{t:"Oblige à renégocier si les circonstances changent radicalement",ok:true},{t:"Exonère automatiquement en cas de force majeure"},{t:"N'est valable qu'en droit international"}],
x:"Bonne réponse : Oblige à renégocier si les circonstances changent radicalement. Depuis la réforme du droit des contrats de 2016 (art. 1195 du Code civil), l'imprévision est reconnue en droit français : si un changement de circonstances imprévisible rend l'exécution du contrat excessivement onéreuse, la partie qui n'avait pas accepté ce risque peut demander une renégociation. À défaut d'accord, le juge peut adapter ou résoudre le contrat."},

{id:2250,prog:'LOURD',theme:'cl-social',d:2,
e:"La visite médicale de reprise après un arrêt de maladie de plus de 30 jours est :",
r:[{t:"Facultative"},{t:"Obligatoire avant ou dans les 8 jours suivant le retour",ok:true},{t:"Obligatoire uniquement pour les arrêts > 60 jours"},{t:"À la charge du salarié uniquement"}],
x:"Bonne réponse : Obligatoire avant ou dans les 8 jours suivant le retour. La visite médicale de reprise est obligatoire auprès du médecin du travail après tout arrêt de travail de plus de 30 jours (pour maladie ou accident non professionnel) ou de plus de 60 jours (pour accident du travail). Elle doit avoir lieu dans les 8 jours suivant la reprise. Elle vise à vérifier l'aptitude et à proposer des aménagements de poste si nécessaire."},

{id:2251,prog:'LOURD',theme:'cl-social',d:3,
e:"La convention de forfait heures (annuel ou mensuel) pour les cadres conducteurs :",
r:[{t:"S'applique automatiquement"},{t:"Prévue par accord collectif et stipulée au contrat de travail",ok:true},{t:"Est interdite dans les transports"},{t:"S'applique à tous les conducteurs autonomes"}],
x:"Bonne réponse : Prévue par accord collectif et stipulée au contrat de travail. Une convention de forfait (en heures ou en jours) doit être prévue par un accord collectif (convention ou accord de branche, accord d'entreprise) ET stipulée dans le contrat de travail ou par avenant signé. Pour les forfaits annuels en jours (cadres autonomes), des garanties obligatoires s'appliquent (entretiens annuels, suivi de charge de travail)."},

{id:2252,prog:'LOURD',theme:'lo-civil',d:2,
e:"Le plan de sauvegarde dans une procédure de redressement judiciaire prévoit :",
r:[{t:"La liquidation immédiate de l'entreprise"},{t:"Un étalement des dettes et la poursuite de l'activité",ok:true},{t:"La cession obligatoire de tous les actifs"},{t:"L'exonération totale des dettes fiscales"}],
x:"Bonne réponse : Un étalement des dettes et la poursuite de l'activité. Le plan de sauvegarde ou de redressement fixe les modalités de règlement des créanciers (étalement sur 10 ans maximum, remises possible avec accord des créanciers) et les mesures de restructuration permettant à l'entreprise de poursuivre son activité. Il doit être adopté par le tribunal de commerce."},

{id:2253,prog:'LOURD',theme:'lo-civil',d:2,
e:"La mise en demeure d'un client de payer une facture impayée est :",
r:[{t:"Obligatoire avant toute procédure judiciaire"},{t:"Souvent un préalable, fait courir les intérêts",ok:true},{t:"Inutile si le retard dépasse 60 jours"},{t:"Obligatoire uniquement pour les montants > 1 000 €"}],
x:"Bonne réponse : Souvent un préalable, fait courir les intérêts. La mise en demeure (LRAR ou acte d'huissier) est un préalable souvent obligatoire ou fortement conseillé avant toute action judiciaire. Elle : fait courir les intérêts moratoires dès la date de la mise en demeure, interrompt le délai de prescription, et constitue la preuve que le débiteur a été informé et n'a pas réglé."},

{id:2254,prog:'LOURD',theme:'lo-intl',d:2,
e:"Le formulaire A1 (anciennement E101) sert à prouver qu'un conducteur détaché :",
r:[{t:"A payé ses droits de douane"},{t:"Reste à la sécurité sociale de son pays d'origine",ok:true},{t:"A le droit de travailler dans un pays étranger"},{t:"A obtenu son permis de conduire international"}],
x:"Bonne réponse : Reste à la sécurité sociale de son pays d'origine. Le formulaire A1 est délivré par l'organisme de sécurité sociale du pays d'origine. Il atteste que le travailleur détaché reste affilié au régime de sécurité sociale de son pays d'origine pendant la durée du détachement. Il évite la double cotisation sociale. En cas de contrôle, il doit être présenté aux autorités du pays d'accueil."},

{id:2255,prog:'LOURD',theme:'lo-intl',d:2,
e:"L'Incoterm DDP (Delivered Duty Paid) est le plus favorable à l'acheteur car :",
r:[{t:"Le prix est le plus bas"},{t:"Le vendeur supporte tous les coûts jusqu'à destination",ok:true},{t:"L'acheteur choisit le transporteur"},{t:"Il n'inclut pas la TVA"}],
x:"Bonne réponse : Le vendeur supporte tous les coûts jusqu'à destination. DDP est l'Incoterm le plus favorable à l'acheteur : le vendeur assume tous les coûts et risques du transport jusqu'au lieu de destination convenu, y compris le dédouanement à l'export ET à l'import et les droits de douane d'importation. C'est l'opposé de EXW (le moins favorable à l'acheteur)."},

{id:2256,prog:'LOURD',theme:'cl-acces',d:2,
e:"Le CPC (Certificat de Compétence Professionnelle) de transporteur PL est obtenu par :",
r:[{t:"Formation uniquement"},{t:"Examen devant une commission CCI, ou par VAE",ok:true},{t:"Dépôt d'un dossier administratif simple"},{t:"Formation en alternance uniquement"}],
x:"Bonne réponse : Examen devant une commission CCI, ou par VAE. Le CPC Marchandises Lourd peut être obtenu : par examen devant une commission dans les CCI (épreuves écrites sur 4 matières), ou par la Validation des Acquis de l'Expérience (VAE) pour les professionnels justifiant d'une expérience significative dans la gestion d'une entreprise de transport. La VAE permet de dispenser certaines épreuves."},

{id:2257,prog:'LOURD',theme:'lo-regl',d:3,
e:"L'accident grave impliquant un PL avec matières dangereuses doit être signalé :",
r:[{t:"Uniquement à l'assurance"},{t:"Aux forces de l'ordre, secours et CSTMD de l'entreprise",ok:true},{t:"Uniquement à la DREAL dans les 24h"},{t:"Uniquement si des blessés sont à déplorer"}],
x:"Bonne réponse : Aux forces de l'ordre, secours et CSTMD de l'entreprise. En cas d'accident grave avec MD : appeler immédiatement les secours (15/18/112) et les forces de l'ordre, transmettre les consignes écrites ADR aux secours, informer le CSTMD de l'entreprise, et selon la gravité, notifier l'autorité compétente ADR. Le CSTMD rédigera un rapport d'accident. Des obligations de déclaration aux autorités environnementales peuvent s'ajouter selon les produits impliqués."},
...
r:[{t:"Aucun dispositif de financement"},{t:"L'OPCO Mobilités du secteur transport",ok:true},{t:"La CPAM"},{t:"La DREAL"}],
...
r:[{t:"Les marchandises communautaires circulant dans l'UE"},{t:"Les marchandises non communautaires en transit dans l'UE",ok:true},{t:"Les marchandises exportées définitivement"},{t:"Les véhicules en transit temporaire"}],
x:"Bonne réponse : Les marchandises non communautaires en transit dans l'UE. Le document T1 est un document de transit douanier externe utilisé pour des marchandises de statut non communautaire qui transitent par l'UE. Il suspend les droits et taxes pendant le transit. Le T2 est utilisé pour des marchandises communautaires qui passent par un pays tiers."},
...
r:[{t:"Longue et coûteuse nécessitant un avocat"},{t:"Une procédure rapide pour recouvrer une créance certaine",ok:true},{t:"Réservée aux dettes > 10 000 €"},{t:"Uniquement pour les litiges commerciaux entre grandes entreprises"}],
x:"Bonne réponse : Une procédure rapide pour recouvrer une créance certaine. L'injonction de payer (art. 1405 du Code de procédure civile) est une procédure judiciaire simplifiée et rapide. Le créancier saisit le tribunal par requête. Si accordée, le débiteur est notifié. S'il ne s'y oppose pas dans le mois, l'ordonnance devient exécutoire et la saisie peut être mise en œuvre."},
...
r:[{t:"Est remplacé par le DAE"},{t:"Atteste l'origine préférentielle pour réduire les douanes",ok:true},{t:"Remplace la déclaration d'exportation"},{t:"N'est utilisé qu'entre pays de l'UE"}],
x:"Bonne réponse : Atteste l'origine préférentielle pour réduire les douanes. Le certificat EUR.1 (ou la déclaration sur facture pour les faibles valeurs) est établi par l'exportateur et visé par les douanes à l'export. Il atteste que la marchandise est d'origine préférentielle (UE ou pays bénéficiaire de l'accord) et permet au destinataire dans le pays tiers de bénéficier de droits de douane réduits ou nuls."},
...
r:[{t:"Le résultat net comptable uniquement"},{t:"Une formule légale intégrant bénéfice, capitaux et salaires",ok:true},{t:"Le bénéfice distribuable uniquement"},{t:"Un accord de branche obligatoire"}],
x:"Bonne réponse : Une formule légale intégrant bénéfice, capitaux et salaires. La réserve de participation légale = 1/2 × (Bénéfice fiscal × 5 % des capitaux propres) × Masse salariale / Valeur ajoutée. Cette formule complexe est définie par le Code du travail. Elle vise à intéresser les salariés aux résultats de l'entreprise. La somme est bloquée 5 ans (sauf cas de déblocage anticipé)."},
...
r:[{t:"= 52 tonnes (sum des PTAC)"},{t:"= 40 tonnes, limite légale pour un ensemble 5 essieux",ok:true},{t:"= 18 tonnes (le plus faible des deux PTAC)"},{t:"= Variable selon le nombre d'essieux"}],
x:"Bonne réponse : = 40 tonnes, limite légale pour un ensemble 5 essieux. Le PTRA n'est pas la somme des PTAC individuels mais la limite légale applicable à l'ensemble. Pour un ensemble tracteur + semi à 5 essieux, le PTRA légal en France est de 40 tonnes. Un tracteur 18t + semi 34t = PTAC cumulés 52t, mais le PTRA légal maximum est de 40t. Il faut choisir un chargement compatible avec le PTRA légal."},

{id:2271,prog:'LOURD',theme:'lo-intl',d:2,
e:"Le formulaire T2L permet de prouver :",
r:[{t:"L'origine commerciale d'une marchandise"},{t:"Le statut communautaire d'une marchandise déjà dans l'UE",ok:true},{t:"La déclaration d'exportation d'une marchandise"},{t:"L'immatriculation d'un véhicule dans l'UE"}],
x:"Bonne réponse : Le statut communautaire d'une marchandise déjà dans l'UE. Le formulaire T2L est un document douanier qui atteste du statut communautaire (Union) d'une marchandise, c'est-à-dire qu'elle a déjà été mise en libre pratique dans l'UE (droits de douane acquittés). Il permet de circuler dans l'UE sans nouveau dédouanement."},

{id:2272,prog:'LOURD',theme:'cl-social',d:3,
e:"Le principe 'à travail égal, salaire égal' impose :",
r:[{t:"Un salaire identique pour tous les salariés d'une même entreprise"},{t:"Une rémunération égale pour un travail de valeur égale",ok:true},{t:"L'application stricte du SMIC pour tous"},{t:"L'interdiction de toute différence salariale"}],
x:"Bonne réponse : Une rémunération égale pour un travail de valeur égale. Le principe d'égalité de rémunération (art. L.3221-2 du Code du travail) interdit les différences de salaire entre salariés qui effectuent un même travail ou un travail de valeur égale, si ces différences ne sont pas justifiées par des critères objectifs (ancienneté, diplôme, résultats, responsabilités). Il s'applique notamment à l'égalité hommes/femmes."},

{id:2273,prog:'LOURD',theme:'lo-gestion',d:1,
e:"Le ROA (Return On Assets) = Résultat net / Total actif mesure :",
r:[{t:"La rentabilité des capitaux propres"},{t:"L'efficacité de l'entreprise à générer du bénéfice",ok:true},{t:"Le niveau d'endettement"},{t:"La solvabilité à court terme"}],
x:"Bonne réponse : L'efficacité de l'entreprise à générer du bénéfice. ROA = Résultat net / Total actif × 100. Un ROA de 8 % signifie que l'entreprise génère 8 € de bénéfice pour 100 € d'actifs investis. C'est un indicateur d'efficience opérationnelle. Plus le ROA dépasse le coût de la dette, plus l'effet de levier financier est favorable."},

{id:2274,prog:'LOURD',theme:'lo-acces',d:2,
e:"La capacité financière minimale pour un transporteur de marchandises >3,5t est de :",
r:[{t:"3 000 € par véhicule"},{t:"9 000 € pour le 1er véhicule, 5 000 € par suivant",ok:true},{t:"50 000 € forfaitaires"},{t:"1 % du CA annuel prévisionnel"}],
x:"Bonne réponse : 9 000 € pour le 1er véhicule, 5 000 € par suivant. Règlement (CE) 1071/2009 : capacité financière = 9 000 € pour le premier véhicule + 5 000 € par véhicule supplémentaire. Ces fonds propres doivent être démontrés par des comptes annuels certifiés ou une garantie bancaire."},
...
r:[{t:"Le registre du commerce uniquement"},{t:"L'ERRU, registre européen reliant les États membres",ok:true},{t:"Interpol"},{t:"La base de données OTAN"}],
x:"Bonne réponse : L'ERRU, registre européen reliant les États membres. Le RENT est la partie française de l'ERRU (European Register of Road Transport Undertakings). Les 27 registres nationaux sont interconnectés, permettant aux autorités de chaque État membre de consulter les informations sur les transporteurs des autres pays (infractions graves, pertes d'honorabilité, suspensions). Cela empêche un transporteur sanctionné dans un pays de s'établir dans un autre."},
...
r:[{t:"0h à 24h le dimanche"},{t:"Du samedi 22h au dimanche 22h, avec variations saisonnières",ok:true},{t:"8h à 20h le dimanche"},{t:"Il n'y a plus de restriction dominicale"}],
x:"Bonne réponse : Du samedi 22h au dimanche 22h, avec variations saisonnières. Les restrictions de circulation pour les PL de PTAC > 7,5t s'appliquent le dimanche de 22h la veille à 22h le soir du dimanche (circulaire annuelle). Des restrictions supplémentaires s'appliquent les samedis de juillet-août et les jours fériés. De nombreuses dérogations existent (denrées périssables, carburant, journaux…)."},

{id:2284,prog:'LOURD',theme:'lo-intl',d:1,
e:"L'Incoterm EXW (Ex Works) signifie que :",
r:[{t:"Le vendeur livre à la frontière"},{t:"Le vendeur met à disposition, l'acheteur fait le reste",ok:true},{t:"Le vendeur paie le transport jusqu'à destination"},{t:"Les risques se transfèrent au port d'embarquement"}],
x:"Bonne réponse : Le vendeur met à disposition, l'acheteur fait le reste. EXW (Ex Works) est l'Incoterm le moins favorable à l'acheteur : le vendeur met la marchandise à disposition dans son établissement (usine, entrepôt). L'acheteur prend en charge tous les frais et risques depuis ce point (chargement, transport, dédouanement à l'export et à l'import, livraison finale)."},
...
r:[{t:"La température au chargement est notée"},{t:"Le compartiment est maintenu à ≤ –18°C et enregistré",ok:true},{t:"Le véhicule est nettoyé avant le chargement uniquement"},{t:"La durée du transport ne dépasse pas 4 heures"}],
x:"Bonne réponse : Le compartiment est maintenu à ≤ –18°C et enregistré. Pour les produits surgelés, la chaîne du froid impose une température ≤ –18°C tout au long du transport (sauf courtes remontées lors du chargement/déchargement). Le thermographe ou enregistreur de température est obligatoire pour les transports soumis à l'accord ATP. Les relevés doivent être archivés."},

{id:2290,prog:'LOURD',theme:'lo-intl',d:2,
e:"Le service T2F est utilisé pour :",
r:[{t:"Les marchandises vers les territoires fiscaux spéciaux",ok:true},{t:"Toutes les marchandises exportées hors UE"},{t:"Les marchandises sous température dirigée"},{t:"Les envois postaux internationaux"}],
x:"Bonne réponse : Les marchandises vers les territoires fiscaux spéciaux. Le formulaire T2F est un document douanier attestant du statut communautaire de marchandises destinées à des territoires fiscaux appartenant à l'UE douanière mais pas à l'UE fiscale (ex : îles Canaries, Ceuta et Melilla, Monaco, îles anglo-normandes…). Il permet d'éviter une perception de TVA à l'entrée de ces territoires."},

{id:2291,prog:'LOURD',theme:'lo-gestion',d:2,
e:"En transport PL, le terme 'full truck load' (FTL) désigne :",
r:[{t:"Un camion à pleine capacité de poids"},{t:"Un transport où le camion est affrété pour un seul client",ok:true},{t:"Un transport express en camion complet"},{t:"Un camion équipé d'un hayon élévateur"}],
x:"Bonne réponse : Un transport où le camion est affrété pour un seul client. FTL (Full Truck Load) désigne un mode de transport où la totalité du véhicule est réservée pour un seul expéditeur/destinataire. À l'opposé, le LTL (Less than Truck Load) ou messagerie regroupe plusieurs expéditeurs dans le même véhicule. Le FTL est généralement moins coûteux par kg pour les grosses quantités."},

{id:2292,prog:'LOURD',theme:'cl-social',d:3,
e:"Le statut de 'salarié portage' pour un conducteur PL freelance est :",
r:[{t:"Impossible dans le transport"},{t:"Possible mais peu adapté à des missions permanentes",ok:true},{t:"Obligatoire pour les conducteurs occasionnels"},{t:"Identique au statut d'auto-entrepreneur"}],
x:"Bonne réponse : Possible mais peu adapté à des missions permanentes. Le portage salarial (loi du 5 mars 2014) permet à un professionnel indépendant d'être rémunéré comme salarié via une entreprise de portage. Dans le transport, il peut être utilisé pour des missions ponctuelles (événementiel, remplacement). Mais l'activité principale de conducteur PL permanent n'est pas adaptée au portage, qui est conçu pour des missions à durée limitée."},
...
r:[{t:"N'est soumis à aucune réglementation particulière"},{t:"Respecter l'ADR, sinon la réglementation la plus stricte",ok:true},{t:"Est interdit pour les liquides inflammables"},{t:"Nécessite uniquement un certificat national"}],
x:"Bonne réponse : Respecter l'ADR, sinon la réglementation la plus stricte. L'ADR s'applique aux transports internationaux entre pays signataires. Si le pays de destination n'est pas signataire de l'ADR, la réglementation nationale de ce pays s'applique. Le transporteur doit se conformer aux exigences les plus strictes. Les pays signataires couvrent l'essentiel de l'Europe, l'Asie centrale et certains pays du Moyen-Orient."},
...
r:[{t:"Uniquement d'une boîte aux lettres"},{t:"Locaux, matériel de gestion et parc adapté dans l'État",ok:true},{t:"D'au moins 3 véhicules"},{t:"D'un capital social minimum de 9 000 €"}],
x:"Bonne réponse : Locaux, matériel de gestion et parc adapté dans l'État. Le règlement 1071/2009 impose que l'établissement soit réel et stable : des locaux où sont conservés les documents principaux (contrats de transport, documents comptables, fichier du personnel), un matériel de gestion adapté, et un parc de véhicules immatriculé dans l'État membre (ou utilisé sur la base d'un contrat de crédit-bail)."},

{id:2296,prog:'LOURD',theme:'lo-gestion',d:3,
e:"Le fonds de roulement normatif d'une entreprise PL est calculé en :",
r:[{t:"Ajoutant les actifs immobilisés aux stocks"},{t:"Exprimer les composantes du BFR en jours de CA",ok:true},{t:"Divisant le CA par 12"},{t:"Multipliant les charges fixes par le taux d'imposition"}],
x:"Bonne réponse : Exprimer les composantes du BFR en jours de CA. Le FRNG normatif exprime le BFR prévisionnel 'normal' de l'entreprise en jours de CA (délai clients × CA, délai fournisseurs × achats, stocks × coût des ventes). Il permet de calculer le FRNG nécessaire pour financer ce BFR normal. C'est un outil de prévision et de pilotage financier."},
...
r:[{t:"La norme NF EN 1756-1"},{t:"L'arrêté de 2004 sur la vérification des appareils de levage",ok:true},{t:"La réglementation du fabricant uniquement"},{t:"Uniquement lors de la visite technique PL"}],
x:"Bonne réponse : L'arrêté de 2004 sur la vérification des appareils de levage. L'arrêté du 1er mars 2004 (modifiant celui de 1993) impose une vérification annuelle des hayons élévateurs par un organisme compétent. Un registre de vérification doit être tenu à disposition lors des contrôles. Le non-respect expose à des sanctions et engage la responsabilité de l'employeur en cas d'accident."},

{id:2299,prog:'LOURD',theme:'lo-intl',d:2,
e:"L'Incoterm DAP (Delivered At Place) signifie que :",
r:[{t:"Le vendeur livre au port de départ"},{t:"Le vendeur livre prêt à décharger, sans droits d'import",ok:true},{t:"L'acheteur assume tous les risques"},{t:"Les droits de douane sont toujours inclus"}],
x:"Bonne réponse : Le vendeur livre prêt à décharger, sans droits d'import. DAP : le vendeur assume tous les risques et frais jusqu'au lieu de destination convenu, mais l'acheteur prend en charge le déchargement et le dédouanement à l'importation. C'est l'un des Incoterms les plus utilisés pour les transports routiers européens. DAP ne comprend pas les droits de douane d'importation (contrairement à DDP)."},

{id:2300,prog:'LOURD',theme:'lo-gestion',d:2,
e:"La cession d'un PL avec une plus-value génère :",
r:[{t:"Un avantage fiscal immédiat automatique"},{t:"Un produit exceptionnel imposable, étalable sous conditions",ok:true},{t:"Une charge déductible"},{t:"Aucun impact fiscal"}],
x:"Bonne réponse : Un produit exceptionnel imposable, étalable sous conditions. La plus-value réalisée sur la cession d'un PL (prix vente > VNC) est un produit exceptionnel imposable (IS ou IR). Des régimes de faveur existent : exonération pour les PME sous condition de CA et de durée de détention (art. 151 septies du CGI pour l'IR). Le remploi des plus-values dans un nouvel investissement peut permettre un étalement fiscal."},
...
r:[{t:"Aucune contrepartie spécifique"},{t:"Une majoration de salaire ou un repos compensateur",ok:true},{t:"Automatiquement des heures supplémentaires"},{t:"Un taux de 200 % du salaire normal"}],
x:"Bonne réponse : Une majoration de salaire ou un repos compensateur. Le travail de nuit (entre 21h et 6h pour les conducteurs routiers) ouvre droit à des contreparties définies par la convention collective des transports routiers : soit une majoration de salaire (généralement entre 10 et 25 %), soit un repos compensateur équivalent."},
...
r:[{t:"N'existe pas en droit français"},{t:"Lui permet d'être payé en priorité sur la marchandise",ok:true},{t:"S'applique uniquement aux créances de plus de 1 000 €"},{t:"N'est valable qu'en cas de faillite du client"}],
x:"Bonne réponse : Lui permet d'être payé en priorité sur la marchandise. Le transporteur dispose d'un privilège spécial sur les marchandises transportées (art. L.133-7 du Code de commerce) pour sa créance de fret, accessoires et déboursés. Ce privilège lui permet d'être désintéressé prioritairement sur la valeur des marchandises en cas de défaillance du client. Il s'exerce tant que le transporteur est en possession des marchandises."},
...
r:[{t:"Uniquement la police nationale"},{t:"La police, la gendarmerie, les douanes et la DREAL",ok:true},{t:"Uniquement les agents de la DREAL"},{t:"Uniquement les douanes"}],
x:"Bonne réponse : La police, la gendarmerie, les douanes et la DREAL. Le contrôle du poids des PL peut être effectué par : la police nationale et la gendarmerie (contrôle routier général), les agents des douanes (contrôle des marchandises), et les agents assermentés de la DREAL (contrôle spécialisé du transport). Des scanners dynamiques de pesage permettent des contrôles sans arrêt des véhicules."},

{id:2312,prog:'LOURD',theme:'lo-gestion',d:2,
e:"Le coût moyen pondéré du parc (CMPP) est calculé en :",
r:[{t:"Additionnant la valeur de tous les véhicules"},{t:"Pondérer les coûts de chaque véhicule par son utilisation",ok:true},{t:"Divisant le chiffre d'affaires par le nombre de véhicules"},{t:"Calculant l'amortissement annuel moyen"}],
x:"Bonne réponse : Pondérer les coûts de chaque véhicule par son utilisation. Le CMPP est une moyenne pondérée des coûts de chaque véhicule de la flotte, en tenant compte de l'utilisation de chacun. Il permet d'établir un tarif de transport cohérent qui reflète les coûts réels de l'ensemble du parc, incluant les véhicules plus récents et plus anciens."},

{id:2313,prog:'LOURD',theme:'lo-civil',d:2,
e:"En cas de grève des conducteurs d'une PME de transport, l'employeur peut :",
r:[{t:"Licencier tous les grévistes immédiatement"},{t:"Recourir à des intérimaires ou à la sous-traitance",ok:true},{t:"Leur retenir l'intégralité du salaire du mois"},{t:"Fermer l'entreprise définitivement"}],
x:"Bonne réponse : Recourir à des intérimaires ou à la sous-traitance. L'employeur peut recourir à la sous-traitance ou à du travail temporaire (intérim) pour assurer les transports urgents en cas de grève, dans le respect de la légalité (pas de briseurs de grève illégaux). La retenue de salaire ne porte que sur les heures non travaillées (grève non rémunérée)."},

{id:2314,prog:'LOURD',theme:'cl-social',d:3,
e:"La grille conventionnelle des coefficients (CCNTR) classe les conducteurs PL de :",
r:[{t:"1 à 5 niveaux"},{t:"100M à 150V, avec sous-groupes selon le transport",ok:true},{t:"A à E selon la taille de l'entreprise"},{t:"Conducteur junior à conducteur senior uniquement"}],
x:"Bonne réponse : 100M à 150V, avec sous-groupes selon le transport. La CCNTR classe les conducteurs PL selon des coefficients qui déterminent les salaires minimaux conventionnels : 100M (VL/messagerie légère), 110V (fourgon), 118V (porteur), 128V (porteur > 19t), 138M (tracteur routier), 150M (grande routier, international, longue distance). Ces coefficients sont distincts selon les activités (Transport Routier de Marchandises vs déménagement vs transport sanitaire…)."},
...
r:[{t:"À chaque variation du prix du gazole"},{t:"Quand le prix du carburant dépasse le seuil de la clause",ok:true},{t:"Uniquement en cas de hausse de plus de 50 %"},{t:"Elle n'existe pas dans les contrats transport"}],
x:"Bonne réponse : Quand le prix du carburant dépasse le seuil de la clause. La clause de révision carburant se déclenche quand le prix du gazole CNR dépasse un seuil de référence défini dans le contrat. La variation est répercutée selon une formule convenue (ex : si le carburant représente 30 % du CRK et que le CNR gazole monte de 10 %, la révision est de 3 % du prix de base)."},

{id:2317,prog:'LOURD',theme:'cl-social',d:3,
e:"Le forfait jours n'est pas applicable aux conducteurs PL car :",
r:[{t:"Ils gagnent trop peu"},{t:"Ils n'ont pas d'autonomie dans l'organisation de leur temps",ok:true},{t:"Leur convention collective le refuse"},{t:"Ils travaillent toujours en équipe"}],
x:"Bonne réponse : Ils n'ont pas d'autonomie dans l'organisation de leur temps. Le forfait annuel en jours est réservé aux cadres disposant d'une réelle autonomie dans l'organisation de leur emploi du temps. Les conducteurs PL, dont les horaires sont essentiellement déterminés par les tournées et les réglementations 561/2006, ne disposent pas de cette autonomie organisationnelle requise par l'art. L.3121-53 du Code du travail."},
...
r:[{t:"Est déficitaire"},{t:"Couvre les charges fixes et génère 30 % de marge",ok:true},{t:"Est à l'équilibre exact"},{t:"Dégage exactement 30 % de résultat net"}],
x:"Bonne réponse : Couvre les charges fixes et génère 30 % de marge. Si MCV / CF = 1,3, la MCV couvre les CF à 130 %, ce qui signifie un bénéfice = MCV - CF = CF × 0,3. Exemple : CF = 100 000 € → MCV = 130 000 € → Résultat = 30 000 €. Ce ratio > 1 signifie que l'entreprise est bénéficiaire."},

{id:2320,prog:'LOURD',theme:'cl-social',d:3,
e:"L'attestation d'activités doit être remise par l'employeur au conducteur pour :",
r:[{t:"Les jours travaillés uniquement"},{t:"Les jours non travaillés sur les 28 derniers jours",ok:true},{t:"Les jours de conduite internationale uniquement"},{t:"Les jours de formation"}],
x:"Bonne réponse : Les jours non travaillés sur les 28 derniers jours. L'attestation d'activités (ou attestation de conduite) est un document que l'employeur doit fournir au conducteur pour justifier les périodes de 28 jours précédant le contrôle où le conducteur n'était pas au volant (congés, repos compensateurs, maladie, formation…). Elle complète les données du tachygraphe lors des contrôles."},
...
r:[{t:"Uniquement les majorations de salaire"},{t:"Le paiement des heures sup par un repos équivalent",ok:true},{t:"Le repos hebdomadaire"},{t:"Le préavis de licenciement"}],
x:"Bonne réponse : Le paiement des heures sup par un repos équivalent. Le repos compensateur de remplacement (RCR) permet, avec accord collectif ou individuel, de remplacer le paiement des heures supplémentaires (et leur majoration) par un repos d'une durée équivalente majorée. Exemple : une HS majorée à 25 % = 1h15 de RCR. Les modalités de prise du RCR sont fixées par l'accord."},

{id:2322,prog:'LOURD',theme:'cl-social',d:3,
e:"Le forfait social sur la participation et l'intéressement est de :",
r:[{t:"5 %"},{t:"20 % (10 % pour l'intéressement en PME)",ok:true},{t:"33 %"},{t:"Il n'y a pas de cotisation sur la participation"}],
x:"Bonne réponse : 20 % (10 % pour l'intéressement en PME). Le forfait social est une contribution patronale sur certains éléments de rémunération exclus de l'assiette des cotisations de Sécurité Sociale. Taux de 20 % sur la participation et l'abondement PEE/PERCO. Taux réduit à 10 % sur l'intéressement dans les entreprises de moins de 250 salariés. Les TPE < 11 salariés sont exonérées de forfait social sur l'intéressement et la participation."},
...
r:[{t:"Tous les 5 ans"},{t:"Tous les 5 ans jusqu'à 60 ans, puis 2 ans, puis 1 an",ok:true},{t:"Uniquement à l'embauche"},{t:"Tous les 2 ans systématiquement"}],
x:"Bonne réponse : Tous les 5 ans jusqu'à 60 ans, puis 2 ans, puis 1 an. La périodicité des visites médicales d'aptitude à la conduite professionnelle dépend de l'âge : tous les 5 ans jusqu'à 60 ans, puis tous les 2 ans entre 60 et 65 ans, puis chaque année après 65 ans. Le médecin agréé préfectoral délivre l'attestation d'aptitude médicale professionnelle."},
...
r:[{t:"9 heures"},{t:"Uniquement 8 heures (pour ne pas dépasser 90h/2 semaines)"},{t:"9 heures s'il n'a pas encore utilisé ses 2 extensions",ok:true},{t:"Aucune heure — il doit prendre un repos"}],
x:"Bonne réponse : 9 heures s'il n'a pas encore utilisé ses 2 extensions. La limite journalière est de 9 heures, sauf 2 fois par semaine où elle peut être portée à 10 heures. Si le conducteur a conduit 10h le lundi (1ère extension), il peut conduire jusqu'à 10h le mardi (2ème extension possible) ou jusqu'à 9h. Mais la limite hebdomadaire de 56h et bihebdomadaire de 90h s'appliquent."},

{id:2329,prog:'LOURD',theme:'lo-gestion',d:1,
e:"Pour calculer le prix de revient d'un transport, on doit inclure :",
r:[{t:"Uniquement les charges directes liées au trajet"},{t:"Toutes les charges directes et indirectes sur le trajet",ok:true},{t:"Uniquement le carburant et les péages"},{t:"Uniquement le salaire du conducteur"}],
x:"Bonne réponse : Toutes les charges directes et indirectes sur le trajet. Un prix de revient complet intègre : les charges directes variables (carburant, péages, pneumatiques, entretien courant) + les charges fixes directes (amortissement, assurance, salaire conducteur) + une quote-part des charges de structure (loyer, personnel administratif, frais généraux). Négliger les charges de structure conduit à une sous-tarification."},

{id:2330,prog:'LOURD',theme:'cl-social',d:3,
e:"L'accord de performance collective (APC) permet à une entreprise de :",
r:[{t:"Licencier sans motif économique"},{t:"Moduler durée, rémunération et mobilité pour l'emploi",ok:true},{t:"Supprimer les congés payés légaux"},{t:"Embaucher sans respecter les règles de droit commun"}],
x:"Bonne réponse : Moduler durée, rémunération et mobilité pour l'emploi. L'accord de performance collective (APC, ordonnances 2017) permet à une entreprise de définir par accord majoritaire les mesures d'organisation nécessaires (aménagement du temps de travail, mobilité, rémunération). Un salarié qui refuse l'application de l'accord peut être licencié pour cause réelle et sérieuse (pas pour motif économique)."},
...
r:[{t:"Ne pas verser de salaire"},{t:"Percevoir les IJ de la CPAM et maintenir le salaire",ok:true},{t:"Doubler les IJ du salarié"},{t:"Retarder le paiement du salaire de 30 jours"}],
x:"Bonne réponse : Percevoir les IJ de la CPAM et maintenir le salaire. La subrogation (possible si accord collectif ou contrat) permet à l'employeur de percevoir directement les IJ versées par la CPAM en lieu et place du salarié, tout en maintenant le salaire complet au salarié. Simplifie les démarches du salarié et améliore sa trésorerie pendant l'arrêt. L'employeur reverse ensuite les IJ à la CPAM."},
...
r:[{t:"Uniquement le certificat ADR du conducteur"},{t:"Plan de sûreté, formation, escorte et signalement des incidents",ok:true},{t:"Un marquage spécial sur le véhicule uniquement"},{t:"Aucune exigence supplémentaire par rapport aux autres matières ADR"}],
x:"Bonne réponse : Plan de sûreté, formation, escorte et signalement des incidents. Pour les marchandises à haut risque sécuritaire (chapitre 1.10 ADR), des exigences renforcées s'appliquent : plan de sûreté de l'entreprise, formation sûreté pour le conducteur et le personnel, mesures de traçabilité, signalement des incidents suspects à l'autorité compétente. L'escorte peut être requise par les autorités pour certains transports."},
...
r:[{t:"Dans les services publics uniquement"},{t:"Dans le transport public de voyageurs, pas le fret privé",ok:true},{t:"Dans toutes les entreprises de transport"},{t:"Uniquement pour les grèves de plus de 48h"}],
x:"Bonne réponse : Dans le transport public de voyageurs, pas le fret privé. Le préavis de grève (5 jours) est obligatoire dans les entreprises gérant un service public (SNCF, RATP, cars scolaires sous délégation de service public…). Dans le transport privé de marchandises, il n'y a pas d'obligation légale de préavis. Cependant, les conventions collectives peuvent en prévoir."},
...
r:[{t:"5 %"},{t:"8,55 % sur le plafond plus 2,02 % déplafonnée",ok:true},{t:"20 %"},{t:"3 %"}],
x:"Bonne réponse : 8,55 % sur le plafond plus 2,02 % déplafonnée. Les cotisations retraite de base (régime général) comprennent une part plafonnée (jusqu'au plafond SS, 48 060 €/an en 2026) et une part déplafonnée (sur la totalité du salaire). Le taux patronal total est d'environ 8,55 % + 2,02 % = 10,57 %. Ces taux varient légèrement chaque année. S'y ajoutent les cotisations AGIRC-ARRCO pour la retraite complémentaire."},
...
r:[{t:"30 jours"},{t:"30 jours (accordé si pas de réponse)",ok:true},{t:"15 jours"},{t:"3 mois"}],
x:"Bonne réponse : 30 jours (accordé si pas de réponse). L'employeur dispose de 30 jours calendaires pour répondre à une demande CPF du salarié. Si aucune réponse n'est donnée dans ce délai, l'accord est présumé (accord implicite). Ce délai peut être différent pour les formations longues ou celles nécessitant un accord de financement de l'OPCO."},
...
r:[{t:"Le calcul de l'IS"},{t:"Vérifier si la CAF suffit à renouveler le parc",ok:true},{t:"L'évaluation des stocks"},{t:"Le calcul des cotisations sociales"}],
x:"Bonne réponse : Vérifier si la CAF suffit à renouveler le parc. La VNC (valeur comptable) peut être très inférieure à la valeur de remplacement (coût d'un véhicule équivalent neuf). L'écart indique que les amortissements passés ne suffiront pas à financer le renouvellement. L'entreprise doit compléter par emprunt ou mobiliser une part de la CAF au-delà des remboursements en cours."},
...
r:[{t:"Uniquement le dernier bilan"},{t:"Les 3 derniers bilans, la CAF, le parc et les contrats",ok:true},{t:"Uniquement les statistiques sectorielles"},{t:"Uniquement les ressources humaines"}],
x:"Bonne réponse : Les 3 derniers bilans, la CAF, le parc et les contrats. Un diagnostic complet pour une reprise analyse : 3 derniers exercices (bilans, CR, annexes), CAF et son évolution, flux de trésorerie, engagements hors bilan (crédit-bail, cautions, litiges), état du parc (vieillissement, VNC vs valeur marché), contrats clients (pérennité, concentration du CA), situation sociale (effectifs, contentieux prud'homaux, sinistralité AT)."},
...
r:[{t:"Le transport est effectué avec un PL de plus de 7,5t"},{t:"Prise en charge et livraison dans deux pays signataires",ok:true},{t:"La valeur de la marchandise dépasse 10 000 €"},{t:"Le transport dure plus de 24 heures"}],
x:"Bonne réponse : Prise en charge et livraison dans deux pays signataires. La CMR (Convention relative au Contrat de transport international de Marchandises par Route) s'applique automatiquement à tout contrat de transport routier de marchandises à titre onéreux entre deux pays dont au moins l'un est signataire, quels que soient la nationalité des parties et le lieu du contrat."},
...
r:[{t:"À chaque variation du prix du carburant"},{t:"Quand le prix du carburant dépasse un seuil de référence",ok:true},{t:"Uniquement en cas de hausse de plus de 50 %"},{t:"Elle n'existe pas dans les contrats de transport"}],
x:"Bonne réponse : Quand le prix du carburant dépasse un seuil de référence. La clause de révision carburant (ou surcharge carburant) est déclenchée quand le prix du gazole dépasse un seuil de référence défini dans le contrat (ex : prix CNR de référence). La variation est alors répercutée selon une formule convenue. Elle protège le transporteur des fluctuations des prix du carburant."},

{id:2348,prog:'LOURD',theme:'lo-civil',d:2,
e:"La garantie de bonne fin dans un marché de transport longue durée :",
r:[{t:"Garantit le paiement systématique des factures"},{t:"Engage le transporteur sur toutes ses prestations contractuelles",ok:true},{t:"Remplace le contrat d'assurance"},{t:"N'existe pas dans le transport routier"}],
x:"Bonne réponse : Engage le transporteur sur toutes ses prestations contractuelles. La garantie de bonne exécution (ou bonne fin) engage le transporteur à exécuter l'intégralité de ses obligations contractuelles sur la durée du marché. Elle peut être garantie par une caution bancaire si le client l'exige. En cas de défaillance, la caution indemnise le client."},

{id:2349,prog:'LOURD',theme:'lo-gestion',d:1,
e:"La location longue durée (LLD) d'un PL par rapport à l'achat se caractérise par :",
r:[{t:"La propriété du véhicule à la fin du contrat"},{t:"Des loyers fixes tout compris, sans option d'achat",ok:true},{t:"Un coût inférieur à l'achat comptant"},{t:"L'impossibilité de changer de véhicule en cours de contrat"}],
x:"Bonne réponse : Des loyers fixes tout compris, sans option d'achat. La LLD (ou Location Longue Durée) diffère du leasing (crédit-bail) : la LLD n'inclut pas d'option d'achat finale. Le locataire utilise le véhicule pendant une durée déterminée (3-5 ans) avec un loyer mensuel qui peut inclure l'entretien, les pneus et parfois l'assurance. À l'échéance, le véhicule est restitué."},
...
r:[{t:"15 jours après un CDD de moins de 14 jours"},{t:"1/3 du contrat précédent si ≥14 jours, 1/2 si <14 jours",ok:true},{t:"1 mois systématiquement"},{t:"Il n'y a pas de délai légal"}],
x:"Bonne réponse : 1/3 du contrat précédent si ≥14 jours, 1/2 si <14 jours. Le délai de carence entre deux CDD sur le même poste est de : 1/3 de la durée totale du contrat précédent (renouvellement inclus) si celui-ci était d'au moins 14 jours, et 1/2 si le contrat précédent était inférieur à 14 jours. Ce délai peut être écarté dans certains cas (remplacement d'absent, saisonnier, etc.)."},
...
r:[{t:"La seule responsabilité civile"},{t:"La responsabilité des infractions sociales qu'il impose",ok:true},{t:"Uniquement les infractions ADR"},{t:"Uniquement les accidents corporels"}],
x:"Bonne réponse : La responsabilité des infractions sociales qu'il impose. Le règlement 561/2006 et la loi française (art. L.3315-4 du Code des transports) établissent la responsabilité des chargeurs, commissionnaires et autres acteurs qui ont ordonné ou provoqué des infractions aux règles de temps de conduite. Si un délai de livraison impossible a contraint le conducteur à dépasser ses temps, le donneur d'ordre peut être poursuivi."},

{id:2353,prog:'LOURD',theme:'lo-regl',d:2,
e:"Un conducteur PL peut conduire avec un tachygraphe défectueux pendant :",
r:[{t:"Aucun délai — interdiction immédiate de rouler"},{t:"Jusqu'au retour au dépôt ou au garage, en notant à la main",ok:true},{t:"7 jours maximum"},{t:"30 jours avec notification à la DREAL"}],
x:"Bonne réponse : Jusqu'au retour au dépôt ou au garage, en notant à la main. En cas de défaillance du tachygraphe, le conducteur peut continuer jusqu'au dépôt ou au garage le plus proche pour réparation, mais doit noter manuellement toutes ses activités sur papier. Le tachygraphe doit être réparé dès que possible. Si la panne survient loin du dépôt, l'appareil doit être réparé en route par un atelier agréé."},
...
r:[{t:"Uniquement les charges de l'aller chargé"},{t:"Les charges aller ET retour, même à vide",ok:true},{t:"Les charges de 3 trajets similaires"},{t:"Uniquement les charges variables"}],
x:"Bonne réponse : Les charges aller ET retour, même à vide. Pour un transport A/B avec retour à vide, le prix de revient doit intégrer l'intégralité des charges (aller + retour), car le conducteur, le véhicule et tous les frais continuent de courir même à vide. Le prix facturé au client doit donc couvrir le coût total aller-retour pour assurer la rentabilité."},

{id:2359,prog:'LOURD',theme:'lo-gestion',d:3,
e:"L'EBITDA (ou EBE - Excédent Brut d'Exploitation) représente :",
r:[{t:"Le bénéfice net après impôts et intérêts"},{t:"Le résultat avant amortissements et provisions",ok:true},{t:"Le chiffre d'affaires hors taxes"},{t:"Les capitaux propres de l'entreprise"}],
x:"Bonne réponse : Le résultat avant amortissements et provisions. L'EBE (ou EBITDA) = Résultat d'exploitation + Amortissements + Provisions. Il mesure la capacité de l'entreprise à générer des liquidités par son activité avant prise en compte des investissements et du financement."},
...
r:[{t:"La loi à 220 heures par an"},{t:"La convention des transports routiers, environ 195 heures",ok:true},{t:"Un accord d'entreprise uniquement"},{t:"Il n'y a pas de contingent pour les conducteurs"}],
x:"Bonne réponse : La convention des transports routiers, environ 195 heures. Le contingent annuel d'heures supplémentaires est fixé par la convention collective nationale des transports routiers à 195 heures (au lieu de 220 heures par défaut). Au-delà de ce contingent, chaque heure supplémentaire nécessite l'autorisation de l'inspection du travail et ouvre droit à un repos compensateur obligatoire."},

{id:2362,prog:'LOURD',theme:'cl-social',d:2,
e:"L'examen du permis C pour la conduite de PL est accompagné obligatoirement :",
r:[{t:"Uniquement de la FIMO"},{t:"Le CQC initial puis périodique tous les 5 ans",ok:true},{t:"D'un stage ADR"},{t:"D'un examen médical annuel"}],
x:"Bonne réponse : Le CQC initial puis périodique tous les 5 ans. Pour conduire professionnellement un PL, il faut : le permis C ou CE + le CQC (Code 95 sur le permis). Le CQC Initial (280h ou 140h selon profil) est obtenu avant la prise de fonctions. Le CQC Périodique (35h tous les 5 ans) maintient les droits. Une visite médicale d'aptitude périodique est également obligatoire."},
...
r:[{t:"Uniquement une signalisation renforcée"},{t:"Une autorisation préfectorale, des escortes et une coordination",ok:true},{t:"Uniquement l'accord de la DREAL"},{t:"Un véhicule spécialement immatriculé"}],
x:"Bonne réponse : Une autorisation préfectorale, des escortes et une coordination. Les transports exceptionnels de catégorie 3 (très grands gabarits ou très lourds) nécessitent une autorisation individuelle spécifique, une coordination avec tous les gestionnaires de voirie concernés, des escortes officielles (police nationale ou gendarmerie), et parfois des déplacements uniquement de nuit ou les week-ends pour minimiser la gêne au trafic."},

{id:2368,prog:'LOURD',theme:'lo-civil',d:2,
e:"L'assurance tous risques marchandises transportées (AMT) :",
r:[{t:"Est toujours incluse dans l'assurance RC du transporteur"},{t:"Souscrite par l'expéditeur ou le destinataire, valeur réelle",ok:true},{t:"Est obligatoire pour tous les transports PL"},{t:"Est souscrite par le transporteur pour son compte"}],
x:"Bonne réponse : Souscrite par l'expéditeur ou le destinataire, valeur réelle. L'assurance AMT (Ad Valorem ou tous risques marchandises) est souscrite par l'expéditeur ou le destinataire pour couvrir la valeur réelle des marchandises en cas de perte, vol ou dommage. Elle complète la responsabilité plafonnée du transporteur. Elle est distincte de l'assurance RC du transporteur."},

{id:2369,prog:'LOURD',theme:'cl-social',d:1,
e:"Le temps de disponibilité d'un conducteur PL est défini comme :",
r:[{t:"Le temps de pause réglementaire de 45 min"},{t:"Le temps d'attente sans conduire, connu à l'avance",ok:true},{t:"Le temps de repos journalier"},{t:"Les congés payés"}],
x:"Bonne réponse : Le temps d'attente sans conduire, connu à l'avance. Le temps de disponibilité (ou temps d'attente) est le temps où le conducteur est présent dans le véhicule ou à sa disposition sans conduire, et dont il connaît la durée à l'avance. Il ne compte pas comme temps de travail effectif mais est rémunéré (à taux réduit selon la CCN). Il ne peut pas être utilisé comme temps de repos."},
...
r:[{t:"Une simple irrégularité administrative"},{t:"Une mise en danger de la vie d'autrui, passible de poursuites",ok:true},{t:"Uniquement une sanction DREAL"},{t:"Un motif légitime en cas d'urgence"}],
x:"Bonne réponse : Une mise en danger de la vie d'autrui, passible de poursuites. Contraindre un conducteur à dépasser les temps de conduite ou à ne pas respecter les repos constitue une mise en danger délibérée d'autrui (art. 223-1 du Code pénal) passible d'1 an d'emprisonnement et 15 000 € d'amende. L'employeur peut aussi être poursuivi pour complicité des infractions du conducteur. En cas d'accident, la responsabilité pénale de l'employeur est systématiquement recherchée."},
...
r:[{t:"Cabotage"},{t:"Transport triangulaire entre États tiers",ok:true},{t:"Transit"},{t:"Covoiturage commercial"}],
x:"Bonne réponse : Transport triangulaire entre États tiers. Le transport triangulaire (ou cross-trade) est le transport effectué par un transporteur d'un pays A entre un pays B et un pays C, sans passer par son pays d'établissement. Dans l'UE, ce type de transport est en principe libre pour les transporteurs titulaires d'une licence communautaire. Des restrictions s'appliquent hors UE."},

{id:2375,prog:'LOURD',theme:'lo-civil',d:2,
e:"Les réserves sur la lettre de voiture lors du chargement doivent être émises par :",
r:[{t:"Le destinataire"},{t:"Le transporteur si le défaut était visible au chargement",ok:true},{t:"L'expéditeur"},{t:"Elles ne peuvent être émises qu'à la livraison"}],
x:"Bonne réponse : Le transporteur si le défaut était visible au chargement. Au chargement, le transporteur doit émettre des réserves sur la lettre de voiture (LVN ou CMR) si l'emballage est endommagé, si la quantité ne correspond pas au document, ou si l'état de la marchandise est suspect. Ces réserves protègent le transporteur d'une mise en cause ultérieure pour des dommages antérieurs à sa prise en charge."},
...
r:[{t:"CA / Actif total"},{t:"Dette nette / CAF, ou coefficient d'exploitation > 95 %",ok:true},{t:"Résultat net / CA"},{t:"Nombre de véhicules / Effectif"}],
x:"Bonne réponse : Dette nette / CAF, ou coefficient d'exploitation > 95 %. Les principaux signaux de danger financier pour une PME transport : coefficient d'exploitation dépassant régulièrement 95-96 %, trésorerie négative et dégradée sur plusieurs trimestres, CAF insuffisante pour couvrir les remboursements d'emprunts, délais clients qui s'allongent, et fonds propres négatifs (situation nette négative)."},

{id:2378,prog:'LOURD',theme:'cl-social',d:2,
e:"Le système de points du permis CE d'un conducteur PL professionnel :",
r:[{t:"Est le même que pour un permis B"},{t:"Commence à 12 points (6 en période probatoire)",ok:true},{t:"Dispose de 24 points spécifiques"},{t:"N'existe pas pour les professionnels"}],
x:"Bonne réponse : Commence à 12 points (6 en période probatoire). Le permis CE (comme tous les permis français) est au capital de 12 points (6 points pour les conducteurs en période probatoire). La perte de points suit les mêmes règles que pour le permis B. Pour un professionnel PL, la perte du permis CE signifie la perte de l'emploi — d'où l'importance de la conduite prudente et préventive."},
...
r:[{t:"Dans tous les pays du monde"},{t:"Entre États membres de l'UE et certains pays tiers",ok:true},{t:"Uniquement pour les PL > 20t"},{t:"Uniquement pour les transports ADR"}],
x:"Bonne réponse : Entre États membres de l'UE et certains pays tiers. La licence communautaire (règl. 1072/2009) autorise les transports de marchandises entre États membres de l'UE. Une copie certifiée conforme doit être à bord du véhicule. Pour les pays tiers non couverts par des accords spécifiques, d'autres autorisations peuvent être requises (bilatérales, contingents de passages)."},

{id:2380,prog:'LOURD',theme:'lo-civil',d:1,
e:"Le contrat de groupage consiste à :",
r:[{t:"Regrouper plusieurs transporteurs pour un seul contrat"},{t:"Grouper les marchandises de plusieurs expéditeurs",ok:true},{t:"Grouper des factures sur une seule"},{t:"Faire des livraisons groupées uniquement en zone urbaine"}],
x:"Bonne réponse : Grouper les marchandises de plusieurs expéditeurs. Le groupage (ou LTL : Less than Truck Load) consiste à réunir dans un même véhicule des marchandises appartenant à différents expéditeurs pour optimiser le taux de remplissage et réduire le coût par unité transportée. C'est le principe de la messagerie et des services de groupage spécialisés."},

{id:2381,prog:'LOURD',theme:'lo-gestion',d:3,
e:"Le tableau de bord de gestion d'une entreprise PL doit comporter en priorité :",
r:[{t:"Uniquement le chiffre d'affaires mensuel"},{t:"Indicateurs de rentabilité, d'activité et de sécurité",ok:true},{t:"Uniquement les indicateurs financiers"},{t:"Les statistiques d'accidents uniquement"}],
x:"Bonne réponse : Indicateurs de rentabilité, d'activité et de sécurité. Un tableau de bord de transport doit comporter : indicateurs financiers (CA, marge, coût revient), indicateurs d'activité (km parcourus, km à vide, taux de remplissage, nombre de livraisons), indicateurs sociaux (heures, heures sup, accidents de travail) et indicateurs de sécurité (infractions, accidents). Il doit être mis à jour au moins mensuellement."},
...
r:[{t:"Une simple contravention"},{t:"Un délit jusqu'à 2 ans de prison et 30 000 € d'amende",ok:true},{t:"Uniquement une suspension de permis"},{t:"Une amende forfaitaire de 500 €"}],
x:"Bonne réponse : Un délit jusqu'à 2 ans de prison et 30 000 € d'amende. La falsification du tachygraphe est un délit grave : jusqu'à 2 ans d'emprisonnement et 30 000 € d'amende pour le conducteur. L'employeur complice encourt des peines similaires. La carte conducteur peut être suspendue ou annulée. Les inspecteurs du travail et DREAL disposent d'outils de détection sophistiqués."},
...
r:[{t:"Rien de spécifique"},{t:"Des indemnités de repas et de couchée selon la CCN",ok:true},{t:"Des heures supplémentaires automatiques"},{t:"Un jour de repos compensateur"}],
x:"Bonne réponse : Des indemnités de repas et de couchée selon la CCN. La Convention Collective Nationale des Transports Routiers (CCNTR) prévoit des indemnités de déplacement (repas et couchées) pour les conducteurs dont les conditions de déplacement les empêchent de regagner leur domicile dans des conditions normales. Les montants sont fixés par la CCN et réévalués régulièrement."},
...
r:[{t:"Uniquement dans un hébergement"},{t:"Dans la cabine, sur couchette, pendant que le véhicule roule",ok:true},{t:"Uniquement aux aires de repos"},{t:"Uniquement s'il ne conduit pas depuis 4 heures"}],
x:"Bonne réponse : Dans la cabine, sur couchette, pendant que le véhicule roule. En équipage (deux conducteurs), le conducteur non actif peut prendre son repos journalier dans la cabine du véhicule en mouvement, à condition que celle-ci soit équipée d'une couchette adaptée. Le repos journalier en équipage est d'au moins 9 heures dans une période de 30 heures (vs 11 heures en solo)."},

{id:2388,prog:'LOURD',theme:'lo-regl',d:2,
e:"Le transport de matières vivantes (poissons en aquaculture) nécessite :",
r:[{t:"Aucune réglementation spécifique"},{t:"Agrément vétérinaire, conditions adaptées et documents sanitaires",ok:true},{t:"Uniquement un véhicule réfrigéré"},{t:"Un permis spécial préfectoral"}],
x:"Bonne réponse : Agrément vétérinaire, conditions adaptées et documents sanitaires. Le transport de poissons vivants est réglementé par le règlement CE 1/2005 sur la protection des animaux. Le transporteur doit : être agréé par les services vétérinaires, disposer de véhicules équipés (systèmes d'oxygénation, filtration, contrôle de température), avoir des conducteurs formés, et disposer des documents d'accompagnement sanitaires requis."},
...
r:[{t:"Illimité après déchargement"},{t:"3 opérations maximum dans les 7 jours après le déchargement",ok:true},{t:"5 opérations en 30 jours"},{t:"1 seule opération par voyage international"}],
x:"Bonne réponse : 3 opérations maximum dans les 7 jours après le déchargement. Le règlement (CE) 1072/2009 limite le cabotage à 3 opérations de transport intérieur en France, dans les 7 jours suivant le déchargement du transport international. Après ces 7 jours, le véhicule doit quitter la France. Ce délai de carence vise à limiter la concurrence des transporteurs de pays à plus bas coûts salariaux."},
...
r:[{t:"Uniquement les 3 derniers bilans"},{t:"Les 3 derniers bilans, comptes de résultat, CAF et flux",ok:true},{t:"Uniquement le dernier bilan"},{t:"Les statistiques sectorielles CNR uniquement"}],
x:"Bonne réponse : Les 3 derniers bilans, comptes de résultat, CAF et flux. Un diagnostic complet pour une reprise doit analyser : les 3 derniers exercices (bilans, CR, annexes), la CAF et son évolution, les flux de trésorerie, les engagements hors bilan (crédit-bail, cautions, litiges en cours), l'état du parc et son vieillissement, les contrats clients et leur pérennité, et la situation sociale (effectifs, contentieux prud'homaux)."},

{id:2393,prog:'LOURD',theme:'cl-social',d:1,
e:"Le principe de faveur en droit du travail des PL signifie que :",
r:[{t:"La loi prime toujours"},{t:"La règle la plus favorable au salarié s'applique",ok:true},{t:"Les accords d'entreprise priment"},{t:"Le salarié choisit la règle applicable"}],
x:"Bonne réponse : La règle la plus favorable au salarié s'applique. En cas de conflit entre la loi, la convention collective et l'accord d'entreprise, la règle la plus favorable au salarié s'applique. Les ordonnances de 2017 ont introduit des dérogations : les accords d'entreprise peuvent désormais primer sur la CCN dans certains domaines spécifiques."},

{id:2394,prog:'LOURD',theme:'lo-gestion',d:2,
e:"La valeur de remplacement d'un PL (vs valeur nette comptable) est importante pour :",
r:[{t:"Le calcul de l'IS"},{t:"La mise à jour de l'amortissement pour renouveler le parc",ok:true},{t:"L'évaluation des stocks"},{t:"Le calcul des cotisations sociales"}],
x:"Bonne réponse : La mise à jour de l'amortissement pour renouveler le parc. La VNC (Valeur Nette Comptable) peut être très inférieure à la valeur de remplacement (coût d'achat d'un nouveau véhicule équivalent). Cet écart indique que les amortissements passés ne seront pas suffisants pour financer le renouvellement. L'entreprise doit provisionner ou emprunter pour remplacer ses véhicules."},
...
r:[{t:"Toujours un avantage fiscal immédiat"},{t:"Un produit exceptionnel imposable, étalable sous conditions",ok:true},{t:"Une charge déductible"},{t:"Aucun impact fiscal"}],
...
r:[{t:"Uniquement en UE"},{t:"Entre deux pays dont l'un signataire, à titre onéreux",ok:true},{t:"Uniquement pour les PL > 20t"},{t:"Uniquement si déclarée dans le contrat"}],
x:"Bonne réponse : Entre deux pays dont l'un signataire, à titre onéreux. La CMR s'applique automatiquement (sans nécessité de clause spécifique) à tout transport routier de marchandises à titre onéreux entre deux pays dont au moins l'un est signataire. Elle régit la responsabilité du transporteur, les documents à établir et les limites d'indemnisation."},
...
r:[{t:"Non, jamais autorisé en équipage"},{t:"Oui, fractionnable en 2 périodes : au moins 3h puis 9h",ok:true},{t:"Oui, en autant de fractions que nécessaire"},{t:"Oui, mais uniquement pour les femmes enceintes"}],
x:"Bonne réponse : Oui, fractionnable en 2 périodes : au moins 3h puis 9h. Pour les conducteurs seuls, le repos journalier ne peut être fractionné qu'en repos réduit (9h). Pour les conducteurs en équipage, l'art. 8 du règlement 561/2006 prévoit une disposition spécifique : le repos peut être scindé en 2 périodes (première ≥ 3h consécutives, deuxième ≥ 9h consécutives, total ≥ 12h)."},
...
r:[{t:"Uniquement aux transports internationaux entre pays signataires"},{t:"Aux transports internationaux et nationaux par transposition",ok:true},{t:"Uniquement aux matières radioactives et explosives"},{t:"Uniquement aux véhicules citernes"}],
x:"Bonne réponse : Aux transports internationaux et nationaux par transposition. L'ADR est un accord international initialement applicable aux transports internationaux. En France, il a été transposé en droit national par arrêté, ce qui le rend applicable aux transports nationaux. La réglementation ADR est actualisée tous les 2 ans."},
...
r:[{t:"Transporte plus de 10 tonnes de marchandises dangereuses par an"},{t:"Expédie, conditionne, charge, remplit ou transporte des MD",ok:true},{t:"Possède plus de 5 véhicules dédiés aux matières dangereuses"},{t:"Réalise uniquement du transport international de matières dangereuses"}],
x:"Bonne réponse : Expédie, conditionne, charge, remplit ou transporte des MD. Toute entreprise dont l'activité comprend l'expédition, le conditionnement, le chargement, le remplissage ou le transport de marchandises dangereuses doit désigner un CSTMD (Conseiller à la Sécurité pour le Transport de Marchandises Dangereuses). Des seuils d'exemption existent pour les petites quantités."},
...
r:[{t:"Identifier la classe de danger de la matière"},{t:"Identifier la matière dangereuse de façon unique au monde",ok:true},{t:"Calculer la quantité maximale transportable"},{t:"Déterminer le type de véhicule requis pour le transport"}],
x:"Bonne réponse : Identifier la matière dangereuse de façon unique au monde. Le numéro ONU est un identifiant numérique à 4 chiffres attribué par les Nations Unies permettant d'identifier une matière dangereuse de manière unique et universelle, indépendamment de la langue. Il figure sur les panneaux orange réfléchissants du véhicule."},
...
r:[{t:"Uniquement le numéro ONU (Organisation des Nations Unies) et la quantité"},{t:"Le numéro ONU, la désignation, la classe, l'emballage, la quantité",ok:true},{t:"Uniquement la désignation commerciale et la quantité"},{t:"Le numéro ONU et le nom du fabricant"}],
x:"Bonne réponse : Le numéro ONU, la désignation, la classe, l'emballage, la quantité. Le document de transport ADR doit mentionner : le numéro ONU précédé de 'UN', la désignation officielle de transport, la classe ADR, le groupe d'emballage (si applicable), la quantité (en kg ou litres) et d'autres mentions selon la matière."},
...
r:[{t:"Conservée uniquement au siège de l'entreprise"},{t:"Portée sur le conducteur et présentée lors des contrôles",ok:true},{t:"Envoyée à la DREAL avant chaque transport"},{t:"Remise à l'expéditeur à chaque chargement"}],
x:"Bonne réponse : Portée sur le conducteur et présentée lors des contrôles. L'attestation de formation ADR du conducteur (le certificat) doit être portée sur lui pendant le transport et présentée à toute réquisition des agents de contrôle. Elle prouve que le conducteur est habilité à transporter les matières dangereuses concernées."},

{id:4023,prog:'ADR',theme:'adr-emb',d:2,
e:"Les emballages utilisés pour le transport de marchandises dangereuses doivent :",
r:[{t:"Être obligatoirement en acier ou en aluminium"},{t:"Porter la marque ONU attestant leur conformité aux tests",ok:true},{t:"Être remplacés après chaque transport"},{t:"Être de couleur orange réglementaire"}],
x:"Bonne réponse : Porter la marque ONU attestant leur conformité aux tests. Les emballages ADR doivent porter la marque ONU (symbole UN dans un hexagone) attestant qu'ils ont réussi les épreuves de performance requises pour la matière transportée. Cette marque inclut le type d'emballage, le groupe d'emballage maximum, l'année de fabrication et le pays de délivrance."},
...
r:[{t:"Permettent de transporter de grandes quantités sans restriction"},{t:"Des quantités très faibles, quasi exemptées de l'ADR",ok:true},{t:"S'appliquent uniquement aux matières radioactives"},{t:"Nécessitent une autorisation préfectorale spéciale"}],
x:"Bonne réponse : Des quantités très faibles, quasi exemptées de l'ADR. Les quantités exceptées (EQ) concernent des quantités très petites (généralement quelques ml ou grammes par emballage intérieur) transportées avec des exemptions quasi-totales : pas de formation, pas de marquage spécial (sauf marque EQ), pas de document de transport ADR spécifique requis."},
...
r:[{t:"Uniquement les étiquettes de danger sur les côtés du véhicule"},{t:"Des panneaux orange avec code Kemler et numéro ONU",ok:true},{t:"Uniquement un panneau orange vierge (sans numéros)"},{t:"Des bandes réfléchissantes orange sur tout le périmètre du véhicule"}],
x:"Bonne réponse : Des panneaux orange avec code Kemler et numéro ONU. Pour le transport en vrac d'une seule matière dangereuse, le véhicule doit afficher à l'avant ET à l'arrière des panneaux orange réfléchissants portant en haut le code danger (Kemler) et en bas le numéro ONU de la matière transportée."},
...
r:[{t:"Uniquement des gants de protection et un masque à gaz"},{t:"Gilet fluorescent, chaussures, lunettes et gants de protection",ok:true},{t:"Une combinaison chimique complète"},{t:"Un casque intégral et des bottes chimiques"}],
x:"Bonne réponse : Gilet fluorescent, chaussures, lunettes et gants de protection. L'équipement de protection individuelle (EPI) minimum obligatoire à bord d'un véhicule ADR comprend : un gilet de signalisation fluorescent, des chaussures ou bottes de sécurité, des lunettes de protection et des gants de protection. D'autres EPI peuvent être requis selon la nature des matières transportées."},
...
r:[{t:"Tenter de réparer immédiatement la fuite lui-même"},{t:"Garer, baliser, éloigner les personnes et alerter les secours",ok:true},{t:"Poursuivre le trajet jusqu'au prochain garage"},{t:"Arroser d'eau le colis qui fuit"}],
x:"Bonne réponse : Garer, baliser, éloigner les personnes et alerter les secours. En cas d'incident/accident, les consignes de sécurité ADR prescrivent : couper le moteur, ne pas fumer, garer et immobiliser le véhicule en lieu sûr, mettre les feux de détresse, baliser à distance, éloigner les personnes des abords, prévenir les secours (18, 15, 17 ou 112) en indiquant la nature du danger."},
...
r:[{t:"Est interdit dans tous les lieux publics"},{t:"Est autorisé partout, de nuit uniquement"},{t:"En lieu sûr, loin des habitations et sources d'ignition",ok:true},{t:"N'est possible que dans les zones industrielles désignées"}],
x:"Bonne réponse : En lieu sûr, loin des habitations et sources d'ignition. Le stationnement d'un véhicule transportant des matières dangereuses doit être effectué en lieu sûr, à l'écart des habitations, des sources d'ignition et des installations à risques. Des dispositions spécifiques s'appliquent pour les matières les plus dangereuses (explosifs, radioactifs…)."},
...
r:[{t:"Les matières radioactives de faible activité"},{t:"Les marchandises banales"},{t:"Les matières dangereuses diverses non classées ailleurs",ok:true},{t:"Les déchets industriels banals"}],
x:"Bonne réponse : Les matières dangereuses diverses non classées ailleurs. La classe 9 est une classe 'fourre-tout' regroupant les matières dangereuses ne rentrant dans aucune autre classe. Exemples : piles au lithium, appareils magnétisés, matières biodégradables transportées à chaud, véhicules."},
...
r:[{t:"Réparer immédiatement la fuite lui-même"},{t:"Garer, baliser, éloigner les personnes et alerter les secours",ok:true},{t:"Poursuivre le trajet jusqu'au garage le plus proche"},{t:"Arroser d'eau les colis qui fuient"}],
x:"Bonne réponse : Garer, baliser, éloigner les personnes et alerter les secours. Les consignes ADR en cas d'incident prévoient : couper le moteur, ne pas fumer, garer et immobiliser le véhicule en lieu sûr, mettre les feux de détresse, baliser à distance, éloigner les personnes, prévenir les secours (112) en indiquant la nature du danger."},
...
r:[{t:"La DREAL automatiquement"},{t:"La direction de l'entreprise, et l'autorité si demandé",ok:true},{t:"La douane française"},{t:"L'ONU chaque année"}],
x:"Bonne réponse : La direction de l'entreprise, et l'autorité si demandé. Le rapport annuel du CSTMD est adressé à la direction de l'entreprise. Il n'est pas envoyé automatiquement à l'autorité compétente mais doit être présenté lors des contrôles sur demande. Il est conservé pendant au moins 5 ans. En cas d'incident grave, un rapport séparé est également rédigé."},
...
r:[{t:"Peser l'emballage avant et après remplissage"},{t:"Soumettre l'emballage rempli à une surpression interne",ok:true},{t:"Plonger l'emballage dans l'eau et observer les bulles"},{t:"Chauffer l'emballage à 50°C pendant 24h"}],
x:"Bonne réponse : Soumettre l'emballage rempli à une surpression interne. Le test d'étanchéité (selon les recommandations ONU/ADR) consiste à appliquer une surpression interne à l'emballage rempli d'eau (ou liquide équivalent) pendant un temps déterminé. Pour les emballages du GE I : 30 kPa de pression interne. Pour les GE II et III : 20 kPa. Absence de fuite = conformité au test."},

{id:4047,prog:'ADR',theme:'adr-doc',d:2,
e:"La mention 'QUANTITÉS LIMITÉES' ou 'LQ' dans le document de transport ADR :",
r:[{t:"Est obligatoire pour tous les transports LQ"},{t:"Non requise — seul le marquage des colis est obligatoire",ok:true},{t:"Remplace le numéro ONU dans le document"},{t:"Doit être accompagnée des consignes écrites"}],
x:"Bonne réponse : Non requise — seul le marquage des colis est obligatoire. Pour les colis en quantités limitées (LQ), l'ADR (art. 3.4.7) n'exige pas de mention spécifique dans le document de transport. Le marquage LQ sur les colis (losange blanc et noir) suffit. Les consignes écrites ne sont pas requises pour les LQ. C'est l'un des avantages de l'exemption LQ : simplification documentaire significative."},
...
r:[{t:"La catégorie du véhicule requis"},{t:"La restriction d'accès aux tunnels selon leur classement",ok:true},{t:"Le type d'emballage autorisé"},{t:"La vitesse maximale en tunnel"}],
x:"Bonne réponse : La restriction d'accès aux tunnels selon leur classement. Les tunnels sont classés de A (pas de restriction) à E (interdits à toutes les matières dangereuses sauf exceptions). Le code tunnel indiqué pour chaque matière dans la colonne 15 du tableau A indique dans quels tunnels le transport est interdit. B = interdit en tunnel B et plus contraignant. D = interdit en tunnel D et E."},
...
r:[{t:"Uniquement des gants en caoutchouc"},{t:"Lunettes, gants chimiques, vêtement, rinçage des yeux",ok:true},{t:"Un masque chirurgical suffit"},{t:"Aucun EPI spécifique n'est requis"}],
x:"Bonne réponse : Lunettes, gants chimiques, vêtement, rinçage des yeux. Pour les matières corrosives (Classe 8), les EPI minimaux requis par les consignes écrites ADR comprennent : lunettes de protection étanches aux liquides (ou écran facial), gants résistants aux produits chimiques, vêtement de protection couvrant le corps, et souvent un récipient d'eau de rinçage (min 1 L) pour les yeux en cas de projection accidentelle."},
...
r:[{t:"À tous les véhicules ADR"},{t:"Aux véhicules de certaines catégories dangereuses",ok:true},{t:"Uniquement aux citernes"},{t:"Uniquement la nuit"}],
...
r:[{t:"D'exporter librement toutes MD"},{t:"Appliquer des règles dérogatoires entre États signataires",ok:true},{t:"D'harmoniser les tarifs de transport"},{t:"D'exonérer les petits transporteurs"}],
x:"Bonne réponse : Appliquer des règles dérogatoires entre États signataires. Les accords multilatéraux (ML) sont des dérogations temporaires aux règles ADR standard, conclus entre autorités compétentes de plusieurs États parties. Ils autorisent des conditions particulières pour un type de transport non prévu par l'ADR ou plus flexibles. Ils sont publiés et ont une durée limitée."},

{id:4056,prog:'ADR',theme:'adr-gen',d:2,
e:"Un véhicule ADR vide et non nettoyé (ex : citerne ayant contenu des inflammables) :",
r:[{t:"N'est plus soumis à l'ADR"},{t:"Reste soumis à l'ADR jusqu'au nettoyage et dégazage complets",ok:true},{t:"Peut être garé dans tout parking"},{t:"Peut être réparé normalement"}],
x:"Bonne réponse : Reste soumis à l'ADR jusqu'au nettoyage et dégazage complets. Un véhicule ADR (notamment une citerne) ayant transporté des MD reste soumis aux obligations ADR (plaques oranges, consignes écrites, interdictions de stationnement…) jusqu'à ce qu'il soit nettoyé et dégazé. Les vapeurs résiduelles d'inflammables constituent un risque d'explosion même en l'absence de liquide visible."},
...
r:[{t:"Uniquement Classe 6.1"},{t:"Classe 4.3, plus Classe 6.1 subsidiaire",ok:true},{t:"Classe 8"},{t:"Classe 9"}],
x:"Bonne réponse : Classe 4.3, plus Classe 6.1 subsidiaire. Un solide qui dégage un gaz inflammable ou toxique au contact de l'eau relève de la Classe 4.3 si ce danger est prédominant. Si le solide est lui-même toxique, un risque subsidiaire de Classe 6.1 peut s'ajouter. Le risque dominant détermine la classe principale. La classification ADR applique une hiérarchie des risques."},

{id:4058,prog:'ADR',theme:'adr-cls',d:2,
e:"La Classe 5.1 (matières comburantes) comprend des matières qui :",
r:[{t:"Brûlent d'elles-mêmes"},{t:"Libèrent de l'oxygène et favorisent la combustion",ok:true},{t:"S'enflamment au contact de l'eau"},{t:"Explosent sous l'effet de la chaleur"}],
x:"Bonne réponse : Libèrent de l'oxygène et favorisent la combustion. Les matières comburantes (Classe 5.1) ne sont pas forcément inflammables elles-mêmes, mais elles entretiennent ou favorisent la combustion d'autres matières en libérant de l'oxygène. Exemples : nitrate d'ammonium (engrais), peroxyde d'hydrogène concentré, permanganate de potassium, hypochlorite de sodium concentré."},
...
r:[{t:"Une flamme"},{t:"Deux éprouvettes déversant sur une main et un métal",ok:true},{t:"Un crâne avec tibias"},{t:"Un trèfle radioactif"}],
x:"Bonne réponse : Deux éprouvettes déversant sur une main et un métal. L'étiquette de la Classe 8 est un losange mi-blanc (haut) mi-noir (bas) représentant deux éprouvettes ou cylindres déversant du liquide sur une main (tissu humain) et un métal (symbolisant l'attaque corrosive). Le chiffre 8 figure dans le coin inférieur."},

{id:4061,prog:'ADR',theme:'adr-doc',d:1,
e:"Le certificat de formation ADR du conducteur doit-il se trouver dans le véhicule ?",
r:[{t:"Non, il est conservé uniquement en entreprise"},{t:"Oui, le conducteur doit le détenir et le présenter",ok:true},{t:"Uniquement pour les transports internationaux"},{t:"Non, un simple justificatif de l'employeur suffit"}],
x:"Bonne réponse : Oui, le conducteur doit le détenir et le présenter. Le conducteur doit détenir son certificat ADR valide dans le véhicule pendant tout transport de marchandises dangereuses et le présenter à tout contrôle. L'employeur doit également en conserver une copie."},
...
r:[{t:"Tenter d'éteindre avec les extincteurs du bord"},{t:"S'éloigner, baliser, alerter les secours, consulter les consignes",ok:true},{t:"Débâcher le chargement pour aérer"},{t:"Appeler son employeur en premier"}],
x:"Bonne réponse : S'éloigner, baliser, alerter les secours, consulter les consignes. En cas d'incendie impliquant des MD : 1) S'éloigner immédiatement (risque d'explosion), 2) Allumer les feux de détresse si possible, 3) Baliser à grande distance, 4) Appeler le 18 (pompiers) et le 15 (SAMU) si blessés, en précisant le numéro ONU, 5) Consulter les consignes écrites et les transmettre aux secours. Ne jamais combattre seul un incendie impliquant des MD."},

{id:4066,prog:'ADR',theme:'adr-gen',d:3,
e:"Le plan de sûreté ADR (ch. 1.10) est obligatoire pour les transporteurs de marchandises :",
r:[{t:"Tous les transporteurs ADR"},{t:"À haut risque sécuritaire (explosifs, toxiques, radioactifs)",ok:true},{t:"Uniquement à l'international"},{t:"Transportant plus de 1 tonne de MD"}],
x:"Bonne réponse : À haut risque sécuritaire (explosifs, toxiques, radioactifs). Le plan de sûreté (ch. 1.10 ADR) est requis pour les entreprises transportant des marchandises à 'haut risque' sécuritaire (liste définie par l'ADR : certains explosifs, gaz très toxiques, radioactifs de haute activité…). Il doit identifier les menaces et définir les mesures de sécurité pour prévenir le vol ou le détournement."},
...
r:[{t:"Envoyées par email avant le départ"},{t:"Dans la cabine, dans les langues du conducteur et des pays",ok:true},{t:"Affichées sur le côté du véhicule"},{t:"Conservées uniquement au dépôt"}],
x:"Bonne réponse : Dans la cabine, dans les langues du conducteur et des pays. Les consignes écrites (art. 5.4.3.4 ADR) doivent être à bord du véhicule, dans la cabine du conducteur, accessibles à tout moment. Elles doivent être rédigées dans les langues que le conducteur peut lire et comprendre, et dans celles des pays traversés. Elles doivent correspondre exactement aux matières transportées."},
...
r:[{t:"Les transports médicaux d'urgence"},{t:"Les transports pour les besoins propres de l'État",ok:true},{t:"Les transports de quantités exceptées"},{t:"Les transports en petits conteneurs"}],
x:"Bonne réponse : Les transports pour les besoins propres de l'État. L'art. 1.1.3.1 de l'ADR exempte les transports effectués par les autorités militaires ou sous leur responsabilité, les transports d'urgence pour sauvetage de vie, et les transports effectués par les autorités compétentes dans leurs activités réglementaires. Ces exemptions permettent à ces services d'intervenir sans les contraintes ADR normales."},
...
r:[{t:"Appeler le médecin du travail"},{t:"Retirer les vêtements contaminés et rincer 15 min à l'eau",ok:true},{t:"Administrer l'antidote spécifique"},{t:"Couvrir le conducteur avec une couverture"}],
x:"Bonne réponse : Retirer les vêtements contaminés et rincer 15 min à l'eau. En cas d'exposition cutanée à une matière toxique : 1) Retirer immédiatement les vêtements et chaussures contaminés, 2) Rincer abondamment la peau à l'eau claire pendant au moins 15 minutes, 3) Appeler le 15/112 et préciser la substance (numéro ONU), 4) Montrer les consignes écrites aux secours, 5) Ne jamais provoquer de vomissements en cas d'ingestion sans avis médical."},
...
r:[{t:"À chaque arrêt de plus de 30 minutes"},{t:"Quand le véhicule est vide et nettoyé des matières signalisées",ok:true},{t:"Uniquement en cas de contrôle policier"},{t:"Jamais — elles doivent rester en permanence"}],
x:"Bonne réponse : Quand le véhicule est vide et nettoyé des matières signalisées. Les plaques oranges (et les étiquettes de danger) doivent être retirées ou masquées lorsque le véhicule est vide et a été nettoyé/dégazé, ou lorsqu'il ne transporte plus les matières correspondantes. Un véhicule vide avec des plaques oranges crée une fausse alarme et induit les secours en erreur. En cours de transport, elles doivent être en place en permanence."},

{id:4076,prog:'ADR',theme:'adr-sec',d:3,
e:"Le phénomène BLEVE (Boiling Liquid Expanding Vapor Explosion) peut survenir lors de :",
r:[{t:"Tout transport de liquide"},{t:"Un récipient sous pression de liquide inflammable exposé au feu",ok:true},{t:"La chute d'un fût de liquide corrosif"},{t:"Le débordement d'une citerne de carburant"}],
x:"Bonne réponse : Un récipient sous pression de liquide inflammable exposé au feu. Le BLEVE est une explosion catastrophique qui survient quand un récipient sous pression (citerne GPL, bouteille de gaz) est exposé à un incendie. La chaleur fait monter la pression interne jusqu'à la rupture du récipient, libérant le liquide qui se vaporise instantanément et s'enflamme. Le risque BLEVE impose des distances de sécurité de 300-500 m minimum pour les secours."},
...
r:[{t:"En anglais uniquement"},{t:"Dans la langue de l'expéditeur et des pays traversés",ok:true},{t:"En français uniquement pour les transports en France"},{t:"Dans la langue du pays destinataire uniquement"}],
x:"Bonne réponse : Dans la langue de l'expéditeur et des pays traversés. Le nom d'expédition officiel (NEO) dans le document de transport doit être dans la langue officielle du pays d'origine et, si cette langue n'est pas l'anglais, le français ou l'allemand, dans l'une de ces trois langues également. Cette règle vise à assurer la compréhension par les autorités de contrôle des pays traversés."},

{id:4079,prog:'ADR',theme:'adr-emb',d:3,
e:"Un emballage combiné en ADR est :",
r:[{t:"Un emballage contenant plusieurs matières différentes"},{t:"Un emballage extérieur contenant des emballages intérieurs",ok:true},{t:"Un emballage homologué pour 2 groupes d'emballage"},{t:"Un conteneur citerne"}],
x:"Bonne réponse : Un emballage extérieur contenant des emballages intérieurs. Un emballage combiné comprend un emballage extérieur (qui assure la résistance mécanique et la protection) et des emballages intérieurs (qui contiennent directement la matière dangereuse). L'emballage extérieur peut être une caisse en bois, en carton, en métal, etc. Les deux niveaux d'emballage doivent être homologués."},

{id:4080,prog:'ADR',theme:'adr-gen',d:3,
e:"Les matières de la Classe 9 (divers) comprennent notamment :",
r:[{t:"Uniquement les matières radioactives"},{t:"Les matières à risque non couvertes par les autres classes",ok:true},{t:"Les matières non classifiées en attente"},{t:"Toutes les matières non dangereuses"}],
x:"Bonne réponse : Les matières à risque non couvertes par les autres classes. La Classe 9 est une classe 'fourre-tout' pour les matières dangereuses pendant le transport qui ne correspondent pas aux critères des classes 1 à 8. Elle inclut : batteries au lithium (ONU 3480, 3481, 3090, 3091), PCB (polychlorobiphényles), CO2 solide (neige carbonique, ONU 1845), airbags et prétensionneurs (ONU 3268), matières dangeureuses pour l'environnement aquatique."},

{id:4081,prog:'ADR',theme:'adr-emb',d:1,
e:"Un fût en acier à fond non amovible (code 1A1) peut être utilisé pour :",
r:[{t:"Les solides uniquement"},{t:"Les liquides et matières visqueuses (fond non amovible)",ok:true},{t:"Uniquement les gaz comprimés"},{t:"Uniquement la Classe 8"}],
x:"Bonne réponse : Les liquides et matières visqueuses (fond non amovible). Le fût en acier à fond non amovible (1A1) est particulièrement adapté au transport de liquides : il résiste bien à la pression interne et limite les risques de fuite. Les fûts à fond amovible (1A2) sont adaptés aux solides car ils permettent un remplissage/vidage par le dessus. Le choix dépend aussi des critères du groupe d'emballage."},

{id:4082,prog:'ADR',theme:'adr-doc',d:2,
e:"Le document de transport ADR doit obligatoirement indiquer :",
r:[{t:"Uniquement le numéro ONU"},{t:"N° ONU, désignation, classe, emballage, quantité, parties",ok:true},{t:"Uniquement la classe de danger et le nom du conducteur"},{t:"Le numéro de plaque d'immatriculation du véhicule uniquement"}],
x:"Bonne réponse : N° ONU, désignation, classe, emballage, quantité, parties. Le document de transport ADR doit contenir : le numéro ONU (UN XXXX), la désignation officielle de transport, la classe, le code de classification, le groupe d'emballage (si applicable), la quantité totale, le nom et adresse de l'expéditeur et du destinataire."},
...
r:[{t:"Tenter de réparer la fuite immédiatement"},{t:"Stationner à l'écart, baliser, alerter et consulter les consignes",ok:true},{t:"Vider le contenu dans un caniveau pour sécuriser"},{t:"Couvrir la fuite avec de la terre ou du sable manuellement"}],
x:"Bonne réponse : Stationner à l'écart, baliser, alerter et consulter les consignes. En cas de fuite d'une citerne ADR : 1) S'arrêter loin des habitations et sources d'ignition, 2) Couper le moteur, 3) Allumer les feux de détresse, 4) Baliser à distance, 5) Appeler le 18 (pompiers) et le 15 (SAMU) si blessés, en précisant le numéro ONU, 6) Consulter les consignes écrites, 7) Ne jamais tenter de colmater seul une fuite importante."},

{id:4084,prog:'ADR',theme:'adr-sec',d:2,
e:"Le plan de sûreté ADR (chapitre 1.10) est obligatoire pour :",
r:[{t:"Tous les transports ADR sans exception"},{t:"Les transporteurs de marchandises à haut risque sécuritaire",ok:true},{t:"Uniquement les transports internationaux"},{t:"Les transports de plus de 1 tonne de matières dangereuses"}],
x:"Bonne réponse : Les transporteurs de marchandises à haut risque sécuritaire. Le plan de sûreté (chapitre 1.10 ADR) est requis pour les entreprises transportant des 'marchandises dangereuses à haut risque' (liste définie par l'ADR) : explosifs, certains gaz très toxiques, matières radioactives de haute activité, et autres matières pouvant être utilisées à des fins terroristes. Il doit identifier les menaces et définir les mesures de sécurité."},
...
r:[{t:"Attribuer la classe la moins restrictive"},{t:"Appliquer les exigences les plus strictes jusqu'à classification",ok:true},{t:"Ne pas transporter la matière"},{t:"Demander l'avis d'un voisin transporteur"}],
x:"Bonne réponse : Appliquer les exigences les plus strictes jusqu'à classification. En cas d'incertitude sur la classification d'une matière, le principe ADR est d'appliquer les règles correspondant aux exigences les plus strictes (groupe d'emballage I si incertain entre I et II, classe la plus dangereuse si plusieurs sont possibles) jusqu'à ce qu'une classification certaine soit obtenue auprès d'un laboratoire ou d'une autorité compétente."},
...
r:[{t:"Les poudres de mine"},{t:"Les matières explosives primaires, les plus sensibles",ok:true},{t:"Les feux d'artifice"},{t:"Les explosifs industriels sécurisés"}],
x:"Bonne réponse : Les matières explosives primaires, les plus sensibles. Le groupe de compatibilité A (initiateur) correspond aux matières explosives primaires, les plus sensibles à un choc, friction, chaleur ou décharge électrique. Exemples : azoture de plomb (UN 0129), styphnate de plomb (UN 0130), trinitrorsorcinate de plomb. Ces matières ne peuvent être transportées qu'isolément dans des conditions strictes."},

{id:4087,prog:'ADR',theme:'adr-cls',d:3,
e:"La peroxydes organiques de la Classe 5.2 se distinguent de la Classe 5.1 car :",
r:[{t:"Ils sont moins dangereux"},{t:"Ils contiennent un groupement peroxyde et sont instables",ok:true},{t:"Ils sont uniquement gazeux"},{t:"Ils sont plus fréquents dans le transport routier"}],
x:"Bonne réponse : Ils contiennent un groupement peroxyde et sont instables. La Classe 5.2 (peroxydes organiques) regroupe des matières dont la structure chimique contient le groupement -O-O-. Ils peuvent se décomposer de façon exothermique (libération de chaleur) et parfois explosive. Beaucoup nécessitent un contrôle de température pendant le transport (température critique de décomposition auto-accélérée - TDAA)."},

{id:4088,prog:'ADR',theme:'adr-sig',d:1,
e:"L'étiquette de danger de la Classe 1 (explosibles) est de forme :",
r:[{t:"Carrée orange"},{t:"Losange orange avec une bombe et un numéro de division",ok:true},{t:"Ronde rouge avec une flamme"},{t:"Triangulaire blanche avec un crâne"}],
x:"Bonne réponse : Losange orange avec une bombe et un numéro de division. Les étiquettes de la Classe 1 sont des losanges (carré sur la pointe) de couleur orange avec le numéro de la sous-classe et de la lettre de groupe de compatibilité. Le pictogramme représente une bombe explosant. Chaque division de la Classe 1 a sa propre étiquette (1.1, 1.2, 1.3, 1.4, 1.5, 1.6)."},
...
r:[{t:"Uniquement le numéro ONU et la classe"},{t:"Numéro ONU, nom, classe, emballage, quantité, parties",ok:true},{t:"Uniquement les mesures d'urgence"},{t:"Le poids du véhicule chargé"}],
x:"Bonne réponse : Numéro ONU, nom, classe, emballage, quantité, parties. La déclaration de l'expéditeur (document de transport) doit contenir, selon l'ADR 5.4.1.1 : 'UN XXXX Nom d'expédition officiel, Classe X, (GE X ou Code de Classification), Quantité, NOM et adresse de l'expéditeur, NOM et adresse du destinataire'. Des informations supplémentaires sont requises selon les cas (température, code tunnel…)."},
...
r:[{t:"Nettoyer soi-même le déversement avec de l'eau"},{t:"Alerter les secours spécialisés et ne pas toucher la marchandise",ok:true},{t:"Ouvrir les fenêtres et attendre que la zone s'aère"},{t:"Utiliser l'extincteur à poudre"}],
x:"Bonne réponse : Alerter les secours spécialisés et ne pas toucher la marchandise. En cas de déversement de matières infectieuses (Classe 6.2), il ne faut jamais toucher la marchandise. Il faut immédiatement alerter les secours spécialisés (pompiers NRBC), évacuer et baliser la zone, consulter les consignes écrites."},
...
r:[{t:"La vitesse maximale du véhicule"},{t:"Le facteur de calcul des points d'exemptions partielles",ok:true},{t:"Le type de véhicule requis"},{t:"La durée de validité du certificat conducteur"}],
x:"Bonne réponse : Le facteur de calcul des points d'exemptions partielles. La catégorie de transport (0, 1, 2 ou 3) détermine le facteur multiplicateur pour les calculs des points d'exemption partielle. Catégorie 0 = facteur 0 (toujours exempté quelle que soit la quantité), catégorie 1 = facteur 50 (très dangereux), catégorie 2 = facteur 3, catégorie 3 = facteur 1 (moins dangereux). Si le total des points ≤ 1000, exemption partielle applicable."},
...
e:"Le rapport annuel du CSTMD doit être transmis à :",
r:[{t:"La DREAL uniquement"},{t:"L'autorité compétente si demandé, sinon l'entreprise",ok:true},{t:"La douane française"},{t:"L'ONU chaque année"}],
x:"Bonne réponse : L'autorité compétente si demandé, sinon l'entreprise. Le rapport annuel du CSTMD (art. 1.8.3.3 ADR) doit être rédigé chaque année et adressé à la direction de l'entreprise. Il est conservé pendant au moins 5 ans. Il n'est pas envoyé automatiquement à l'autorité compétente, mais doit être communiqué en cas de demande lors d'un contrôle."},
...
r:[{t:"Uniquement les numéros d'urgence"},{t:"Les mesures contre le vol ou l'usage illicite de la marchandise",ok:true},{t:"Le plan de livraison du client"},{t:"L'itinéraire détaillé du transport"}],
x:"Bonne réponse : Les mesures contre le vol ou l'usage illicite de la marchandise. Pour les marchandises à 'haut risque' (explosifs, radioactifs, certains toxiques…), un plan de sûreté est requis (chapitre 1.10 de l'ADR). Il doit identifier les risques sécuritaires (vol, détournement), les mesures de prévention (contrôle des accès, traçabilité) et les procédures en cas d'incident de sûreté."},
...
r:[{t:"Accord de Droit Routier"},{t:"Accord européen sur le transport de marchandises Dangereuses",ok:true},{t:"Autorisation de Déplacement Routier"},{t:"Acte de Déclaration de Risques"}],
x:"Bonne réponse : Accord européen sur le transport de marchandises Dangereuses. ADR = Accord européen relatif au transport international des marchandises Dangereuses par Route. Signé à Genève en 1957, il est révisé tous les 2 ans et s'applique aux transports internationaux ET nationaux dans les pays signataires."},
...
r:[{t:"Tous les transports ADR sans exception"},{t:"Les transports ADR groupant plusieurs expéditeurs",ok:true},{t:"Les transports de gaz uniquement"},{t:"Les transports ADR de plus de 5 tonnes"}],
x:"Bonne réponse : Les transports ADR groupant plusieurs expéditeurs. La déclaration de chargement du conteneur (ou véhicule) est requise lorsque des marchandises dangereuses sont chargées dans un conteneur, pour attester que le chargement a été effectué correctement et que le conteneur est en bon état."},
...
r:[{t:"Repasser l'intégralité de la formation initiale"},{t:"Suivre un recyclage avant l'expiration et réussir l'examen",ok:true},{t:"Simplement présenter une demande à la préfecture"},{t:"Faire valider son expérience par son employeur"}],
x:"Bonne réponse : Suivre un recyclage avant l'expiration et réussir l'examen. Pour renouveler le certificat ADR avant son expiration, le conducteur doit suivre une formation de recyclage (durée réduite par rapport à la formation initiale) chez un organisme agréé et réussir l'examen de renouvellement. Si le certificat est expiré depuis plus de 12 mois, la formation initiale complète doit être refaite."},

{id:4126,prog:'ADR',theme:'adr-sec',d:2,
e:"Le stationnement d'un véhicule transportant des marchandises dangereuses est :",
r:[{t:"Libre, sans restriction particulière"},{t:"Soumis à restrictions (tunnels, ponts) et à surveillance",ok:true},{t:"Interdit la nuit en tout lieu"},{t:"Autorisé uniquement dans les dépôts agréés ADR"}],
x:"Bonne réponse : Soumis à restrictions (tunnels, ponts) et à surveillance. Le stationnement d'un véhicule ADR est soumis à des restrictions : éviter les zones habitées, les tunnels, les dessous de ponts. Une surveillance permanente peut être requise. En cas de stationnement prolongé, des mesures de sécurité supplémentaires s'appliquent."},
...
r:[{t:"Un kit de premiers secours uniquement"},{t:"EPI, matériel de collecte des fuites et extincteurs adaptés",ok:true},{t:"Uniquement un détecteur de gaz"},{t:"Une radio de communication spéciale"}],
x:"Bonne réponse : EPI, matériel de collecte des fuites et extincteurs adaptés. L'ADR chapitre 8.1.5 liste les équipements obligatoires : cales d'arrêt, deux feux d'avertissement autoportants, un gilet haute visibilité par personne à bord, et dans les consignes de formation, les EPI adaptés (gants, lunettes, combinaison de protection, appareil respiratoire si applicable). Pour les citernes de carburant : des matériaux absorbants."},
...
r:[{t:"Uniquement des gants"},{t:"Lunettes, gants chimiques et vêtement de protection complet",ok:true},{t:"Uniquement un masque respiratoire"},{t:"Aucun EPI spécifique n'est requis"}],
x:"Bonne réponse : Lunettes, gants chimiques et vêtement de protection complet. Pour les matières corrosives (Classe 8), les consignes écrites ADR et les fiches de données de sécurité indiquent les EPI minimaux : lunettes étanches aux liquides (ou écran facial), gants résistants au produit chimique spécifique, vêtement de protection (combinaison ou tablier selon le risque). Un récipient d'eau de rinçage pour les yeux (min 1L) doit être accessible dans la cabine."},
...
r:[{t:"Cessent à la montée sur le ferry"},{t:"Restent applicables, plus des exigences IMDG en mer",ok:true},{t:"Sont remplacées par les règles IMDG"},{t:"Ne s'appliquent qu'à la partie routière finale"}],
x:"Bonne réponse : Restent applicables, plus des exigences IMDG en mer. En transport multimodal, les obligations ADR s'appliquent à la partie routière avant et après la traversée maritime. Pour la partie maritime, le Code IMDG (transport maritime de MD) s'applique en plus. Des documents complémentaires (déclaration MD maritime) peuvent être requis par la compagnie maritime. À l'arrivée, les obligations ADR reprennent."},
...
r:[{t:"Uniquement le numéro ONU"},{t:"Nom, numéro ONU, étiquettes, orientation et homologation",ok:true},{t:"Le nom et adresse de l'expéditeur uniquement"},{t:"La date de fabrication de l'emballage"}],
x:"Bonne réponse : Nom, numéro ONU, étiquettes, orientation et homologation. Le marquage d'un colis ADR doit comporter : le numéro ONU (précédé de 'UN' ou 'ONU'), le nom d'expédition officiel, les étiquettes de danger (losanges), les flèches d'orientation si le colis contient des liquides (ne pas retourner), le marquage d'homologation de l'emballage (code UN). Les informations de l'expéditeur/destinataire sont également requises."},
...
r:[{t:"D'exporter des marchandises dangereuses sans formalité"},{t:"Appliquer des règles dérogatoires entre États signataires",ok:true},{t:"D'harmoniser les tarifs de transport entre pays"},{t:"D'exonérer de l'ADR pour les petits transporteurs"}],
x:"Bonne réponse : Appliquer des règles dérogatoires entre États signataires. Les accords multilatéraux (ML) sont des dérogations temporaires aux règles ADR, conclus entre les autorités compétentes de plusieurs États parties. Ils autorisent des conditions particulières de transport non prévues par l'ADR standard. Ils sont publiés et ont une durée limitée."},
...
r:[{t:"Toutes les citernes"},{t:"Prévenir les étincelles électrostatiques lors du transfert",ok:true},{t:"Uniquement pour les citernes en plastique"},{t:"Uniquement la nuit"}],
x:"Bonne réponse : Prévenir les étincelles électrostatiques lors du transfert. La mise à la masse est obligatoire lors du chargement/déchargement de liquides inflammables en citerne pour dissiper les charges électrostatiques générées par l'écoulement du liquide. Une étincelle dans une atmosphère explosive (vapeurs de carburant) peut provoquer l'inflammation. Un câble de mise à la masse doit être branché avant toute opération."},
...
r:[{t:"Que l'emballage est fabriqué par l'ONU"},{t:"Que l'emballage a été testé et approuvé selon l'ONU/ADR",ok:true},{t:"Que l'emballage peut contenir toutes les classes ADR"},{t:"Que l'emballage est d'origine américaine (United Nations)"}],
x:"Bonne réponse : Que l'emballage a été testé et approuvé selon l'ONU/ADR. Le marquage 'UN' (ou pictogramme UN) sur un emballage atteste qu'il a subi les tests de performance prescrits par les Recommandations de l'ONU sur le transport des marchandises dangereuses (tests de chute, empilage, étanchéité, pression interne selon les cas). C'est le marquage homologué exigé par l'ADR."},

{id:4149,prog:'ADR',theme:'adr-gen',d:1,
e:"Le principe de séparation des charges incompatibles en ADR interdit notamment :",
r:[{t:"Le transport de plusieurs types de GRV dans un même véhicule"},{t:"Le chargement en commun de classes incompatibles",ok:true},{t:"Tout mélange de classes dans le même colis"},{t:"Le transport simultané de 3 classes différentes"}],
x:"Bonne réponse : Le chargement en commun de classes incompatibles. Le tableau de séparation ADR (sous-section 7.5.2) définit quelles classes peuvent être chargées ensemble et lesquelles sont incompatibles. Par exemple : les explosibles (Cl.1) ne peuvent pas être transportés avec les liquides inflammables (Cl.3) ni les comburants (Cl.5.1). En cas de doute, la règle est de séparer."},

{id:4150,prog:'ADR',theme:'adr-cls',d:3,
e:"La Classe 9 de l'ADR est une classe résiduelle qui inclut notamment :",
r:[{t:"Les matières non dangereuses transportées volontairement"},{t:"Les matières dangereuses non couvertes par les autres classes",ok:true},{t:"Uniquement les matières radioactives de faible activité"},{t:"Les médicaments et produits pharmaceutiques"}],
x:"Bonne réponse : Les matières dangereuses non couvertes par les autres classes. Classe 9 = matières et objets dangereux divers non couverts par les autres classes. Exemples : batteries au lithium (ONU 3480/3481), neige carbonique (ONU 1845), engins de sauvetage (airbags), véhicules électriques. Pictogramme : rayures verticales noires sur fond blanc."},

{id:4151,prog:'ADR',theme:'adr-sec',d:2,
e:"Les extincteurs à bord d'un véhicule ADR doivent être :",
r:[{t:"Uniquement à poudre ABC"},{t:"En bon état, avec date d'inspection valide et adaptés",ok:true},{t:"Uniquement à CO2 (gaz carbonique)"},{t:"Non obligatoires si la cargaison est faible quantité"}],
x:"Bonne réponse : En bon état, avec date d'inspection valide et adaptés. Les extincteurs ADR doivent être : homologués, en bon état, vérifiés périodiquement (date de validité visible), adaptés au type de cargaison. Au minimum : 1 extincteur de 2 kg de poudre AB pour cabine + 1 ou 2 extincteurs selon le type de véhicule."},
...
r:[{t:"Peuvent être éteintes avec de l'eau en cas d'incendie"},{t:"Ne doivent jamais toucher l'eau — le code X l'indique",ok:true},{t:"Sont transportées dans des citernes réfrigérées"},{t:"Ne nécessitent pas de signalisation particulière"}],
x:"Bonne réponse : Ne doivent jamais toucher l'eau — le code X l'indique. La Classe 4.3 regroupe les matières qui, au contact de l'eau, dégagent des gaz inflammables (ex : carbure de calcium, lithium métallique, sodium). Le transport de ces matières est signalé par le code 'X' devant le numéro Kemler (ex : X423). L'eau est absolument contre-indiquée pour l'extinction."},
...
r:[{t:"La quantité totale est < 1 tonne"},{t:"Chaque colis intérieur respecte la quantité limite",ok:true},{t:"Le transport est local (< 50 km)"},{t:"Le conducteur n'a pas de certificat ADR"}],
x:"Bonne réponse : Chaque colis intérieur respecte la quantité limite. Les quantités limitées (LQ) permettent une exemption de nombreuses obligations ADR quand chaque colis intérieur contient au maximum la quantité définie par colonne 7a du tableau A (généralement de 25 ml à 5L selon la matière). Le colis extérieur est limité à 30 kg maximum. Le marquage LQ (losange noir et blanc) remplace les étiquettes ADR."},
...
r:[{t:"Toutes les citernes ADR"},{t:"Les citernes de liquides inflammables, contre l'électrostatique",ok:true},{t:"Uniquement les citernes de la Classe 1"},{t:"Uniquement lors des opérations nocturnes"}],
x:"Bonne réponse : Les citernes de liquides inflammables, contre l'électrostatique. La mise à la masse (earthing/bonding) est obligatoire lors du chargement/déchargement de liquides inflammables en citerne pour prévenir les étincelles dues aux charges électrostatiques générées par l'écoulement du liquide. Une étincelle dans une atmosphère explosive peut provoquer l'inflammation des vapeurs de carburant."},

{id:4162,prog:'ADR',theme:'adr-gen',d:2,
e:"Les consignes écrites ADR (instructions en cas d'accident) doivent être rédigées dans :",
r:[{t:"Uniquement en français"},{t:"Les langues du conducteur et des pays traversés",ok:true},{t:"En anglais uniquement (langue internationale)"},{t:"Uniquement dans la langue du pays de destination"}],
x:"Bonne réponse : Les langues du conducteur et des pays traversés. Les consignes écrites ADR doivent être rédigées dans une langue comprise par chaque membre de l'équipage ET dans les langues officielles de chaque pays de chargement, de transit et de déchargement."},
...
r:[{t:"Identifier la marchandise pour appeler les bons secours"},{t:"Baliser la zone, alerter les secours et consulter les consignes",ok:true},{t:"Tenter de redresser le véhicule"},{t:"Prendre des photos pour l'assurance"}],
x:"Bonne réponse : Baliser la zone, alerter les secours et consulter les consignes. En cas d'accident ADR : 1. SÉCURISER (couper le moteur, ne pas fumer, baliser à distance) 2. ALERTER (112, pompiers NRBC si nécessaire) 3. Consulter les CONSIGNES ÉCRITES pour les mesures adaptées à la marchandise 4. Ne PAS tenter de réparer ou redresser seul — attendre les secours spécialisés."},
...
r:[{t:"Transporte plus de 10 tonnes de MD par an"},{t:"Expédie, conditionne, charge ou transporte des MD",ok:true},{t:"Possède plus de 5 véhicules"},{t:"Réalise uniquement du transport international"}],
x:"Bonne réponse : Expédie, conditionne, charge ou transporte des MD. Toute entreprise dont l'activité comprend l'expédition, le chargement, le remplissage, le conditionnement, l'emballage ou le transport de marchandises dangereuses doit désigner un CSTMD. Ce conseiller peut être interne ou externe à l'entreprise."},
...
r:[{t:"Classe 3 — inflammable"},{t:"Classe 2, code 2TOC (toxique, comburant, corrosif)",ok:true},{t:"Classe 8 — corrosif uniquement"},{t:"Classe 6.1 — toxique uniquement"}],
x:"Bonne réponse : Classe 2, code 2TOC (toxique, comburant, corrosif). Le chlore (UN 1017) est un gaz liquéfié de la Classe 2 avec code 2TOC : liquéfié (2) + Toxique (T) + comburant (O) + Corrosif (C). C'est un gaz de guerre historique, extrêmement dangereux par inhalation. Son transport est très réglementé et réservé aux opérateurs spécialisés disposant d'équipements adaptés."},
...
r:[{t:"Ans"},{t:"2 ans (années impaires)",ok:true},{t:"5 ans"},{t:"À la demande des États"}],
x:"Bonne réponse : 2 ans (années impaires). L'ADR est révisé tous les deux ans (années impaires : 2023, 2025…). La nouvelle édition entre en vigueur le 1er janvier de l'année paire suivante avec un délai de transition de 6 mois pour permettre l'adaptation des entreprises."},
...
r:[{t:"Uniquement une plaque orange vierge à l'avant"},{t:"Une plaque numéro de danger et numéro ONU sur les côtés",ok:true},{t:"Uniquement les étiquettes de danger"},{t:"Aucun marquage si le volume est inférieur à 1 000 litres"}],
x:"Bonne réponse : Une plaque numéro de danger et numéro ONU sur les côtés. Pour un transport en citerne d'une seule matière, les plaques orange avec codes doivent être placées de chaque côté et à l'arrière de la citerne. À l'avant du véhicule, une plaque orange sans code suffit."},
...
r:[{t:"Face au vent (vers la source)"},{t:"En position sous le vent, à grande distance",ok:true},{t:"À 10 m maximum"},{t:"N'importe où — le vent ne change pas la dangerosité"}],
x:"Bonne réponse : En position sous le vent, à grande distance. En cas de fuite de gaz toxique, le nuage se disperse dans le sens du vent. Les secours doivent se positionner SOUS LE VENT (donc dos au vent, le nuage s'éloigne d'eux) et à grande distance. La zone d'exclusion est plus grande dans la direction du vent. La force et la direction du vent sont les premiers paramètres évalués lors d'une intervention sur un incident impliquant des gaz toxiques."},

{id:4182,prog:'ADR',theme:'adr-sig',d:2,
e:"Les plaques oranges sur une citerne transportant un seul produit dangereux indiquent :",
r:[{t:"Uniquement le numéro de danger"},{t:"Le numéro de danger (Kemler) et le numéro ONU",ok:true},{t:"Uniquement le numéro ONU"},{t:"Le nom de la matière"}],
x:"Bonne réponse : Le numéro de danger (Kemler) et le numéro ONU. Les plaques oranges codifiées sur une citerne montrent en partie supérieure le numéro de danger (Kemler, 2 ou 3 chiffres, ex : 33 pour très inflammable) et en partie inférieure le numéro ONU à 4 chiffres (ex : 1203 pour l'essence). Sur les véhicules transportant des colis multiples, seules des plaques oranges vierges (sans code) sont apposées à l'avant et à l'arrière."},

{id:4183,prog:'ADR',theme:'adr-doc',d:2,
e:"Les consignes écrites ADR doivent être conservées dans le véhicule :",
r:[{t:"Uniquement dans la cabine du conducteur"},{t:"Dans la cabine, accessibles au conducteur à tout moment",ok:true},{t:"Dans la boîte à outils du véhicule"},{t:"Transmises au destinataire avant livraison uniquement"}],
x:"Bonne réponse : Dans la cabine, accessibles au conducteur à tout moment. Les consignes écrites ADR (art. 5.4.3.4) doivent être conservées dans la cabine du conducteur et accessibles à tout moment pendant le transport. Elles doivent correspondre exactement aux matières transportées et être dans les langues appropriées. En cas de contrôle, leur absence constitue une infraction."},
...
r:[{t:"Uniquement pour les matières de Classe 1 (explosibles)"},{t:"Uniquement si la marchandise est inflammable"},{t:"Pendant le chargement et le transport des MD à risque incendie",ok:true},{t:"Uniquement dans les tunnels"}],
x:"Bonne réponse : Pendant le chargement et le transport des MD à risque incendie. L'interdiction de fumer s'applique lors des opérations de chargement, de transport et de déchargement pour toutes les marchandises dont le transport peut créer un risque d'incendie ou d'explosion. Elle est généralement étendue à tout transport ADR."},
...
r:[{t:"La longueur maximale des tunnels"},{t:"Les marchandises autorisées ou interdites dans chaque tunnel",ok:true},{t:"La vitesse maximale dans les tunnels"},{t:"Le nombre de véhicules pouvant circuler simultanément"}],
x:"Bonne réponse : Les marchandises autorisées ou interdites dans chaque tunnel. Les catégories de tunnel ADR (A = pas de restriction spécifique à E = restrictions maximales) définissent quelles marchandises dangereuses peuvent y transiter. La catégorie est indiquée sur les panneaux de signalisation à l'entrée du tunnel."},
...
r:[{t:"Avoir sa propre homologation UN"},{t:"Les marquages de tous les colis plus la mention SUREMBALLAGE",ok:true},{t:"N'avoir que l'étiquette de la classe principale"},{t:"Aucun marquage spécifique"}],
x:"Bonne réponse : Les marquages de tous les colis plus la mention SUREMBALLAGE. Un suremballage (art. 5.1.2.1 ADR) regroupant plusieurs colis de MD doit porter : tous les numéros ONU des matières, tous les noms d'expédition, toutes les étiquettes de danger de tous les colis contenus, et la mention 'OVERPACK' ou 'SUREMBALLAGE'. Il ne nécessite pas de marquage homologué UN propre."},

{id:4201,prog:'ADR',theme:'adr-gen',d:2,
e:"Le CSTMD doit rédiger un rapport d'accident lorsque :",
r:[{t:"Tout incident de transport, même mineur"},{t:"Un incident avec pertes de matières, blessés ou gros dommages",ok:true},{t:"Uniquement lors d'accidents mortels"},{t:"Uniquement pour les Classes 1 et 7"}],
x:"Bonne réponse : Un incident avec pertes de matières, blessés ou gros dommages. Le CSTMD doit établir un rapport d'accident (art. 1.8.3.6 ADR) après tout incident ou accident survenu pendant le transport qui implique des pertes de matières dangereuses ou qui a causé des dommages à des personnes, des biens ou à l'environnement. Ce rapport est distinct du rapport annuel et est adressé à la direction de l'entreprise."}
];
