...
corr:"Nouvelle MCV = 108 000 × 38 % = 41 040 €\nNouveau résultat = 41 040 – 26 000 = 15 040 €\nAugmentation = +4 560 €"},
...
{id:'PL01-2B',pts:10,num:'Q 2.2',text:"Mercredi : 4h de conduite, puis livraison 2h, puis 3h30 de conduite. La règle des 4h30 continues est-elle respectée ?",type:'redige',
...
corr:"Total semaine = 36 h < 56 h ✓ (limite hebdo).\nJournées à 9h = durée normale maximale ✓ (la conduite de 10h est possible 2 fois/semaine mais pas obligatoire).\nAucun dépassement."},
...
corr:"Durée de validité : 5 ans. Renouvellement avant expiration obligatoire.\nSi la carte expire pendant le transport : le conducteur est en infraction. Il peut utiliser des feuilles de papier (procédure de secours) pendant 7 jours maximum en attendant la réparation/remplacement."},
]},
